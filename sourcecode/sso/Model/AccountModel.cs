...
namespace SSOModels
{
    ...
    public class RegisterModel
    {
        ...
        [Required]
        [DataType(DataType.Text)]
        [DisplayName("bHoatDong")]
        public Boolean bHoatDong { get; set; }
    }
    #endregion
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipCreateStatus CreateUser(string userName, string password, string email, string fullname)
        {
            ...
            if (status == MembershipCreateStatus.Success)
            {
                ...
                cmd = new SqlCommand("UPDATE aspnet_Membership SET FullName=@FullName WHERE UserId=@UserId");
                cmd.Parameters.AddWithValue("@UserId", us.ProviderUserKey);
                cmd.Parameters.AddWithValue("@FullName", fullname);
                Connection.UpdateDatabase(cmd);
                cmd.Dispose();

                cmd = new SqlCommand("UPDATE QT_NguoiDung SET sHoTen=@sHoTen WHERE sID_MaNguoiDung=@sID_MaNguoiDung");
