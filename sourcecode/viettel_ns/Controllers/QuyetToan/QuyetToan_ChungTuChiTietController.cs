...
namespace VIETTEL.Controllers.QuyetToan
{
    public class QuyetToan_ChungTuChiTietController : Controller
    {
        ...
        [Authorize]
        public ActionResult ChungTuChiTiet_Frame(string sLNS, string sL, string sK, string sM, string sTM, string sTTM, string sNG, string sTNG, string iID_MaDonVi, String MaLoai)
        {
