...
namespace VIETTEL.Controllers.DuToanBS
{
    public class DuToanBSChungTuController : Controller
    {
        ...
        /// <returns></returns>
        [Authorize]
        public ActionResult SuaChungTu(string iID_MaChungTu, string sLNS, String iKyThuat)
        {
        ...
        [Authorize]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult ThemSuaChungTu(string parentID, string maChungTu, string sLNS, string iKyThuat)
        {
            string maND = User.Identity.Name;
        ...
        /// <returns></returns>
        [Authorize]
        public ActionResult TuChoiChungTu(string maChungTu, string iLoai, string sLNS, string sLyDo, string maChungTuTLTH, string chiTiet, String iKyThuat)
        {
            string maND = User.Identity.Name;
            //Xác định trạng thái duyệt tiếp theo
