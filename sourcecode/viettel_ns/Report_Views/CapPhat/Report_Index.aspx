            ...
            <table class="mGrid">
              ...
              <tr>
                  ...
                  <tr>
                    ...
                    <td style="padding: 3px 2px;"><%=MyHtmlHelper.ActionLink(Url.Action("Index", "rptCapPhat_THChiTieu_SecDMNB"), "Tổng hợp chi tiêu - Cấp SDMNB")%></td>                        
                    <td></td>
                </tr>
                 <%--<tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td align="center" style="padding: 3px 2px;">TH1C1+GB</td>
                    <td style="padding: 3px 2px;"><%=MyHtmlHelper.ActionLink(Url.Action("Index", "rptTongHop_GiaoBan"), "Tổng hợp giao ban - Theo Bql")%></td>                        
                    <td align="center" style="padding: 3px 2px;"></td>
                </tr>        
                ...
                <tr>
                    <td align="center" style="padding: 3px 2px;">10</td>
                    <td align="center" style="padding: 3px 2px;">TH1C1+GB</td>
                    <td style="padding: 3px 2px;"><%=MyHtmlHelper.ActionLink(Url.Action("Index", "rptTongHop_GiaoBan_DonVi"), "Tổng hợp giao ban - Theo đơn vị")%></td>                        
                    <td align="center" style="padding: 3px 2px;"></td>
                </tr>     
            </table>
        </div>
