...
<body>
    <%
        ...
        var trinhky = (int)ViewData["trinhky"];
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtTo(MaND,"1050100");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaTo.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_1050100_ChonTo/viewpdf?MaTo={0}&sLNS={1}&trinhky={2}",
                         arrMaTo[i], "1050100", trinhky);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_1050100_ChonTo", new {ParentID, trinhky}))
        {
    %>
    <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi ngân sách sử dụng (phần chi hỗ trợ doanh nghiệp làm nhiệm vụ C) năm <%=iNamLamViec %>
                           </span>
                    </td>
