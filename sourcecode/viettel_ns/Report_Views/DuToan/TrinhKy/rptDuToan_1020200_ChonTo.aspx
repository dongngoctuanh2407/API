...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtTo(MaND,"1020200");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaTo.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_1020200_ChonTo/viewpdf?MaTo={0}&sLNS={1}&MaND={2}",
                         arrMaTo[i], "1020200", MaND);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_1020200_ChonTo", new {ParentID=ParentID}))
        {
    %>
    <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi ngân sách sử dụng (phần ngân sách tùy viên) năm <%=iNamLamViec %>
                           </span>
                    </td>
