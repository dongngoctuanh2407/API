...
<body>
    <%
        String ParentID = "DuToan";
         ...
         if (sTrinhKy.ToLower() == "true")
         {
              dtDonVi = DuToan_ReportModels.dtDonVi(MaND, "1010000");
         }
         else
         {
              dtDonVi = DuToan_ReportModels.dtDonViAll(MaND, "1010000");
         }
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_1010000_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}&sTrinhKy={2}",
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_1010000_TungDonVi", new {ParentID=ParentID}))
        {
