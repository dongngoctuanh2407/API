...
<body>
    <%
        ...
        DataTable dtDonVi = DuToan_ReportModels.dtDonVi(MaND, "1,2,3,4,8");
        ...
        if (PageLoad == "1")
        {
            ...
            {
                if (arrBaoCao[i].StartsWith("/rptDuToan_1040100_TungNganh") || arrBaoCao[i].StartsWith("/rptDuToan_207_TungDonVi") || arrBaoCao[i].StartsWith("/rptDuToan_207_TungNganh"))
                {
