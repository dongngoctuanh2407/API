...
<body>
    <%
        ...
        DataTable dtDonVi = DuToan_ReportModels.dtDonVi(MaND,"1020200");
        ...
        if (PageLoad == "1")
        {
            ...
            for (int i = 0; i < arrMaDonVi.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptDuToan_1020200_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}&trinhky={2}",
        ...
        using (Html.BeginForm("EditSubmit", "rptDuToan_1020200_TungDonVi", new {ParentID, trinhky}))
        {
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                       <span>Báo cáo dự toán chi ngân sách quốc phòng (phần ngân sách Tùy viên Quốc phòng) năm <%=iNamLamViec %>
                           </span>
                    </td>
