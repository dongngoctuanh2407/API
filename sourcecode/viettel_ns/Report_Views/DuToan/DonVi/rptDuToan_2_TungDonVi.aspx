...
<body>
    <%
        String ParentID = "DuToan";
         ...
         var trinhky = Convert.ToInt32(ViewData["trinhky"]);
         DataTable dtDonVi = DuToan_ReportModels.dtDonViAll(MaND, "2");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_2_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}&iCapTongHop={2}&trinhky={3}",
                         arrMaDonVi[i], MaND, iCapTongHop, trinhky);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_2_TungDonVi", new {ParentID, trinhky}))
        {
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi ngân sách nhà nước giao năm <%=iNamLamViec %>
                           </span>
                    </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td style="width: 5%" class="td_form2_td1"></td>
