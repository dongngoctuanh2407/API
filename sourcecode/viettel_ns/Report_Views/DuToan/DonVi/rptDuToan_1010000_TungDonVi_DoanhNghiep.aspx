...
<body>
    <%
        String ParentID = "DuToan";
         ...
         String sTrinhKy = Convert.ToString(ViewData["sTrinhKy"]);
         DataTable dtDonVi = DuToan_ReportModels.dtDonVi_DoanhNghiep(MaND, "1010000");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_1010000_TungDonVi_DoanhNghiep/viewpdf?iID_MaDonVi={0}&MaND={1}&sTrinhKy={2}",
                         arrMaDonVi[i], MaND,sTrinhKy);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_1010000_TungDonVi_DoanhNghiep", new {ParentID=ParentID}))
        {
    %>
    <%=MyHtmlHelper.Hidden(ParentID,sTrinhKy,"sTrinhKy","")%>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi ngân sách sử dụng (phần lương, phụ cấp, trợ cấp tiền ăn chi cho doanh nghiệp) năm <%=iNamLamViec %>
                           </span>
                    </td>
