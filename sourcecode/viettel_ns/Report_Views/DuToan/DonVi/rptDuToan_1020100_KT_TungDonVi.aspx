...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtDonVi_KT(MaND,"1020100");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_1020100_KT_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}&trinhky={2}",
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_1020100_KT_TungDonVi", new { ParentID=ParentID, trinhky, iID_MaDonVi}))
        {
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi ngân sách sử dụng (phần ngân sách nghiệp vụ ngành kỹ thuật) năm <%=iNamLamViec %>
                           </span>
                    </td>
