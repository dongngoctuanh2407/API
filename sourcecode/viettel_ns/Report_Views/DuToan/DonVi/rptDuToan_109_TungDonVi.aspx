...
<body>
    <%
        String ParentID = "DuToan";
         ...
         var loai = ViewData["loai"];
         DataTable dtDonVi = DuToan_ReportModels.dtDonVi(MaND,"109");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_109_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}&loai={2}",
                         arrMaDonVi[i], MaND, loai);
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_109_TungDonVi", new {ParentID, loai}))
        {
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi việc nhà nước giao vào NSQP năm <%=iNamLamViec %>
                           </span>
                    </td>
