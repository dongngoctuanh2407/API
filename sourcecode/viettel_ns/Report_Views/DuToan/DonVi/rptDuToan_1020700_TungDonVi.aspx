...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtDonVi(MaND, "1020700");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_1020700_TungDonVi/viewpdf?iID_MaDonVi={0}&MaND={1}",
                         arrMaDonVi[i], MaND);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_1020700_TungDonVi", new {ParentID}))
        {
    ...
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi ngân sách sử dụng (phần bảo hiểm xã hội, y tế) năm <%=iNamLamViec %>
                           </span>
                    </td>
