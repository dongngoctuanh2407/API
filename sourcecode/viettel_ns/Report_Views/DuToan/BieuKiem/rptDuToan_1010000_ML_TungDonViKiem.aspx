...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_1010000_ML_TungDonViKiem", new { MaND = MaND, iID_MaDonVi = iID_MaDonVi, iCapTongHop = "" });
    }  
    ...
    dtDonVi.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_1010000_ML_TungDonViKiem", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_1010000_ML_TungDonViKiem", new { MaND = MaND, iID_MaDonVi = iID_MaDonVi, iCapTongHop = "" }), "Export to Excel")%>
