...
<body>
   <%
    ...
    var URLView = "";
    var PageLoad = Convert.ToString(ViewData["PageLoad"]);
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_109_TongHop", new { MaND, iID_MaPhongBan, trinhky });
    }  
    String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai="0"});
    DataTable dtPhongBan = DuToan_ReportModels.getDSPhongBan(iNamLamViec, MaND,"109");
    SelectOptionList slPhongBan = new SelectOptionList(dtPhongBan, "iID_MaPhongBan", "sTenPhongBan");
    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_109_TongHop", new { ParentID, trinhky }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Tổng hợp dự toán chi NSQP năm <%=iNamLamViec %> ( Phần ngân sách khác )</span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_109_TongHop", new { MaND, iID_MaPhongBan, trinhky }), "Export to Excel")%>
