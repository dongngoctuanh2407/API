...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtPhongBan(MaND, "1020100,1020000,1030000,1040100");
         ...
         if (PageLoad == "1")
         {
                 arrView[0] =
                     String.Format(
                         @"/rptDuToan_TongHopCuc_PhanBoDTNS/viewpdf?iID_MaPhongBan={0}&MaND={1}",
                         iID_MaPhongBan, MaND);
                 Chuoi += arrView[0];
         }
         String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai = "0" });
         using (Html.BeginForm("EditSubmit", "rptDuToan_TongHopCuc_PhanBoDTNS", new {ParentID=ParentID}))
        {
    %>
     <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo công khai phân bổ dự toán chi NSQP năm <%=iNamLamViec %>
                           </span>
                    </td>
