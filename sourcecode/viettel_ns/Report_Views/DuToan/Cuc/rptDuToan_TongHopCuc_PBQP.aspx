...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_TongHopCuc_PBQP", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, loaiBaoCao = loaiBaoCao });
    }  
    ...
    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_TongHopCuc_PBQP", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_TongHopCuc_PBQP", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, loaiBaoCao = loaiBaoCao }), "Export to Excel")%>
