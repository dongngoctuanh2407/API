...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_TongHopCuc_THB2_Min", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan });
    }  
    ...
    using (Html.BeginForm("EditSubmit", "rptDuToan_TongHopCuc_THB2_Min", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
    ...
    <%}
      ...
      <script type="text/javascript">
          ...
          function changeTest(value) {
              ...
              var url = unescape('<%= Url.Action("Update_GhiChu?sMoTa=#0", "rptDuToan_TongHopCuc_THB2_Min") %>');
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_TongHopCuc_THB2_Min", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan }), "Export to Excel")%>
