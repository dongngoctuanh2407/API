...
<body>
    <%
        ...
        if (PageLoad == "1")
        {
            URLView = Url.Action("ViewPDF", "rptDuToan_2_TongHop", new { iID_MaPhongBan, iCapTongHop, trinhky });
        }
        String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai = "0" });
        DataTable dtPhongBan = DuToan_ReportModels.getDSPhongBan(iNamLamViec, MaND, "2");
        SelectOptionList slPhongBan = new SelectOptionList(dtPhongBan, "iID_MaPhongBan", "sTenPhongBan");
        dtPhongBan.Dispose();
        using (Html.BeginForm("EditSubmit", "rptDuToan_2_TongHop", new { ParentID, trinhky }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo tổng hợp dự toán ngân sách nhà nước giao năm
                            <%=iNamLamViec %></span>
                    </td>
                </tr>
            </table>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("Download", "rptDuToan_2_TongHop", new { iID_MaPhongBan, iCapTongHop, trinhky }), "Xuất báo cáo file Excel")%>
