...
<body>
    <%
        ...
        DataTable dtTo = rptDuToan_5_TongHopController.DanhSachToIn(MaND, "", ToSo,sLNS,iID_MaPhongBan);
        ...
        if (PageLoad == "1")
        {
            for (int i = 0; i < arrMaTo.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptDuToan_5_TongHop/viewpdf?ToSo={0}&MaND={1}&Nganh={2}&sLNS={3}&iID_MaPhongBan={4}&trinhky={5}",
        ...
        using (Html.BeginForm("EditSubmit", "rptDuToan_5_TongHop", new { ParentID, trinhky }))
        {
    %>
    <div class="box_tong">
        ...
        <div id="Div1">
         ...
         $("input:checkbox[check-group='To']").each(function (i) {
            ...
            function Chon() {
                ...
                var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&Nganh=#1&ToSo=#2&sLNS=#3&iID_MaPhongBan=#4&trinhky=#5", "rptDuToan_5_TongHop") %>');
