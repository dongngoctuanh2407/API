...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_1020800_TongHop");
    }  
    String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai="0"});
    using (Html.BeginForm("EditSubmit", "rptDuToan_1020800_TongHop", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_1020800_TongHop"), "Export to Excel")%>
