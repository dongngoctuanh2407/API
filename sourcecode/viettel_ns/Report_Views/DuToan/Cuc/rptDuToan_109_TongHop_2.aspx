...
<body>
   <%
       ...
       if (PageLoad == "1")
       {
           URLView = Url.Action("ViewPDF", "rptDuToan_109_TongHop_2", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, trinhky });
       }
       ...
       dtPhongBan.Dispose();
       using (Html.BeginForm("EditSubmit", "rptDuToan_109_TongHop_2", new { ParentID = ParentID , trinhky }))
       {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo tổng hợp dự toán chi việc nhà nước giao tính vào NSQP năm <%=iNamLamViec %></span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_109_TongHop_2", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan }), "Export to Excel")%>
