...
<body>
   <%
    ...
    if (PageLoad == "1")
    {
        URLView = Url.Action("ViewPDF", "rptDuToan_TongHopCuc_PBQP_TB", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, loaiBaoCao = loaiBaoCao });
    }  
    ...
    SelectOptionList slChon = new SelectOptionList(dt, "loaiBaoCao", "sTen");

    dtPhongBan.Dispose();
    using (Html.BeginForm("EditSubmit", "rptDuToan_TongHopCuc_PBQP_TB", new { ParentID = ParentID }))
    {
    %>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Báo cáo số phân bổ dự toán ngân sách năm các đơn vị ( Phần ngân sách quốc phòng )</span>
                    </td>
                </tr>
            </table>
        </div>
                 ...
                 <table width="100%" cellpadding="0"  cellspacing="0" border="0" class="table_form2">
                    <tr>   
                        ...
                        <td class="td_form2_td1" style="text-align:center">
                            <div><b>Chọn phòng ban: </b>   <%=MyHtmlHelper.DropDownList(ParentID, slPhongBan, iID_MaPhongBan, "iID_MaPhongBan", "", "class=\"input1_2\" style=\"width: 50%;height:24px;\"")%>    
                            </div>
                        </td>
                        <td class="td_form2_td1" style="text-align:center">
                            <div><b>Lấy số: </b>   <%=MyHtmlHelper.DropDownList(ParentID, slChon, loaiBaoCao, "loaiBaoCao", "", "class=\"input1_2\" style=\"width: 50%;height:24px;\"")%>    
                            </div>
                        </td>
                        <td class="td_form2_td1" style="text-align:center;width:30%">
                        </td>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_TongHopCuc_PBQP_TB", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, loaiBaoCao = loaiBaoCao }), "Export to Excel")%>
