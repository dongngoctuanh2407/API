...
<body>
   <%
       ...
       if (PageLoad == "1")
       {
           URLView = Url.Action("ViewPDF", "rptDuToan_TongHop_2060101", new { iID_MaPhongBan, trinhky });
       }
       String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai="0"});
       DataTable dtPhongBan = DuToan_ReportModels.getDSPhongBan(iNamLamViec, MaND,"2060101");
       SelectOptionList slPhongBan = new SelectOptionList(dtPhongBan, "iID_MaPhongBan", "sTenPhongBan");
       dtPhongBan.Dispose();
       using (Html.BeginForm("EditSubmit", "rptDuToan_TongHop_2060101", new { ParentID = ParentID, trinhky }))
       {
    %>
    <%--<%=MyHtmlHelper.Hidden(ParentID, string ,"sTrinhKy","")%>--%>   
    <div class="box_tong">
         <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	    <tr>
            	    <td>
                	    <span>Tổng hợp ngân sách người có công</span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("Download", "rptDuToan_TongHop_2060101", new { iID_MaPhongBan, trinhky }), "Xuất báo cáo file Excel")%>
