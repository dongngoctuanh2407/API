    ...
    <%
        ...
        if (PageLoad == "1")
        {
            for (int i = 0; i < arrMaTo.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptDuToan_109_PhanCap_DonVi/viewpdf?ToSo={0}&MaND={1}&Nganh={2}&sLNS={3}&iID_MaPhongBan={4}&trinhky={5}",
        ...
        using (Html.BeginForm("EditSubmit", "rptDuToan_109_PhanCap_DonVi", new { ParentID, trinhky }))
        {
    %>
    <div class="box_tong">
