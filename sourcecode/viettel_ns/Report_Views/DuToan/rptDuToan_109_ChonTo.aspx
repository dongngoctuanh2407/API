...
<body>
    <%
        String ParentID = "DuToan";
         ...
         DataTable dtDonVi = DuToan_ReportModels.dtTo(MaND,"109");
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaTo.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_109_ChonTo/viewpdf?MaTo={0}&sLNS={1}&MaND={2}",
                         arrMaTo[i], "109", MaND);
                 Chuoi += arrView[i];
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_109_ChonTo", new {ParentID}))
        {
    %>
    <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi nhà nước giao tính vào NSQP năm <%=iNamLamViec %>
                           </span>
                    </td>
