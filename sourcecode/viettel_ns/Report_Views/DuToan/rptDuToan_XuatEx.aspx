...
<body>
    <%
        String ParentID = "DuToan";
         ...
         {
             dtDonVi = DuToan_ReportModels.dtDonViAll(MaND, "1010000,1020100");
         }
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_XuatEx/ExportToExcel?iID_MaDonVi={0}&MaND={1}&sTrinhKy={2}",
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_XuatEx", new {ParentID=ParentID}))
        {
