...
<body>
    <%
        ...
        DataTable dtNganh = DuToan_ReportModels.dtNganh_PC_NhaNuoc(MaND, "207");
        ...
        dtNguonBD.Dispose();
        DataTable dtTo = rptDuToan_207_TungNganhController.DanhSachToIn(MaND, Nganh, ToSo,sLNS,iID_MaPhongBan);
        ...
        if (PageLoad == "1")
        {
            for (int i = 0; i < arrMaTo.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptDuToan_207_TungNganh/viewpdf?ToSo={0}&MaND={1}&Nganh={2}&sLNS={3}&iID_MaPhongBan={4}",
        ...
        using (Html.BeginForm("EditSubmit", "rptDuToan_207_TungNganh", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Báo cáo dự toán chi ngân sách nhà nước năm
                            <%=iNamLamViec%> phần chi QLHC
        ...
        <div id="Div1">
         ...
         $("input:checkbox[check-group='To']").each(function (i) {
            ...
            function Chon() {
                ...
                var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&Nganh=#1&ToSo=#2&sLNS=#3&iID_MaPhongBan=#4", "rptDuToan_207_TungNganh") %>');
    ...
    %>
    <div>
        <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptDuToan_207_TungNganh", new { MaND = MaND, Nganh = Nganh, ToSo = MaTo, iID_MaPhongBan = iID_MaPhongBan, sLNS = sLNS }), "Xuất ra Excels")%>
    </div>
</body>
</html>
