...
<%
    ...
    dtTrangThai.Dispose();
    String urlExport = Url.Action("ExportToExcel", "rptDuToan_BieuKiem_1020700", new { iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet });
    String BackURL = Url.Action("Index", "DuToan_Report", new { sLoai = "0" });
    String PageLoad = Convert.ToString(ViewData["PageLoad"]);
    String URLView = "";
    if (PageLoad == "1")
        URLView = Url.Action("ViewPDF", "rptDuToan_BieuKiem_1020700", new {  iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet });
    using (Html.BeginForm("EditSubmit", "rptDuToan_BieuKiem_1020700", new { ParentID = ParentID }))
    {
    %>   
