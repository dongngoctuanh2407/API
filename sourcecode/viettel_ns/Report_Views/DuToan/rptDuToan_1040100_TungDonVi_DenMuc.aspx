...
<body>
    <%
        String ParentID = "DuToan";
         ...
         dtDonVi.Dispose();
         String[] arrMaDonVi = new String[1];
         arrMaDonVi[0] = iID_MaDonVi;
         ...
         DataTable dtCapTongHop = DuToan_ReportModels.dtCapTongHop_B();
         ...
         if (PageLoad == "1")
         {
             ...
             for (int i = 0; i < arrMaDonVi.Length; i++)
             {
                 arrView[i] =
                     String.Format(
                         @"/rptDuToan_1040100_TungDonVi_DenMuc/viewpdf?iID_MaDonVi={0}&MaND={1}&iCapTongHop={2}",
         ...
         using (Html.BeginForm("EditSubmit", "rptDuToan_1040100_TungDonVi_DenMuc", new {ParentID=ParentID}))
        {
    %>
