...
<body>
    <%
        ...
        DataTable dtDonVi = DuToan_ReportModels.dtTo(MaND, "1020100");
        ...
        if (PageLoad == "1")
        {
            ...
            for (int i = 0; i < arrMaTo.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptDuToan_1020100_ChonTo/viewpdf?MaTo={0}&sLNS={1}&MaND={2}",
                        arrMaTo[i], "1020100", MaND);
                Chuoi += arrView[i];
        ...
        using (Html.BeginForm("EditSubmit", "rptDuToan_1020100_ChonTo", new { ParentID = ParentID }))
        {
    %>
