    ...
    <%
        ...
        if (PageLoad == "1")
        {
            ...
            for (int i = 0; i < arrMaDonVi.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptQTQS_THQS_TungDonVi_1/viewpdf?iID_MaDonVi={0}&MaND={1}&iThang_Quy={2}&iID_MaPhongBan={3}&LoaiThang_Quy={4}&bCheckTongHop={5}",
                        arrMaDonVi[i], MaND, iThangQuy, iID_MaPhongBan, LoaiThang_Quy, bCheckTongHop);
                Chuoi += arrView[i];
        ...
        using (Html.BeginForm("EditSubmit", "rptQTQS_THQS_TungDonVi_1", new { ParentID = ParentID }))
        {
    %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            ...
            <td class="td_form2_td1" style="width: 20%">
                <div>
                    <%=MyHtmlHelper.DropDownList(ParentID, slPhongBan, iID_MaPhongBan, "iID_MaPhongBan", "", "class=\"form-control\" style=\"width: 100%\" onchange=\"ChonDonVi1()\"")%>
                </div>
            </td>
            <td class="td_form2_td1" style="width: 10%" rowspan="3">
                <div>
                    Chọn đơn vị:</div>
            </td>
        ...
        <tr>
            ...
            <td class="td_form2_td1" style="width: 20%">
                <div>
                    ...
                    <%=MyHtmlHelper.DropDownList(ParentID, slThang, iThang, "iThang", "", "class=\"input1_2\" style=\"width:25%;\"")%>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <button class="btn btn-primary" type="submit" id="Submit1"><i class="fa fa-plus"></i>Tiếp tục</button>
                            </td>
                            <td style="width: 1%">
                                &nbsp;
                            </td>
        ...
        <script type="text/javascript">
           ...
           function ChonDonVi1() {
                ...
                var url = unescape('<%= Url.Action("LayDanhSachDonVi?ParentID=#0&iID_MaPhongBan=#1&iID_MaDonVi=#2", "rptQTQS_THQS_TungDonVi_1") %>');
