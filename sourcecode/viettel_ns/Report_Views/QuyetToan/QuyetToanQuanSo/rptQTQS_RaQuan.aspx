    ...
    <%
        ...
        if (PageLoad == "1")
        {
            ...
            for (int i = 0; i < arrMaDonVi.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptQTQS_RaQuan/viewpdf?iID_MaDonVi={0}&MaND={1}&iThang_Quy={2}&iID_MaPhongBan={3}&LoaiThang_Quy={4}&bCheckTongHop={5}",
        ...
        using (Html.BeginForm("EditSubmit", "rptQTQS_RaQuan", new { ParentID = ParentID }))
        {
    %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <script type="text/javascript">
           ...
           function ChonDonVi1() {
                ...
                var url = unescape('<%= Url.Action("LayDanhSachDonVi?ParentID=#0&iID_MaPhongBan=#1&iID_MaDonVi=#2", "rptQTQS_RaQuan") %>');
