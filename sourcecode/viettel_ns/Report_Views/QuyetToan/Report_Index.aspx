            ...
            <div id="form2">
                ...
                <table class="mGrid">
                    ...
                    <tr class="alt">
                        ...
                        <td align="center" style="padding: 3px 2px;"></td>
                        <td style="padding: 3px 2px;"><%=MyHtmlHelper.ActionLink(Url.Action("Index", "rptQuyetToan_TongHop_NamQuy"), "Quyết toán Tổng hợp Năm-Quý")%></td>
                        <td align="center" style="padding: 3px 2px;">TuNB</td>
                    </tr>
                    ...
                    <tr class="alt">
                        ...
                        <td align="center" style="padding: 3px 2px;"></td>
                        <td style="padding: 3px 2px;"><%=MyHtmlHelper.ActionLink(Url.Action("Index", "rptQuyetToan_BieuKiemKeToan"), "Quyết toán so sánh kế toán")%></td>
                        <td align="center" style="padding: 3px 2px;"></td>
                    </tr>
                    <%-- <tr class="alt">
                    <td align="center" style="padding: 3px 2px;">1</td>
