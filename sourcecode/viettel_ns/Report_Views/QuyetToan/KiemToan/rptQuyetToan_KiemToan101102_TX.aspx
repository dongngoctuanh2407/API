...
<body>
    <% 
        ...
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptQuyetToan_KiemToan101102_TX", new { iNamLamViec = iNamLamViec, iID_MaNamNganSach = iID_MaNamNganSach });
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_KiemToan101102_TX", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
...
<td>
     ...
     <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToan_KiemToan101102_TX", new { iNamLamViec = iNamLamViec, iID_MaNamNganSach = iID_MaNamNganSach }), "Xuất ra Excels")%>
