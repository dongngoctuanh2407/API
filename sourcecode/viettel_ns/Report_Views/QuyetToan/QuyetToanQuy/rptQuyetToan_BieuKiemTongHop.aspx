...
<body>
    <%
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptQuyetToan_BieuKiemTongHop", new { viID_MaPhongBan = iID_MaPhongBan, viThang_Quy = iThang_Quy, viID_MaDonVi = iID_MaDonVi, viID_MaNamNganSach = iID_MaNamNganSach });
        ...
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_BieuKiemTongHop", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <div id="<%= ParentID %>_tdDonVi">
                                <%rptQuyetToan_BieuKiemTongHopController rpt = new rptQuyetToan_BieuKiemTongHopController();%>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToan_BieuKiemTongHop", new { viID_MaPhongBan = iID_MaPhongBan, viThang_Quy = iThang_Quy, viID_MaDonVi = iID_MaDonVi, viID_MaNamNganSach = iID_MaNamNganSach }), "Xuất ra excel")%>
...
<script type="text/javascript">
    function Chon() {
        ...
        var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&oiID_MaPhongBan=#1&oiThang_Quy=#2&oiID_MaNamNganSach=#3&oiID_MaDonVi=#4&oMaND=#5","rptQuyetToan_BieuKiemTongHop") %>');
