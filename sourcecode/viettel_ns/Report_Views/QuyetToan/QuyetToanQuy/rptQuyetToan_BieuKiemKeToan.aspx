...
<body>
    <%
        ...
        String URLView = "";
        if (PageLoad == "1")
            URLView = Url.Action("ViewPDF", "rptQuyetToan_BieuKiemKeToan", new { viID_MaPhongBan = iID_MaPhongBan, viThang_Quy = iThang_Quy, viID_MaDonVi = iID_MaDonVi, viID_MaNamNganSach = iID_MaNamNganSach });
        ...
        using (Html.BeginForm("EditSubmit", "rptQuyetToan_BieuKiemKeToan", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <div id="<%= ParentID %>_tdDonVi">
                                <%rptQuyetToan_BieuKiemKeToanController rpt = new rptQuyetToan_BieuKiemKeToanController();%>
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptQuyetToan_BieuKiemKeToan", new { viID_MaPhongBan = iID_MaPhongBan, viThang_Quy = iThang_Quy, viID_MaDonVi = iID_MaDonVi, viID_MaNamNganSach = iID_MaNamNganSach }), "Xuất ra excel")%>
...
<script type="text/javascript">
    function Chon() {
        ...
        var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&oiID_MaPhongBan=#1&oiThang_Quy=#2&oiID_MaNamNganSach=#3&oiID_MaDonVi=#4&oMaND=#5","rptQuyetToan_BieuKiemKeToan") %>');
