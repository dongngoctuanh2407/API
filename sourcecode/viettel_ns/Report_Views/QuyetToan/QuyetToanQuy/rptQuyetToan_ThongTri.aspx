        ...
        if (PageLoad == "1") {
            if (LoaiTongHop == "ChiTiet") {
                for (int i = 0; i < arrMaDonVi.Length; i++) {
                    arrView[i] = String.Format(
                        @"/rptQuyetToan_ThongTri/viewpdf?iID_MaDonVi={0}&sLNS={1}&iThang_Quy={2}&iID_MaNamNganSach={3}&MaND={4}&LoaiTongHop={5}&DenMuc={6}&LoaiCapPhat={7}&LoaiThongTri={8}&khoangCachDong={9}",
                        arrMaDonVi[i], sLNS, iThang_Quy, iID_MaNamNganSach, MaND, LoaiTongHop, DenMuc, LoaiCapPhat, LoaiThongTri, khoangCachDong);
                    Chuoi += arrView[i];
            ...
            //VungNV: 2015/09/23 LoaiTongHop == TongHop
                ...
                arrView[0] = String.Format(
                        @"/rptQuyetToan_ThongTri/viewpdf?iID_MaDonVi={0}&sLNS={1}&iThang_Quy={2}&iID_MaNamNganSach={3}&MaND={4}&LoaiTongHop={5}&DenMuc={6}&LoaiCapPhat={7}&LoaiThongTri={8}&khoangCachDong={9}",
                        iID_MaDonVi, sLNS, iThang_Quy, iID_MaNamNganSach, MaND, LoaiTongHop, DenMuc, LoaiCapPhat, LoaiThongTri, khoangCachDong);
                Chuoi += arrView[0];
            }
        }
