...
<body>
    <%
        ...
        var tuyChonList = new List<dynamic>()
        {
            new { Id = 1, Ten = "Ngành"},
            //new { IdTuyChon = 1, TenTuyChon = "Nganh"},
            //new { IdTuyChon = 1, TenTuyChon = "Nganh"},
            //new { IdTuyChon = 1, TenTuyChon = "Nganh"},
        };
        ...
        DataColumn IdTuyChon = dtTuyChon.Columns.Add("Id", typeof(String));
        DataColumn TenTuyChon = dtTuyChon.Columns.Add("Ten", typeof(String));

        tuyChonList.ForEach(x =>
        {
            var r = dtTuyChon.NewRow();
            r["Id"] = x.Id;
            r["Ten"] = x.Ten;

            dtTuyChon.Rows.Add(r);
        });
        ...
        SelectOptionList slTuyChon = new SelectOptionList(dtTuyChon, "Id", "Ten");
        // dtQuy.
        ...
        String urlExport = Url.Action("ExportToExcel", "rptQuyetToan_TongHop_Nam_Quy", new { ParentID = ParentID });
    ...
    <div class="box_tong">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" align="center">
                                <tr>
                                    <td>
                                     ...
                                     <td>
                                        <a type="button" class="button" id="btnExcel">Excel</a>
                                    </td>
                                    <td width="5px">
                                    </td>
                                    <td>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                openTabs(count - 1, count, siteArray);
                } 
            });
            ...
            function Chon() {
             ...
             $("input:checkbox[check-group='DonVi']").each(function (i) {
                ...
                var url = unescape('<%= Url.Action("Ds_DonVi?ParentID=#0&Thang_Quy=#1&iID_MaDonVi=#2&sLNS=#3&iID_MaNamNganSach=#4&iID_MaPhongBan=#5", "rptQuyetToan_TongHop_Nam_Quy") %>');
            ...
            $("#btnExcel").click(function(){
                ...
                openTabs(count -1, count, links);
            });

            function getExcelUrl(donvi){
                var url = "/rptQuyetToan_TongHop_Nam_Quy/Excel?"+
                            ...
                            "&iID_TuyChon=@iID_TuyChon";

                url = url
                        .replace("@iID_MaDonVi", donvi)
                        .replace("@sLNS", '<%=sLNS%>')
                        .replace("@iThang_Quy", '<%=iThang_Quy%>')
                        .replace("@iID_MaNamNganSach", '<%=iID_MaNamNganSach%>')
                        .replace("@MaND", '<%=MaND%>')
                        .replace("@LoaiBaoCao", '<%=LoaiBaoCao%>')
                        .replace("@iID_MaPhongBan", '<%=iID_MaPhongBan%>')
                        .replace("@iID_TuyChon", '<%=iID_TuyChon%>');
