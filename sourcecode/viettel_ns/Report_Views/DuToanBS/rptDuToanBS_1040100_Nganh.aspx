...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        var Modelx = (rptDuToanBS_1040100_NganhViewModel)Model;
    %>

    <div class="panel panel-danger">
        <div class="panel-heading">
            <strong class="text-uppercase">Biểu giao bổ sung dự toán ngân sách bảo đảm theo ngành năm <%= Modelx.iNamLamViec%> - Chọn tờ</strong>
        </div>
                    ...
                    <div class="col-xs-6">
                        <form action="" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%= Html.DropDownList("iID_MaDot", Modelx.DotList, new { @class="form-control", onchange="changeData()"}) %>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div>
                                        <%= Html.DropDownList("iID_MaNguon", Modelx.NguonList, new { @class="form-control", onchange="change()"}) %>
                                    </div>
                                </div>
                            </div>
