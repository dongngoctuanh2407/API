...
<body>
    <%
        ...
        DataTable dtCapTongHop = DuToan_ReportModels.dtKieuBaoCao();
        ...
        if (PageLoad == "1")
        {
            ...
            for (int i = 0; i < arrMaDonVi.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptDuToanBS_1040100_Dot/viewpdf?iID_MaDonVi={0}&MaND={1}&iCapTongHop={2}&dNgayChungTu={3}",
        ...
        using (Html.BeginForm("EditSubmit", "rptDuToanBS_1040100_Dot", new { ParentID = ParentID }))
        {
    %>
    <div class="box_tong">
            ...
            $(document).ready(function () {
                ...
                function Refresh() {
                    ...
                    var iID_MaDot = document.getElementById("<%=ParentID %>_iID_MaDot").value;
                        ...
                        var url = unescape('<%= Url.Action("LayDanhSachNganh?ParentID=#0&iID_MaDot=#1&iID_MaPhongBan=#2&iID_MaDonVi=#4", "rptDuToanBS_1040100_Dot") %>');
