...
<body>
    <%
        ...
        var canCu = ViewData["canCu"] != null ?
            ViewData["canCu"].ToString() :
@"- Căn cứ Điều lệ công tác Tài chính QĐNDVN ban hành kèm theo QĐ số 27/2007/QĐ-BQP ngày 14/2/2007 của Bộ trưởng Bộ Quốc Phòng
- (Kèm theo Quyết định số ……………………/QĐ-BQP ngày ……… tháng ……… năm 20…… của Bộ Quốc Phòng)";
        ...
        if (PageLoad == "1")
        {
            for (int i = 0; i < arrDonVi.Length; i++)
            {
                arrView[i] =
                    String.Format(
                        @"/rptDuToanBS_ChiTieuNganSach2/viewpdf?iID_MaDonVi={0}&sLNS={1}&iID_MaDot={2}&MaND={3}&MaPhongBan={4}&canCu={5}",
                        arrDonVi[i], sLNS, idDot, MaND, MaPhongBan, HttpUtility.UrlPathEncode(canCu));
                Chuoi += arrView[i];
        ...
        using (Html.BeginForm("FormSubmit", "rptDuToanBS_ChiTieuNganSach2", new { ParentID = ParentID, }))
        {
    %>
    ...
    <div class="box_tong">
        ...
        <div id="rptMain" style="background-color: #F0F9FE;">
            <div id="Div2" style="margin-left: 10px;" class="table_form2">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="td_form2_td5" style="width: 14%; height: 20px">
                            <div>
                                <div>
                                    <%=MyHtmlHelper.TextArea(ParentID, canCu, "canCu", "", "class=\"input1_2\" style=\"height:280px;\"")%>
                                </div>
                            </div>
                        </td>
                    </tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 10px 20px">
                    <tr>
                        <td align="center">
