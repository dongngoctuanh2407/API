...
namespace AutoMapper.Extensions
{
    public static class AutoMapExtensions
    {
        ...
        public static IEnumerable<TDestination> MapToList<TSource, TDestination>(this TSource source, IEnumerable<TDestination> destination)
        {
            return Mapper.Map<IEnumerable<TDestination>>(source);
        }

        //public static IEnumerable<TDestination> MapToList<TSource, TDestination>(this TSource source)
        //{
        //    return Mapper.Map<IEnumerable<TDestination>>(source);
        //}
