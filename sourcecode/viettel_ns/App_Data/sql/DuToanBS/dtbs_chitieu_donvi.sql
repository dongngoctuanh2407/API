...
declare @iID_MaChungTu nvarchar(200)				set @iID_MaChungTu='357bf1cb-f7eb-48bc-8ef1-b7ae98c26769'
declare @iID_MaDonVi nvarchar(20)					set @iID_MaDonVi='51'
declare @iID_MaPhongBan nvarchar(2)					set @iID_MaPhongBan='10'
declare @sLNS nvarchar(100)							set @sLNS='1020100,1040100,1040200'
...
SELECT  LEFT(sLNS,1) as sLNS1,
		...
		sLNS,sL,sK,sM,sTM,sTTM,sNG,sXauNoiMa,sMota = [dbo].F_MLNS_MoTa_LNS(@iNamLamviec,sLNS,sL,sK,sM,sTM,sTTM,sNG),
