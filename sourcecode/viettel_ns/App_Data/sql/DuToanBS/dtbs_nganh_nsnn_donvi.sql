...
declare @iID_MaChungTu nvarchar(200)				set @iID_MaChungTu='fc492a51-46a9-4c37-ae07-abb6592dc853'
...
(
    ...
    WHERE   iTrangThai=1  
            ...
            AND (sLNS LIKE '2%' or left(sLNS,1) like '4%' or sLNS like '107%')
