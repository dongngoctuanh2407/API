...
declare @iID_MaNamNganSach nvarchar(20)				set @iID_MaNamNganSach='4'
...
(
    ...
    FROM f_ns_chitieu_full_tuchi(@iNamLamViec,@iID_MaDonVi,@iID_MaPhongBan,@iID_MaNamNganSach,null,GETDATE(),1,null)
