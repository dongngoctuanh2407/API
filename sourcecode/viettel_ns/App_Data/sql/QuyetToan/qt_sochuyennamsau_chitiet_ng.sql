...
declare @sM nvarchar(200)							set @sM=null
...
FROM 
(
	--SELECT	iID_MaDonVi,sLNS,sL,sK,sM,sTM,sTTM,sNG,
	...
	--GROUP BY iID_MaDonVi,sTenDonVi,sLNS,sL,sK,sM,sTM,sTTM,sNG
...
GROUP BY iID_MaDonVi,sLNS,sL,sK,sM,sTM,sTTM,sNG,sXauNoiMa,sTenDonVi
