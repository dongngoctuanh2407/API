...
SELECT  LEFT(sLNS,1) as sLNS1,
        ...
        LEFT(sLNS,5) as sLNS5,sLNS,sL,sK,sM,sTM,sTTM,sNG,sMoTa=dbo.F_MoTa_sXauNoiMa(@iNamLamViec,sLNS+'-'+sL+'-'+sK+'-'+sM+'-'+sTM+'-'+sTTM+'-'+sNG),
