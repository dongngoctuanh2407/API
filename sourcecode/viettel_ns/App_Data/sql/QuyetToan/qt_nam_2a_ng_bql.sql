...
GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,iID_MaDonVi,iId_MaPhongBan
...
(
   -- chi tieu nam nay
	SELECT  sLNS,sL,sK,sM,sTM,sTTM,sNG,iId_MaDonVi=left(iId_MaDonVi,2),iId_MaPhongBan,
            rChiTieu =	SUM(rTuChi)
    FROM f_ns_chitieu_full_tuchi_bql(@iNamLamViec,@iID_MaDonVi,@iID_MaPhongBan,@namTuChi,null,GETDATE(),1,null)
    GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,iId_MaDonVi,iId_MaPhongBan
...
(
    ...
    FROM f_ns_chitieu_full_tuchi_bql(@iNamLamViecNS,@iID_MaDonVi,@iID_MaPhongBan,@namDaCapTien,null,GETDATE(),1,null)
    GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,iId_MaDonVi,iId_MaPhongBan
...
(
    ...
    FROM f_ns_chitieu_full_tuchi_bql(@iNamLamViecNS,@iID_MaDonVi,@iID_MaPhongBan,@namChuaCapTien,null,GETDATE(),1,null)
    GROUP BY sLNS,sL,sK,sM,sTM,sTTM,sNG,iId_MaDonVi,iId_MaPhongBan
...
order by sXauNoiMa, iID_MaPhongBan, iId_MaDonVi
