...
from    (
        SELECT  rTuChiDT= case when iID_MaPhongBanDich <> '06' and iID_MaDonVi not in ('76','77','79') and LEN(iID_MaDonVi) = 2 then SUM(rTuChi/@dvt) else 0 end,
        ...
        WHERE   iTrangThai <> 0  AND (@@DKLNSNV)  AND iNamLamViec=@iNamLamViec @@DKPB @@DKDV
