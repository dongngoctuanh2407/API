...
-- Phần bìa bảo đảm--
			...
			SELECT		sLNS = '1020100'
						...
						, rChiTapTrung = SUM(rTuChi/@dvt)-SUM(CASE WHEN iID_MaPhongBan IN ('07','10') AND sLNS IN ('1020100','1020000') THEN (rTuChi-rChiTapTrung)/@dvt ELSE 0 END)
						, rHienVat = SUM(rHienVat/@dvt)
			 FROM		DT_ChungTuChiTiet
			 WHERE		iTrangThai in (1,2)
						AND sLNS IN ('1020100','1020000')
						AND iNamLamViec=@nam 
						AND ((iID_MaPhongBanDich = '07' and LEN(iID_MaDonVi) = 2) or iID_MaDonVi in ('30','34','35','50','69','70','71','72','73','78','80','88','89','90','91','92','93','94'))
						@@DKPB @@DKDV 
