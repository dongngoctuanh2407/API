...
SELECT  rTuChiDT=sum(rTuChiDT),rTuChiDN=sum(rTuChiDN),rTuChiBV=sum(rTuChiBV)
from    (
        SELECT		rTuChiDT= case when iID_MaDonVi not in ('30','34','35','50','69','70','71','72','73','76','77','78','79','80','88','89','90','91','92','93','94') and LEN(iID_MaDonVi) = 2 then SUM(rTuChi/@dvt) else 0 end,
					rTuChiDN= case when iID_MaDonVi in ('30','34','35','50','69','70','71','72','73','78','80','88','89','90','91','92','93','94') then SUM(rTuChi/@dvt) else 0 end,
					rTuChiBV= case when iID_MaDonVi in ('76','77','79') or LEN(iID_MaDonVi) > 2 then SUM(rTuChi/@dvt) else 0 end
