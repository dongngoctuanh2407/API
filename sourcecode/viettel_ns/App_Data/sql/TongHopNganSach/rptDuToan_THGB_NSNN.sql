...
declare @dMaDot datetime							set @dMaDot='2018-10-10 00:00:00.0'
...
select  sLNS1 = CASE WHEN sLNS LIKE '1%' THEN LEFT(sLNS,3) ELSE LEFT(sLNS,1) END,
        iID_MaDonVi, 
...
SELECT sLNS	=	CASE    
				...
				WHEN sLNS LIKE '1%' and sLNS NOT LIKE '102%' then LEFT(sLNS,3)
...
where  sLNS NOT LIKE '8%' and
        (@iID_MaDonVi IS NULL OR iID_MaDonVi IN (SELECT * FROM F_Split(@iID_MaDonVi)))
group by sLNS,iID_MaDonVi
