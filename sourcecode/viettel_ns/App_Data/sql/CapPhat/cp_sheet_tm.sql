...
SELECT 
	sLNS,sL,sK,sM,sTM
	,sXauNoiMa=CONVERT(nvarchar(10),sLNS)+'-'+CONVERT(nvarchar(10),sL)+'-'+CONVERT(nvarchar(10),sK)+'-'+CONVERT(nvarchar(10),sM)+'-'+CONVERT(nvarchar(10),sTM)+'_'+iID_MaDonVi
...
(
	...
	group by sLNS,sL,sK,sM,sTM,iID_MaDonVi
...
(
select		 
			id=CONVERT(nvarchar(10),sLNS)+'-'+CONVERT(nvarchar(10),sL)+'-'+CONVERT(nvarchar(10),sK)+'-'+CONVERT(nvarchar(10),sM)+'-'+CONVERT(nvarchar(10),sTM)+'_'+iID_MaDonVi
