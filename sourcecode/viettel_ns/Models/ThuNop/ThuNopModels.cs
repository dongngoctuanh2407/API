...
namespace VIETTEL.Models
{
    public class ThuNopModels
    {
        ...
        {
            DataTable dt;
            String SQL = "SELECT * FROM TN_CauHinhBaoCao WHERE iTrangThai = 1 AND iID_MaLoaiBaoCao=@iLoai ORDER BY iID_MaCotBaoCao";
        ...
        {
            DataTable dt;
            String SQL = "SELECT * FROM TN_CauHinhBaoCao WHERE iID_MaBaoCao=@iLoai AND iID_MaCot=@iID_MaCot AND iTrangThai = 1";
            SqlCommand cmd = new SqlCommand(SQL);
            cmd.Parameters.AddWithValue("@iLoai", iLoai);
        ...
        public static String DKPhongBan_alias(String MaND, SqlCommand cmd, String iID_MaPhongBan)
        {
            String DKPhongBan = "";
            String sTenPB = NguoiDung_PhongBanModels.getTenPhongBan_NguoiDung(MaND);
            if (iID_MaPhongBan == "-1" || iID_MaPhongBan == "" || iID_MaPhongBan == "02" || iID_MaPhongBan == "11")
