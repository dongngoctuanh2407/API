            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (Cap == 0)
                    {
                        ...
                        strPG += string.Format("<td style=\"background-color:#f4f9fd;padding: 3px 3px; text-align: center\">{0}<b>{1}</b></td>", strDoanTrang, HttpUtility.HtmlEncode(Row["sKyHieu"]));
                        strPG += string.Format("<td style=\"background-color:#f4f9fd;padding: 3px 3px; text-align: center\">{0}<b>{1}</b></td>", strDoanTrang, HttpUtility.HtmlEncode(Row["sTen"]));
                    ...
                    else
                    {
                        if (tgThuTu % 2 == 0)
                        {
                            ...
                            strPG += string.Format("<td style=\"background-color:#dff0fb;padding: 3px 3px; text-align: center\">{0}{1}</td>", strDoanTrang, HttpUtility.HtmlEncode(Row["sKyHieu"]));
                            strPG += string.Format("<td style=\"background-color:#dff0fb;padding: 3px 3px; text-align: center\">{0}{1}</td>", strDoanTrang, HttpUtility.HtmlEncode(Row["sTen"]));
