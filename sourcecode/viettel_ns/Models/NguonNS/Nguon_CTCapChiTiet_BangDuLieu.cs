...
namespace VIETTEL.Models
{
    ...
    /// </summary>
    public class Nguon_CTCapChiTiet_BangDuLieu : BangDuLieu_E
    {
        ...
        public Nguon_CTCapChiTiet_BangDuLieu(string Id_CTCap, Dictionary<string, string> arrGiaTriTimKiem, string MaND, string IPSua)
        {
            ...
            _dtChiTiet = _nguonNSService.GetChungTuChiTiet("Nguon_CTCap_ChiTiet", _iID_Ma, arrGiaTriTimKiem, _arrDSTruongTimKiem);               
