...
{
    public class Nguon_DMBQP_BangDuLieu :    BangDuLieu_E
    {
        /// /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public Nguon_DMBQP_BangDuLieu(Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._MaND = MaND;
            this._IPSua = IPSua;
        ...
        private DataTable Get_Dt_Nguon_DMBQP(Dictionary<string, string> arrGiaTriTimKiem)
        {
            ...
            using (var cmdvr = new SqlCommand("sp_nguon_dmbqp_edit", conn))
            {
