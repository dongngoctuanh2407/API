...
namespace VIETTEL.Models.DuToanBS
{
    ...
    public class DuToanBSPhanCapBangDuLieu : BangDuLieu
    {
        ...
        public DuToanBSPhanCapBangDuLieu(String iID_MaChungTu, Dictionary<string, string> arrGiaTriTimKiem, string MaND, string IPSua, string sKieuXem)
        {
            ...
            string iKyThuat = Convert.ToString(CommonFunction.LayTruong("DTBS_ChungTuChiTiet", "iID_MaChungTuChiTiet", iID_MaChungTu, "iKyThuat"));
