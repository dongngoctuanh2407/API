...
{
    public class PhongBan_DonViCT_BangDuLieu :    BangDuLieu_E
    {
        /// /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        ...
        public PhongBan_DonViCT_BangDuLieu(string id_pb, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua)
        {
            this._iID_Ma = id_pb;
            this._MaND = MaND;
            this._IPSua = IPSua;
            ...
            _dtChiTiet = Get_Dt_PhongBanCT_DonVi(arrGiaTriTimKiem);
            _dtChiTiet_Cu = _dtChiTiet.Copy();
            DienDuLieu();
        }

        private DataTable Get_Dt_PhongBanCT_DonVi(Dictionary<string, string> arrGiaTriTimKiem)
        {
            DataTable vR;
            ...
            using (var cmdvr = new SqlCommand("ns_phongban_donvi_edit", conn))
            {
                ...
                cmdvr.Parameters.AddWithValue("@sMaPhongBan", _iID_Ma);
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString($"{R["iID_MaPhongBanDonVi"]}_{R["id"]}");
