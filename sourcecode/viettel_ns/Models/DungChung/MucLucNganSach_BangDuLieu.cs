...
{
    public class MucLucNganSach_BangDuLieu:BangDuLieu
    {

        ///Chuc nang sua: load data man muc luc ngan sach
        ///Ngay sua: 5/5/2021
        ///Nguoi sua: anhht
        ///Noi dung: tang toc do load data man muc luc ngan sach
        ...
        /// <param name="loadData">Có lấy data chi tiết hay không</param>
        public MucLucNganSach_BangDuLieu(Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua, bool loadData = true)
        {
            this._iID_Ma = "";
            this._MaND = MaND;
            this._IPSua = IPSua;
            ...
            if (loadData)
            {
                _dtChiTiet = MucLucNganSachModels.Get_dtDanhSachMucLucNganSach(arrGiaTriTimKiem, MaND);
        ...
        protected void CapNhapDanhSachMaHang()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                String MaHang = Convert.ToString(R["iID_MaMucLucNganSach"]);
        ...
        protected void CapNhapDanhSachMaCot_Slide()
        {
            ...
            for (int j = 0; j < MucLucNganSachModels.arrDSTruong.Length; j++)
            {
                _arrDSMaCot.Add(MucLucNganSachModels.arrDSTruong[j]);
                _arrTieuDe.Add(MucLucNganSachModels.arrDSTruongTieuDe[j]);
                _arrWidth.Add(Convert.ToInt32(MucLucNganSachModels.arrDSTruongDoRong[j]));
