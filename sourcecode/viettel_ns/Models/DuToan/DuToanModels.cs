...
namespace VIETTEL.Models
{
    public class DuToanModels
    {
        ...
        public static String strDSTruongTienTieuDe =
            "Tên công trình,Ngày,Người,Chi tại kho bạc,Tồn kho,Hàng nhập,Tự chi,Chi tập trung,Hàng mua,Hiện vật,Phân cấp,Dự phòng";

        public static String strDSTruongTienTieuDe_ThuChi =
            "Tên công trình,Ngày,Người,Chi tại kho bạc,Tồn kho,Hàng nhập,Số tiền,Chi tập trung,Hàng mua,Hiện vật,Phân cấp,Dự phòng";

        public static String strDSTruongTien_So =
            "rNgay,rSoNguoi,rChiTaiKhoBac,rTonKho,rHangNhap,rTuChi,rChiTapTrung,rHangMua,rHienVat,rPhanCap,rDuPhong";
