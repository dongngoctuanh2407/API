...
namespace VIETTEL.Models
{
    ...
    /// </summary>
    public class DuToan_PhanCapBangDuLieu : BangDuLieu
    {
        ...
        public DuToan_PhanCapBangDuLieu(String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem, String MaND, String IPSua, String sLNS, String MaLoai)
        {
            ...
            {
                if (_dtBang.Rows[0]["sLNS"].ToString().Substring(0, 3) == "109" && _dtBang.Rows[0]["MaLoai"].ToString() != "3")
                {
                    SQL = String.Format(@"
            ...
            String iID_MaChungTuTo = Convert.ToString(CommonFunction.LayTruong("DT_ChungTuChiTiet", "iID_MaChungTuChiTiet", iID_MaChungTu, "iID_MaChungTu"));
            String iKyThuat = Convert.ToString(CommonFunction.LayTruong("DT_ChungTu", "iID_MaChungTu", iID_MaChungTuTo, "iKyThuat")); ;
            sLNS = Convert.ToString(_dtBang.Rows[0]["sLNS"]);
            ...
            _dtChiTiet = DuToan_ChungTuChiTietModels.GetChungTuChiTiet_PhanCap(_iID_Ma, arrGiaTriTimKiem, MaND, sLNS, sXauNoiMa, iKyThuat, MaLoai);
        ...
        protected void DienDuLieu(String sLNS, String MaLoai, String iKyThuat)
        {
            ...
            if (_arrDuLieu == null)
            {
                ...
                dr["rHienVat"] = rHienVat_PhanCap - (Tong_HV);
                dr["rDuPhong"] = 0;
        ...
        protected void CapNhap_arrDuLieu()
        {
            ...
            for (int i = 0; i < _dtChiTiet.Rows.Count; i++)
            {
                ...
                else if (i == 1)
                {
                    ...
                    double dConLaiTC = DuToan_ChungTuChiTietModels.dTongConLai(Convert.ToString(_dtBang.Rows[0]["iID_MaChungTuChiTiet"]), "rTuChi");
                    double dConLaiHV = DuToan_ChungTuChiTietModels.dTongConLai(Convert.ToString(_dtBang.Rows[0]["iID_MaChungTuChiTiet"]), "rHienVat");
