 ...
 ", DK, DKPhongBan, DKDonVi);
                                                   ...
                                                   String LoaiThongTri, String iID_MaPhongBan)
        {
            ...
            if (LoaiThongTri == "NghiepVu")
                sLNS = "102";
            if (LoaiThongTri == "BaoDam")
                sLNS = "104";
            if (LoaiThongTri == "DoanhNghiep")
                sLNS = "105";
            if (LoaiThongTri == "NhaNuoc")
                sLNS = "2";
            if (LoaiThongTri == "Khac")
                sLNS = "4";
            if (LoaiThongTri == "DacBiet")
                sLNS = "3";
            if (LoaiThongTri == "QPKhac")
                sLNS = "109";
        ...
        public static DataTable DanhSachLNSCoDuLieu(String iThang_Quy, String iID_MaNamNganSach, String MaND, String sLNS, String iID_MaPhongBan)
        {
            ...
            String SQL = String.Format(@"SELECT a.sLNS,a.sLNS+' - '+sMoTa as TenHT FROM 
                            ...
                            WHERE iTrangThai=1 {0} {1} AND iThang_Quy=@iThang_Quy AND iNamLamViec=@iNamLamViec ) a

                            INNER JOIN
                            (SELECT sLNS,sMoTa FROM NS_MucLucNganSach WHERE iTrangThai=1 AND LEN(sLNS)=7 AND sL='' AND iNamLamViec=@iNamLamViec ) as b
