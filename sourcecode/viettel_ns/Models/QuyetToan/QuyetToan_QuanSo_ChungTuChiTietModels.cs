    ...
    public class QuyetToan_QuanSo_ChungTuChiTietModels
    {
        ...
        public static void ThemQuanSoBienChe(String iID_MaChungTu, String MaND, String IPSua)
        {
            ...
            DataTable dtBienChe = Get_QuanSoBienChe(iNamLamViec, iThang_Quy,
                                                    ...
                                                    Convert.ToString(dtChungTu.Rows[0]["iLoai"]),"","",MaND);
        ...
        public static DataTable Get_dtQuyetToanChiTiet(String iLoai, String iID_MaChungTu, Dictionary<String, String> arrGiaTriTimKiem,String MaND)
        {
            DataTable vR;
            String SQL, DK;
            ...
            DataTable dtThangtruoc = Get_QuanSoThangTruoc(iNamLamViec, iThang, iID_MaDonVi, iLoai,"","",MaND);
            DataTable dtThangNay = Get_QuanSoThangTruoc(iNamLamViec, iThang+1, iID_MaDonVi, iLoai,"","",MaND);
            DataTable dtTrongThang = Get_QuanSoThangTruoc(iNamLamViec, iThang + 1, iID_MaDonVi, iLoai, "", "", MaND);
            //So ke Hoach
            DK = "iTrangThai=1 ";
            if (iLoai == "2")
            {
            ...
            for (int i = 0; i < vRCount; i++)
            {
                ...
                if (Convert.ToString(vR.Rows[i]["sKyHieu"]) == "400")
                {
                    for (int j = 0; j < arrDSTruongTien.Length - 4; j++)
                    {
                        vR.Rows[i][dtTrongThang.Columns[j].ColumnName] = dtTrongThang.Rows[0][j];
                    }
                }
        ...
        public static void Insert_FROM_Luong(String iID_MaChungTu, String MaND, String IPSua)
        {
            ...
            DataTable dt = Get_dtQuyetToanChiTiet("", iID_MaChungTu, null,MaND);
            ...
            dtChungTu.Dispose();
            dtQuanSo.Dispose();
            dt = Get_dtQuyetToanChiTiet("", iID_MaChungTu, null,MaND);
        ...
        public static DataTable Get_QuanSoBienChe(int iNamLamViec, int iThang, String iID_MaDonVi, String iLoai,String bCheckTongHop="",String iID_MaPhongBan="",String MaND="")
        {
            ...
            SqlCommand cmd = new SqlCommand();
            String DKDonVi = "", DKPhongBan = "",DK="iTrangThai=1";
            if (iID_MaPhongBan != "-2" && iID_MaPhongBan != "-1" && iID_MaPhongBan != "")
            {
           ...
           // DKDonVi = ThuNopModels.DKDonVi(MaND, cmd);
            ...
            String SQL = String.Format(@"SELECT skyHIeu, {0}  FROM QTQS_ChungTuChiTiet WHERE {1} {2} {3} AND iNamLamViec=@iNamLamViec AND iThang_Quy<=@iThang_Quy AND sKyHieu=@sKyHieu GROUP BY skyHIeu", DKSELECT,DK,DKPhongBan,DKDonVi);
        ...
        public static DataTable Get_QuanSoThangTruoc(int iNamLamViec, int iThang, String iID_MaDonVi, String iLoai,String bCheckTongHop="",String iID_MaPhongBan="",String MaND="")
        {
            String sTruongTien = MucLucQuanSoModels.strDSTruongTien;
            String[] arrDSTruongTien = sTruongTien.Split(',');
            ...
            if (iThang == 1)
            {
                DK += " AND ((iNamLamViec<=@iNamLamViecTruoc AND iThang_Quy<=12) OR (iNamLamViec=@iNamLamViec AND iThang_Quy=0))";
            ...
            String SQL = String.Format(@"SELECT {0}  FROM QTQS_ChungTuChiTiet WHERE iTrangThai=1  {1} {2} {3}", DKSELECT,DK,DKDonVi,DKPhongBan);
            cmd.CommandText = SQL;
            DataTable dt = Connection.GetDataTable(cmd);
            cmd.Dispose();
            return dt;
