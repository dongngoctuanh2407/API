...
{
    public class rptQuyetToan_BieuKiemTongHopController : Controller
    {
       
        public string sViewPath = "~/Report_Views/";
        private const String sFilePath = "/Report_ExcelFrom/QuyetToan/QuyetToanQuy/rptQuyetToan_BieuKiemTongHop.xls";

        public static String iID_MaPhongBan, iID_MaDonVi, iThang_Quy, iID_MaNamNganSach, MaND;
        public ActionResult Index()
        {
            ViewData["path"] = "~/Report_Views/QuyetToan/QuyetToanQuy/rptQuyetToan_BieuKiemTongHop.aspx";
        ...
        /// <returns></returns>
        public static DataTable rptQuyetToan_BieuKiemTongHop()
        {
...
FROM QTA_ChungTuChiTiet 
WHERE iTrangThai=1 AND iNamLamViec=@iNamLamViec AND iID_MaNamNganSach=1  {0} {1} {2}
AND sLNS LIKE '2%' AND sLNS NOT IN ('2120100','2010100','2200000','2100000')
GROUP BY iID_MaDonVi,sTenDonVi
...
", DKDonVi, DKPhongBan, DK, DKTrongKy);
        ...
        public ExcelFile CreateReport()
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptQuyetToan_BieuKiemTongHop");
            LoadData(fr);
        ...
        private void LoadData(FlexCelReport fr)
        {
            ...
            DataTable dtDonVi = rptQuyetToan_BieuKiemTongHop();
