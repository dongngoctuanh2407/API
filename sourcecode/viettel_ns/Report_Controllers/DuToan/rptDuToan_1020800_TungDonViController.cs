...
namespace VIETTEL.Report_Controllers.DuToan
{
    public class rptDuToan_1020700_TungDonViController : AppController
    {
        ...
        private const string sFilePath = "/Report_ExcelFrom/DuToan/rptDuToan_1020700_TungDonVi.xls";
        ...
        public ActionResult Index()
        {
            ...
            {
            ViewData["path"] = "~/Report_Views/DuToan/rptDuToan_1020700_TungDonVi.aspx";
            ViewData["PageLoad"] = "0";
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        //        private  DataTable getDuToan_1020700_TungDonVi(string iID_MaDonVi)
        //        {
        ...
        // WHERE iTrangThai=1  AND sLNS='1020700' AND iID_MaDonVi =@iID_MaDonVi AND {4} AND iNamLamViec=@iNamLamViec {1} {2}
        ...
        private DataTable getDuToan_1020700_TungDonVi(string iID_MaDonVi, string sLns)
        {
            #region sql
...
HAVING	SUM(rTuChi+rDuPhong)>0 OR 
        ...
        {
            DataTable data = getDuToan_1020700_TungDonVi(iID_MaDonVi, sLns);
