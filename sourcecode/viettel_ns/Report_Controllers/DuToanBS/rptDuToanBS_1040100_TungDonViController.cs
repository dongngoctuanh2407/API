...
{
    public class rptDuToanBS_1040100_TungDonViController : Controller
    {

        public string sViewPath = "~/Report_Views/";
        private String sFilePath = "/Report_ExcelFrom/DuToanBS/rptDuToanBS_1040100_TungDonVi.xls";
        private String sFilePath_Muc = "/Report_ExcelFrom/DuToanBS/rptDuToanBS_1040100_TungDonVi_Muc.xls";
        String iCapTongHop = "";
        String dNgayChungTu = "";
        ...
        public ActionResult Index()
        {
            ...
            {
                ViewData["path"] = "~/Report_Views/DuToanBS/rptDuToanBS_1040100_TungDonVi.aspx";
                ViewData["PageLoad"] = "0";
        ...
        public ExcelFile CreateReport(String path, String MaND, String iID_MaDonVi, String iID_MaDot)
        {
            ...
            fr = ReportModels.LayThongTinChuKy(fr, "rptDuToanBS_1040100_TungDonVi");
        ...
        /// <param name="NamLamViec"></param>
        /// <returns></returns>
        public DataTable DT_rptDuToanBS_1040100_TungDonVi(String MaND, String iID_MaDonVi, String iID_MaDot)
        {
...
,rDuPhong=SUM(rDuPhong/{3})
 ...
 WHERE iTrangThai=1  AND sLNS='1040100'  AND (MaLoai='' OR MaLoai='2') AND iNamLamViec=@iNamLamViec {1} {2} {0} AND iID_MaChungTu IN {4}
...
", DSNganh, DKPhongBan, DKDonVi, DVT, dsMaChungTu);
        ...
        public static DataTable DT_rptDuToanBS_1040100_TungDonVi_GhiChu(String MaND, String iID_MaDonVi, String iID_MaDot)
        {
            String DKCT="",DKDonVi = "", DKPhongBan = "";
            SqlCommand cmd = new SqlCommand();
            String dsMaChungTu = DuToanBS_ReportModels.DKMaChungTuCT(iID_MaDot, MaND);
            DKCT += " AND iID_MaChungTu IN" + dsMaChungTu;
...
", DSNganh, DKPhongBan, DKDonVi, DVT);
        ...
        {
            DataRow r;
            DataTable data = DT_rptDuToanBS_1040100_TungDonVi(MaND, iID_MaDonVi, iID_MaDot);
            DataTable dataGhiChu = DT_rptDuToanBS_1040100_TungDonVi_GhiChu(MaND, iID_MaDonVi, iID_MaDot);
