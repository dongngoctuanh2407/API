...
namespace VIETTEL.Report_Controllers.DuToanBS
{
    public class rptDuToanBS_ChiTieuNganSach2Controller : Controller
    {
        ...
        private const String VIEW_PATH_DUTOANBS_CHITIEU_NS = "~/Report_Views/DuToanBS/rptDuToanBS_ChiTieuNganSach2.aspx";
        private const String sFilePath_ChiTieuNganSach = "/Report_ExcelFrom/DuToanBS/rptDuToanBS_ChiTieuNganSach2.xls";
        int DVT = 1000;
        ...
        public ActionResult FormSubmit(String ParentID)
        {
            ...
            var canCu = Request.Form[ParentID + "_canCu"];
        ...
        /// <returns></returns>
        public ActionResult ViewPDF(String MaND, String iID_MaDot, String sLNS, String iID_MaDonVi, String iID_MaPhongBan, string canCu = null)
        {
            HamChung.Language();

            String sDuongDan = sFilePath_ChiTieuNganSach;

            ExcelFile xls = CreateReport(Server.MapPath(sDuongDan), MaND, sLNS, iID_MaDot, iID_MaDonVi, iID_MaPhongBan, canCu);
            ...
            string canCu = null)
        {
            ...
            //}
            //else
            var sTenDonVi = DonViModels.Get_TenDonVi(iID_MaDonVi, MaND);
        ...
        private void LoadData(FlexCelReport fr, String MaND, String sLNS, String iID_MaDot, String iID_MaDonVi, String iID_MaPhongBan)
        {
            ...
            {
                TongTien *= -1;
                Tien = "Âm " + CommonFunction.TienRaChu(TongTien);
            }
            else
            {
