...
function BangDuLieu_onCellAfterEdit(h, c) {
        if (h < Bang_nH - 1) {
            ...
            else if (Bang_arrMaCot[c] == "bPhanCap" && Bang_arrLaHangCha[h]==false) {
            ...
            else if (Bang_arrMaCot[c].startsWith("s")){
                var cs = 0;
                if (Bang_arrMaCot[c] == "sM") {
                }
                else if (Bang_arrMaCot[c] == "sLNS") {
        ...
        if (iLoai == "4") {
            ...
            var TongCongTC = Bang_arrGiaTri[0][17]
            var TongBD = 0;
            for (var j = 15; j < 23; j++) {
                tong = 0;
            ...
            Bang_GanGiaTriThatChoO(1, 17, TongCongTC - TongBD);
        ...
        if (iChiTapTrung == "1") {
            ...
            var ChiTieu = Bang_arrGiaTri[h][9];
            var ChiTapTrung = Bang_arrGiaTri[h][10];
            if(ChiTapTrung-ChiTieu>0)
                Bang_GanGiaTriThatChoO_colName(h, "sMauSac", sMauSac_TuChoi);
            else
