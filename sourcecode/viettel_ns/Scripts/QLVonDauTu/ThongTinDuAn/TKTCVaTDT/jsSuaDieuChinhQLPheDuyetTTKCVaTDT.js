...
function LoadDataViewNguonVon() {
    ...
    if (data != null) {
        for (var i = 0; i < data.length; i++) {
            ...
            dongMoi += "<td><input type='text' style='text-align: right' class='form-control txtGiaTriNguonVon' disabled onkeyup='ValidateNumberKeyUp(this);' onkeypress='return ValidateNumberKeyPress(this, event);' value='" + FormatNumber(data[i].fTienPheDuyet) + "'/></td>"
