    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            if (arrHasValue(resp.data)) {
                ...
                UpdateArrayNguonVonInitial(resp.data);
            }
...
function UpdateArrayNguonVonInitial(arrayNguonVonParam) {

    for (var i = 0; i < arrayNguonVonParam.length; i++) {
        arrNguonVon.push({
            id: (i + 1).toString(),
            //iID_QDDauTu_NguonVonID: arrNguonVon[i].iID_QDDauTu_NguonVonID,
            iID_NguonVonID: arrayNguonVonParam[i].iID_NguonVonID,
            fTienPheDuyet: arrayNguonVonParam[i].fTienPheDuyet,
            fGiaTriDieuChinh: 0,
            fGiaTriTruocDieuChinh: arrayNguonVonParam[i].fGiaTriTruocDieuChinh,
        })
    }
...
function LoadDataViewNguonVon() {
    ...
    if (data != null) {
        for (var i = 0; i < data.length; i++) {
            var dongMoi = "";
            dongMoi += "<tr>";
            dongMoi += "<td class='r_STT' style='text-align: center'>" + (i + 1) + "</td>";
            ...
            dongMoi += "<td><input type='text' style='text-align: right' disabled class='form-control txtGiaTriNguonVonTruocDC' onkeyup='ValidateNumberKeyUp(this);' onkeypress='return ValidateNumberKeyPress(this, event);' value='" + FormatNumber(data[i].fTienPheDuyet) + "'/></td>"
            dongMoi += "<td><input type='text' style='text-align: right' class='form-control txtGiaTriNguonVon' onkeyup='ValidateNumberKeyUp(this);' onkeypress='return ValidateNumberKeyPress(this, event);' value='" + FormatNumber(data[i].fTienPheDuyet) + "'/></td>"
...
function ThemMoiNguonVon() {
    ...
    dongMoi += "<td><div hidden></div><input type='text' style='text-align: right' disabled class='form-control txtGiaTriNguonVonTruocDC' onkeyup='ValidateNumberKeyUp(this);' onkeypress='return ValidateNumberKeyPress(this, event);'/></td>"
    dongMoi += "<td><div hidden></div><input type='text' style='text-align: right' class='form-control txtGiaTriNguonVon' onkeyup='ValidateNumberKeyUp(this);' onkeypress='return ValidateNumberKeyPress(this, event);'/></td>"
    dongMoi += "<td align='center'>";
    dongMoi += "<button class='btn-save btn-icon' type = 'button' onclick = 'CreateNguonVon(this, \"" + TBL_NGUON_VON_DAU_TU + "\")'> " +
        "<i class='fa fa-floppy-o fa-lg' aria-hidden='true'></i>" +
        "</button> ";
...
function LoadDataViewChiPhi() {
    ...
    items.forEach(x => {
        ...
        var stt = count;
        html += '<tr>';
        html += '<input type="hidden" class="r_IThuTu" value = "' + x.iThuTu + '"/> <input type="hidden" class="r_IdCreate" value = "' + duanChiPhiId + '"/>';
        ...
        html += '<td style="text-align:right"><input type="text" style="text-align: right" disabled class="form-control txtGiaTriChiPhiTruocDC" onkeyup="ValidateNumberKeyUp(this); " onkeypress="return ValidateNumberKeyPress(this, event); " value="' + FormatNumber(x.fTienPheDuyet) + '"/> </td>';
...
function CreateChiPhi(nutCreate) {
    ...
    var id = $(dongHienTai).find(".r_IdCreate").val();
...
function AddParrentInArrayChiPhiSave(parentId) {
    ...
    if (chiPhiParent != undefined) {
        chiPhiParent.iID_DuToan_ChiPhiID = "";
...
function ThemMoiChiPhiCon(nutThem) {
    ...
    var dongMoi = "";
    dongMoi += '<tr>';
    dongMoi += '<input type="hidden" class="r_IThuTu" value = "' + iThuTu + '"/> <input type="hidden" class="r_IdCreate" value = ""/>';
    ...
    dongMoi += '<td style="text-align:right"><input type="text" style="text-align: right" disabled class="form-control txtGiaTriChiPhiTruocDC" onkeyup="ValidateNumberKeyUp(this); " onkeypress="return ValidateNumberKeyPress(this, event); " /> </td>';
...
function EditChiPhi(nutEdit) {
    ...
    $(dongHienTai).find(".r_TenChiPhi").attr("disabled", false);
...
function DetailChiPhi(nutDetail) {
    ...
    if (arrHangMucSave.some(x => x.iID_DuAn_ChiPhi == chiPhiId)) {
        ...
        LoadViewHangMuc(arrHangMucByChiPhi,true);
        ...
        LoadViewHangMuc(arrHangMucByChiPhi,false);
        CalculateTienConLaiHangMuc(arrHangMucByChiPhi);
    }
}
...
function LoadViewHangMuc(data,isSaved) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].isEdit) {
            ...
            dongMoi += "<td  align='right'><div  hidden></div><input type='text' style='text-align: right' disabled  class='form-control txtGiaTriHMTruocDC' onkeyup='ValidateNumberKeyUp(this);' onkeypress='return ValidateNumberKeyPress(this, event);' value='" + FormatNumber(data[i].fTienPheDuyet) + "'/></td>";
...
function ThemMoiHangMucCon(nutThem) {
    ...
    dongMoi += "<td class='r_STT'></td><input type='hidden' id='" + hangMucId + "' class='r_iID_DuAn_HangMucID' value='" + hangMucId + "'/> <input type='hidden' class='r_HangMucID' value=''/> <input type='hidden' class='r_HangMucParentID' value='" + iIDDuAnHangMucID + "'/> <input type='hidden' class='r_IsEdit' value='true'/>";
    ...
    dongMoi += "<td  align='right'><div  hidden></div><input type='text' style='text-align: right' disabled  class='form-control txtGiaTriHMTruocDC' onkeyup='ValidateNumberKeyUp(this);' onkeypress='return ValidateNumberKeyPress(this, event);' /></td>";
...
function AddParrentInArrayHangMucSave(parentId) {
    ...
    if (hangMucParent != undefined) {
        hangMucParent.iID_DuToan_HangMuciID = '';
...
function GetFormDataThietKeThiCong() {
    var iID_ParentID = $("#iIDDuToanId").val();
