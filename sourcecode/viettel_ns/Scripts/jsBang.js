...
function Bang_LayTenTruongVaTruongGan(c) {
    ...
    else if (Bang_arrMaCot[c].startsWith("TenPhongBan")) {
        Truong = 'TenPhongBan';
        TruongGan = 'Id_PhongBan';
    }
...
//Chuc nang sua: scroll bi loop tren chrome
//Ngay sua: 5/5/2021
//Nguoi sua: anhht
//Noi dung: sua loi scroll bi loop khi cuon tren table tren trinh duyet chrome

// anhht: bien check co dang scroll hay khong
var scrolling = false;
Bang_fnScroll = function () {
    // anhht: neu khong dang scroll thi moi tiep tuc
    if (!scrolling) {
        scrolling = true;
        ...
        $('#' + Bang_ID_TB11_Div).scrollTop(yTop);
        scrolling = false;
    }
    return;
}
