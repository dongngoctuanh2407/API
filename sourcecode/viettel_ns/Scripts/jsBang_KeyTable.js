...
function KeyTable(oInit) {
    ...
    */
    function _fnKey(e) {
        ...
        switch (iKey) {
            ...
            case 13: /* return(Enter) */
                ...
                e.preventDefault();                
                var cell_orRow = window['Bang_Cell_OrRow'];
                alert
                if (cell_orRow){
    ...
    function _fnSetFocusNextRow() {
        ...
        y = _iOldY;
        while (true) {
            var pos = _fnGetNextRow(_iOldY, 1, 1);
            if (pos == null) return false;
            y = pos;
            c_DuLieu = (_tableId == BangDuLieuID_Slide) ? AnhXaCot_Slide_DuLieu(x) : AnhXaCot_Fixed_DuLieu(x);
    ...
    this.fnSetFocusNextRow = function () {
        return _fnSetFocusNextRow();
    }
