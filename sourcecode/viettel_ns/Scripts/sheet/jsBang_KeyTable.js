...
function KeyTable(oInit) {
    ...
    */
    ...
    this.fnSetViewportPosition = function (newH) {
        return _fnSetViewportPosition(newH);
    }
    ...
    function _fnSetViewportPosition(newH) {
        ...
        console.log("hmoi:" + hMoi);


        //if (hMoi != Bang_Viewport_hMin && !last_hmoi) {
    ...
    function _fnRefreshFocusClass() {
        if (_nOldFocus != null) {
            jQuery(_nOldFocus).removeClass(_sFocusClass);
            jQuery(_nOldFocus).removeClass(_sFocusClass_edit);
            $('tr').removeClass(_sFocusClass_edit);
            if (Bang_Viewport_hMin <= _iOldY && _iOldY < Bang_Viewport_hMin + Bang_Viewport_NMax) {
                ...
                if (!_bKeyCapture) {
                    ...
                    $(Bang_arrRow_Slide[_iOldY - Bang_Viewport_hMin]).addClass(_sFocusClass_edit);
                    $(Bang_arrRow_Fixed[_iOldY - Bang_Viewport_hMin]).addClass(_sFocusClass_edit);
                }
            }
        }
    }
    ...
    */
    function _fnKey(e) {
        ...
        // xac dinh phim vua bam, loai bo truong hop bi nhap focus 2 lan trong chrome
        ls_key = e.keyCode;
        ...
        if (_that.block || !_bKeyCapture || document.getElementById("txtONhapDuLieu")) {
            console.log("ingore input");
            return true;
        }

        console.log("_that.block:" + _that.block);
        console.log("_bKeyCapture:" + _bKeyCapture);
        console.log("txtONhapDuLieu:" + document.getElementById("txtONhapDuLieu"));
        ...
        switch (iKey) {
            ...
            default: /* Nothing we are interested in */
                ...
                if (browserId == 'chrome' || browserId == "ie") {
                ...
                console.log("input: " + KeyTable_sKyTuVuaNhap);
    ...
    function _fnSetFocusNextCell() {
        ...
        while (true) {
            ...
            if (Bang_arrEdit[y][c_DuLieu]) {
                ...
                if ((ls_key == '13' && keyPressCounter == 0) || keyPressCounter == 0) {
    ...
    */
    function _fnInit(oInit, that) {
        ...
        */
        ...
        console.log(jQuery.browser.browser);
