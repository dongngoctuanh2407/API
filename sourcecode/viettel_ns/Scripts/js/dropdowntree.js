...
;(function ( $, window, document, undefined ) {
  ...
  ComboTree.prototype.init = function () {
    ...
    this._elemWrapper = $('#' + this.comboTreeId + 'Wrapper');
      ...
      this._elemArrowBtn = $('<div id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn" type="button"><span class="fa fa-chevron-down comboTreeArrowBtnImg" aria-hidden="true"></span></div>');
  ...
  ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
    ...
    if (isThereSubs)
        itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '<span class="fa fa-chevron-circle-right" aria-hidden="true"></span>' : '<span class="fa fa-chevron-circle-right" aria-hidden="true"></span>') + '</span>'; // itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '+' : '&minus;') + '</span>';
  ...
  ComboTree.prototype.toggleSelectionTree = function (item, direction) {
    ...
    if (direction === undefined){
      if ($(subMenu).is(':visible'))
          $(item).children('span.comboTreeParentPlus').html('<span class="fa fa-chevron-circle-right" aria-hidden="true"></span>'); //$(item).children('span.comboTreeParentPlus').html("+");
      else
          $(item).children('span.comboTreeParentPlus').html('<span class="fa fa-chevron-circle-down" aria-hidden="true"></span>'); //$(item).children('span.comboTreeParentPlus').html("&minus;");
  ...
  ComboTree.prototype.setSource = function(source) {
    ...
    ComboTree.prototype.clearSelection = function () {
        if (this.options.isMultiple && this._selectedItems.length > 0) {
            ...
            let itemElem = $("#" + this.comboTreeId + 'Li' + this._selectedItem.id);
            $(itemElem).find("input").prop('checked', false);
