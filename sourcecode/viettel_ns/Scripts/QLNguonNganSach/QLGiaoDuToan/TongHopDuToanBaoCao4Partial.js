function GetBaoCao() {
    ...
    $.ajax({
        type: "POST",
        url: "/QLNguonNganSach/BaoCaoNguonNS/TongHopGiaoDuToanBaoCao4Partial",
        data: {
            iNguonNganSach: $("#iID_Nguon").val(), dDateFrom: $("#txtTuNgay").val(), dDateTo: $("#txtDenNgay").val(),
            sSoQuyetDinh: $("#txtsSoQuyetDinh").val(), dvt: $("#dvt").val()
        },
...
function OpenModalChiTietQuyetDinh(sSoQuyetDinh) {
    $.ajax({
        type: "POST",
        dataType: "html",
        url: "/QLNguonNganSach/BaoCaoNguonNS/ChiTietQuyetDinhBaoCao4Partial",
        data: { sSoQuyetDinh: sSoQuyetDinh },
        success: function (data) {
            window.open("TongHopGiaoDuToanBaoCao4Partial.cshtml")
