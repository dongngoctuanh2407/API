...
var jsDuToan_Url = '';
var jsDuToan_Url_Submit = '';
function jsDuToan_LoadLaiChiTiet() {
    if ($("#tabs-1").css("display") != "none") {
        var url = jsDuToan_Url_Frame;
        //        var urlSubmit = jsDuToan_Url_Submit;

        // var iframe = document.getElementById("ifrChiTietChungTu").contentWindow.document;

        // var inputs = iframe.getElementsByTagName('form');
        //        inputs[0].submit();
        ...
        //  alert(1);
        //reload lai trang
       jsDuToan_Search_inteval=setInterval(function () {
...
function TinhTong(ParentID) {
    var Tong = 0;
    var DSTruongTien = "_rChiTaiKhoBac,_rTonKho,_rTuChi,_rChiTaiNganh,_rHangNhap,_rHangMua,_rHienVat,_rDuPhong,_rPhanCap";
