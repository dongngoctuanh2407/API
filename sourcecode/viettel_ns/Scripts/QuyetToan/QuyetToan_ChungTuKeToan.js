...
function BangDuLieu_onKeypress_F2(h, c) {
    if (BangDuLieu_DuocSuaChiTiet && h < Bang_nH - 1) {
        ...
        var arrTruongTien = "rTuChi,rHienVat".split(',');
        ...
        var arrTruongChu = "sSoBangKe,sSoChungTu,iNgay,iThang,sNoiDung,sTenDonVi,iID_MaDonVi".split(',');
