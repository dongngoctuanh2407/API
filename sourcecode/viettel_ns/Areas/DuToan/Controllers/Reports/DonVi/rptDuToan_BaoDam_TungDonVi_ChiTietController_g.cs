...
namespace VIETTEL.Areas.DuToan.Controllers
{
    public class rptDuToan_BaoDam_TungDonVi_ChiTietController : FlexcelReportController
    {
        ...
        public ActionResult Index()
        {
            ...
            var nganhList = _ngansachService.ChuyenNganh_GetAll(PhienLamViec.iNamLamViec, Username).ToSelectList("Id", "Nganh", "-1", "-- Chọn chuyên ngành --");
            ...
            string ext = "pdf")
        {
            ...
            var tenNganh = "Ngành: " + _ngansachService.ChuyenNganh_Get(PhienLamViec.iNamLamViec, _id_nganh);
        ...
        private ExcelFile createReport()
        {
            ...
            var tenNganh = string.IsNullOrWhiteSpace(_id_nganh) || _id_nganh == "-1" ? string.Empty : "Ngành: " + _ngansachService.ChuyenNganh_Get(PhienLamViec.iNamLamViec, _id_nganh);
        ...
        private DataTable getTable(string nam, string id_phongban, string id_nganh, int loaiBaoCao, string username)
        {
            ...
            using (var conn = _connectionFactory.GetConnection())
            {
                ...
                using (var cmd = new SqlCommand("sp_dutoan_report_baodam_tungdonvi_chitiet", conn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@nganh", id_nganh.ToParamString());
