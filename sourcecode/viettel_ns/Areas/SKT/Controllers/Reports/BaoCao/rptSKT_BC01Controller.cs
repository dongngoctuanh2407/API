...
{
    public class rptSKT_BC01Controller : FlexcelReportController
    {
        private const string _filePath = "~/Report_ExcelFrom/SKT/BaoCao/rptSKT_BC01.xls";
        private const string _filePath_b = "~/Report_ExcelFrom/SKT/BaoCao/rptSKT_BC01b.xls";
        ...
        public ActionResult Index()
        {
            ...
            return View(@"~/Areas\SKT\Views\Reports\BaoCao\rptSKT_BC01.cshtml", vm);
        }
        ...
        public JsonResult Ds_DonVi(string id_PhongBan)
        {
            ...
            var data = _SKTService.Get_DonVi_TheoBql_ExistData(PhienLamViec.iNamLamViec, PhienLamViec.iID_MaDonVi, id, id).Select("LEN(Id) = 2 and Id not in ('76','77','79')").CopyToDataTable();
        ...
        private ExcelFile createReport()
        {
            ...
            var filename = Request.GetQueryStringValue("b") == 0 ? _filePath : _filePath_b;
