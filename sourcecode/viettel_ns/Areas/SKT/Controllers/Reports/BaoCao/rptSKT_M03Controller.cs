...
{
    public class rptSKT_M03Controller : FlexcelReportController
    {
        #region var def
        public string _viewPath = "~/Areas/SKT/Views/Reports/BaoCao/";
        private const string _filePath = "~/Report_ExcelFrom/SKT/PhuLuc/rptDuToanKT_M03a.xls";
        private const string _filePath_trinhky = "~/Report_ExcelFrom/SKT/TrinhKy/rptDuToanKT_M03a_trinhky.xls";
        private const string _filePath_trinhky2 = "~/Report_ExcelFrom/SKT/TrinhKy/rptDuToanKT_M03a_trinhky2.xls";
        ...
        public ActionResult Index()
        {
            ...
            var data = _sKTService.Get_DonVi_TheoBql_ExistData(PhienLamViec.iNamLamViec, getParamUsername(), GetPhongBanId(PhienLamViec.iID_MaPhongBan));
            var vm = new rptSKT_M03ViewModel
            {
        ...
        {
            var data = _sKTService.Get_DonVi_TheoBql_ExistData(PhienLamViec.iNamLamViec, getParamUsername(), GetPhongBanId(id_PhongBan));
