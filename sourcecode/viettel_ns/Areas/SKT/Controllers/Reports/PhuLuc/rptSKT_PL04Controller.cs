...
{
    public class rptSKT_PL04Controller : FlexcelReportController
    {
        public string _viewPath = "~/Areas/SKT/Views/Reports/PhuLuc/";
        private string _filePath = "~/Areas/SKT/FlexcelForm/PhuLuc/rptSKT_PL04_Bia.xls";
        private string _filePath_trinhky = "~/Areas/SKT/FlexcelForm/PhuLuc/rptSKT_PL04_Bia_TrinhKy.xls";
        private const string _filePath_ct = "~/Areas/SKT/FlexcelForm/PhuLuc/rptSKT_PL04_CT.xls";
        private const string _filePath_ct_lm = "~/Areas/SKT/FlexcelForm/PhuLuc/rptSKT_PL04_CT_LM.xls";
        private const string _filePath_ct_lm2 = "~/Areas/SKT/FlexcelForm/PhuLuc/rptSKT_PL04_CT_LM2.xls";
        private const string _filePath_ct_lm3 = "~/Areas/SKT/FlexcelForm/PhuLuc/rptSKT_PL04_CT_LM3.xls";
        private const string _filePath_ct_trinhky = "~/Areas/SKT/FlexcelForm/PhuLuc/rptSKT_PL04_CT_TrinhKy.xls";
        ...
        public JsonResult Ds_To(int loaiBC = 1, int muc = 4, int nd = 1)
        {
            var sql = "skt_report_pl04b";
            if (muc == 2)
                sql = "skt_report_pl04b_m";
            ...
            int dvt = 1000)
        {
            ...
            var filename = loai != 2 ? "BDKT_Bìa" + "." + ext : "BDKT_ChiTiet_Tờ_" + to + "." + ext;
        ...
        private DataTable GetTable()
        {
            ...
            {
                if (_muc == 4)
                    sql = "skt_report_pl04a";
                else
                    sql = "skt_report_pl04a_m";
            } else
            {
                if (_muc == 4)
                    sql = "skt_report_pl04b";
                else
                    sql = "skt_report_pl04b_m";
            }
            using (var conn = _connectionFactory.GetConnection())
        ...
        private string GetFilePath(int loaiBaoCao, int loai)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        case 2:
                            return _filePath_ct_lm;
                        case 3:
                            return _filePath_ct_lm2;
                        case 4:
                            return _filePath_ct_lm3;
                        default:
                            return _filePath_ct;
                    }
                }
