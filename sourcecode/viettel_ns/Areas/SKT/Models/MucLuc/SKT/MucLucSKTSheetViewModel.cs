...
{
    public class MucLucSKTSheetTable : SheetTable
    {
        public MucLucSKTSheetTable(bool parentRowEditable = false) : base(false, parentRowEditable)
        {
        }

        public MucLucSKTSheetTable(Dictionary<string, string> filters, bool parentRowEditable = false) : this(parentRowEditable)
        {
            _filters = filters ?? new Dictionary<string, string>();
        }

        public MucLucSKTSheetTable(NameValueCollection query, bool parentRowEditable = false) : this(parentRowEditable)
        {
    ...
    public class MucLucSKTViewModel
    {
        public MucLucSKTViewModel()
        {
