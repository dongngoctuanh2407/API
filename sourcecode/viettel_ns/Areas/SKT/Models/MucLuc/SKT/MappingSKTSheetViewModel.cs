...
{
    public class MappingSKTSheetTable : SheetTable
    {
        public MappingSKTSheetTable(bool parentRowEditable = false) : base(false, parentRowEditable)
        {
        }

        public MappingSKTSheetTable(Dictionary<string, string> filters, bool parentRowEditable = false) : this(parentRowEditable)
        {
            _filters = filters ?? new Dictionary<string, string>();
        }

        public MappingSKTSheetTable(NameValueCollection query, bool parentRowEditable = false) : this(parentRowEditable)
        {
    ...
    public class MappingSKTViewModel
    {
        public MappingSKTViewModel()
        {
