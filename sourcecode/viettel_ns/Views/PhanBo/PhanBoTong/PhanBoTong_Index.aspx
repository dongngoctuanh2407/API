...
<div class="box_tong">
    ...
    for (i = 0; i < dt.Rows.Count; i++)
    {
            ...
            if (R != null)
            {
                ...
                {
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "PhanBo_Tong", new { iID_MaPhanBo = R["iID_MaPhanBo"]}), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");                    
                }
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "PhanBo_Tong", new { iID_MaPhanBo = R["iID_MaPhanBo"] }), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
