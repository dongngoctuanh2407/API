...
<div class="box_tong">
    ...
    <table class="mGrid" id="<%= ParentID %>_thList">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "PhanBo_ChiTieu", new { iID_MaChiTieu = R["iID_MaChiTieu"], MaDotPhanBo = MaDotPhanBo }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "PhanBo_ChiTieu", new { iID_MaChiTieu = R["iID_MaChiTieu"], MaDotPhanBo = MaDotPhanBo }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }
