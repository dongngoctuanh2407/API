    ...
    for (i = 0; i < dtDonVi.Rows.Count; i++)
        if(Convert.ToString(dtDonVi.Rows[i]["iID_MaDonVi"])!=PhanBo_PhanBoNganh_BangDuLieu.iID_MaDonViChoPhanBo)
        {
            ...
            if (R != null)
            {
                ...
                {
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "PhanBo_PhanBo", new { iID_MaPhanBo = R["iID_MaPhanBo"], iID_MaChiTieu = iID_MaChiTieu }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "PhanBo_PhanBo", new { iID_MaPhanBo = R["iID_MaPhanBo"], iID_MaChiTieu = iID_MaChiTieu }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                }
