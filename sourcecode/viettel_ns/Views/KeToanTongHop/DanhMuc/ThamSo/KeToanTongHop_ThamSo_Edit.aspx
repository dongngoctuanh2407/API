            ...
            <table cellpadding="0"  cellspacing=""="0" border="0" width="70%">
                    ...
                    <td class="td_form2_td1"><div>Ký hiệu&nbsp;<span style="color: Red;">*</span></div></td>
                     <td class="td_form2_td5">
                      ...
                      <%=MyHtmlHelper.TextBox(ParentID, sKyHieu, "sKyHieu", "", "class=\"form-control\" tab-index='-1'")%>
                       ...
                       <%=MyHtmlHelper.TextBox(ParentID, sKyHieu, "sKyHieu", "", "class=\"form-control\" tab-index='-1' readonly=\"readonly\"")%>
               ...
               <tr>
                    <td class="td_form2_td1"><div>Nội dung&nbsp;<span style="color: Red;">*</span></div></td>
                     <td class="td_form2_td5">
                        <div>
                            <%=MyHtmlHelper.TextBox(ParentID, sNoiDung, "sNoiDung", "", "class=\"form-control\"")%>
                ...
                <tr>
                    <td class="td_form2_td1"><div>Tham số&nbsp;<span style="color: Red;">*</span></div></td>
                     <td class="td_form2_td5">
                        <div>
                            <%=MyHtmlHelper.TextBox(ParentID, sThamSo, "sThamSo", "", "class=\"form-control\"")%>
                    ...
                    <td class="td_form2_td1"><div>Phương án thuộc báo cáo&nbsp;<span style="color: Red;">*</span></div></td>
                     <td class="td_form2_td5">
                       <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, optLoaiBaoCao, sBaoCao_ControllerName, "sBaoCao_ControllerName", null, "class=\"form-control\"")%>
