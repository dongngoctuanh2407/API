    ...
    <div class="custom_css box_tong">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    ...
                    <td align="right" style="padding-right: 10px;">
                        <button id="Button2" class="btn btn-info pull-right" onclick="javascript:location.href='<%=strCopy %>'" ><i class="fa fa-plus" aria-hidden="true"></i>Lấy dữ liệu năm trước</button>
                    <%} %>
        ...
        <table class="mGrid">
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "KeToanTongHop_ThamSo", new { iID_MaThamSo = R["iID_MaThamSo"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                   <%-- <% if (bChoPhepXoa == "True" || bChoPhepXoa == "true")
                       { %>--%>
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "KeToanTongHop_ThamSo", new { iID_MaThamSo = R["iID_MaThamSo"], bChoPhepXoa = R["bChoPhepXoa"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                  <%--  <%}%>--%>
                </td>
            </tr>
            <%} %>
