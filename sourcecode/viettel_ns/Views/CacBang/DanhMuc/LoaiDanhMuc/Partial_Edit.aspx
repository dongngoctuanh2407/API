	...
	<tr>
		...
		<td width="30%" align="right">
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="right">
        	    <tr>
            	    <td>
                        <button class="btn btn-primary" type="submit" id="Submit1" style="padding: 2px 5px;"><i class="fa fa-download"></i>Lưu</button>
            	            <!-- <input type="submit" class="button" id="Submit1" value="Lưu" /> -->
            	    </td>
                    <td width="5px"></td>
                    <td>
                        <button class="btn btn-default"  type="button" onclick="history.go(-1)" style="padding: 2px 5px;"><i class="fa fa-ban"></i>Hủy</button>
            ...
            <table cellpadding="0"  cellspacing=""="0" border="0" class="table_form2" >
                <tr>
                    ...
                    <td class="td_form2_td5"><div>
                        <%= MyHtmlHelper.TextBox(ParentID, data, "sTen", sDanhSachTruongCam, "class=\"form-control\"")%>
                ...
                <tr>
                    ...
                    <td class="td_form2_td5"><div>
                        <%= MyHtmlHelper.TextBox(ParentID, data, "sTenBang", sDanhSachTruongCam, "class=\"form-control\"")%>
