...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
		...
		<td  width="30%" align="right">	
		    <a href="<%=urlSort %>" class="mr-10"><button class="btn btn-info"><i class="fa fa-sort" style="padding: 0px" aria-hidden="true"></i><%=NgonNgu.LayXau("Sắp xếp")%></button></a>
		</td>
		<td  width="30%" align="right">			    
			<a href="<%=urlSua%>"><button class="btn btn-primary"><i class="fa fa-pencil-square-o" style="padding: 0px" aria-hidden="true"></i><%=NgonNgu.LayXau("Sửa")%></button></a>
		</td>
	</tr>
</table>
