	...
	<tr>
		...
		<td width="30%" align="right">
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="right">
        	    <tr>
            	    <td>
                        <button class="btn btn-primary" style="padding: 2px 5px;" onclick="javascript:return ctlDanhMuc_list_btnLuu_click();"><i class="fa fa-download"></i> <%=NgonNgu.LayXau("Lưu")%></button>
            	        <!-- <a href="#" onclick="javascript:return ctlDanhMuc_list_btnLuu_click();" class="button4"><%=NgonNgu.LayXau("Lưu")%></a> -->
            	    </td>
                    <td width="5px"></td>
                    <td>
                        <button class="btn btn-default" style="padding: 2px 5px;" ><i class="fa fa-ban"></i> <%=NgonNgu.LayXau("Hủy")%></button>
