...
<div class="custom_css box_tong">
	<div class="title_tong">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
            	<td>
                	<span><%=NgonNgu.LayXau("Danh mục") %></span>
                    
                </td>
                <td>
                     <span class="pull-right mr-10 aToBtn">
...
<table cellpadding="0" cellspacing="0" border="0" class="mGrid">
    ...
    <tr <%=classtr %>>
        ...
        <td style="padding: 3px 2px;text-align: center">
            <%= MyHtmlHelper.ActionLink(urlEdit, "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", sDanhSachChucNangCam)%>
            
            <%= MyHtmlHelper.ActionLink(urlDelete, "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", sDanhSachChucNangCam)%>
        </td>
    </tr>
    <%}
        dt.Dispose();
