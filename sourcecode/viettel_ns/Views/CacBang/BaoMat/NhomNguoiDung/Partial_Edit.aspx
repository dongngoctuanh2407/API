          ...
          <table width="100%" cellpadding="0"  cellspacing=""="0" border="0" class="table_form2" >
            <tr>
                ...
                <td class="td_form2_td5"><div>
                     <%= MyHtmlHelper.TextBox(ParentID,data,"sTen", sDanhSachTruongCam, "style=\"width:500px;\"class=\"form-control\"")%>
            ...
            <tr>
                ...
                <td class="td_form2_td5"><div>
                    ...
                    %>
                    <%=MyHtmlHelper.DropDownList(ParentID, slDonVi, data, "iID_MaDonVi", null, "style=\"width:500px;\"class=\"form-control\"")%>
                </div></td>
            </tr>
        </table>
      </div>
	        ...
	        <td  width="30%" align="right">						
                <table cellpadding="0" cellspacing="0" border="0" align="right">
        	        <tr>
                        ...
                        <td width="5px"></td>
                        <td>
    <%--                        <input type="button" value="<%=NgonNgu.LayXau("Hủy")%>" class="button4" onclick="javascript:history.go(-1);" />--%>
