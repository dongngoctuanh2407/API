        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
                ...
                <td align="right" style="padding-right: 10px;">
                    <%=MyHtmlHelper.ButtonLink(Url.Action("Create", "NhomNguoiDung", new { MaNhomNguoiDungCha = 1 }), "Thêm nhóm người dùng", "Create", sDanhSachChucNangCam, "class=\"btn btn-primary\"")%>
                    <%=MyHtmlHelper.ButtonLink(Url.Action("Register", "Account"), "Đăng ký người dùng mới", null, null, "class=\"btn btn-info\"")%>
                </td>
            </tr>
        </table>
    </div>           
