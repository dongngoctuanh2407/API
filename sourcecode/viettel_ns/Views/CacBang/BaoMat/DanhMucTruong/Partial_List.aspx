        ...
        <tr>
            ...
            for (i = 0; i <= dt.Rows.Count - 1; i++)
            {
                ...
                <tr <%=classtr %>>
                    ...
                    <td align="center">
                        <%= MyHtmlHelper.ActionLink(urlEdit, "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", null)%>
                    </td>
                    <td align="center">
                        <%= MyHtmlHelper.ActionLink(urlDelete, "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", null)%>
                    </td>
                </tr>
             <%   
            }
