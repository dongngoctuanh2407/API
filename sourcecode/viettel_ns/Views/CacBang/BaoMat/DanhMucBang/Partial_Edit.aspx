          ...
          <table width="100%" cellpadding="0"  cellspacing=""="0" border="0" class="table_form2" >
            <tr>
               ...
               <td class="td_form2_td5"><div>
                     <%= MyHtmlHelper.DropDownList(ParentID, slBang, data, "sTenBang", sDanhSachTruongCam, "class=\"form-control\" style=\"width: 50%\"")%>
            ...
            <tr>
               ...
               <td class="td_form2_td5"><div>
                     <%= MyHtmlHelper.TextBox(ParentID, data, "sTenBangHT", sDanhSachTruongCam,  "class=\"form-control\" style=\"width: 50%\"")%>
    ...
    <tr>
	    ...
	    <td  width="30%" align="right">						
            <table cellpadding="0" cellspacing="0" border="0" align="right">
        	    <tr>
            	    <td>
                        <%--<input type="submit" type="button" class="button4" value="<%=NgonNgu.LayXau("Lưu")%>"/>--%>
