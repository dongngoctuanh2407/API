...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        Nguon_BTCBQPCT_BangDuLieu bang = new Nguon_BTCBQPCT_BangDuLieu(Id_MaNguon,loai,arrGiaTriTimKiem, MaND, IPSua);
        ...
        string DetailSubmit = Url.Action("DetailSubmit", "Nguon_BTCBQP", new { loai = loai, Id_MaNguon = Id_MaNguon });
    %>
