...
<div class="box_tong">
    <div id="nhapform">
        <div id="form2">
            ...
            <tr>
                <%
                    for (int j = 0; j < arrDSTruong.Length; j++)
                    {
                        ...
                        string strAttr = string.Format("class='input1_4' onkeypress='jsCTCap_CTPC_Search_onkeypress(event)' search-control='1' search-field='{1}' style='width:{0}px;height:22px;'", iColWidth - 2, arrDSTruong[j]);
                        if (CoTabIndex)
                        {
            ...
            <iframe id="ifrChiTietChungTu" width="100%" height="538px" src="<%= Url.Action("ChungTuChiTiet_Frame", "ChungTuCap_ChungTuChiTiet_PC", new {Id_CTCap=Id_CTCap, Id_NguonBTC=Id_NguonBTC})%>"></iframe>
        </div>
    </div>
</div>