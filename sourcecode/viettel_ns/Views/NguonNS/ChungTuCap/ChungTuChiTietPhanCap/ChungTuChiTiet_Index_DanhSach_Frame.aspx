...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        else
        {
            ...
            Nguon_CTCapChiTietPC_BangDuLieu bang = new Nguon_CTCapChiTietPC_BangDuLieu(Id_CTCap, Id_NguonBTC, arrGiaTriTimKiem, MaND, IPSua);
            string BangID = "BangDuLieu";
            int Bang_Height = 470;
            int Bang_FixedRow_Height = 50;
            string BackURL = Url.Action("Index", "ChungTuCap_ChungTu");
    %>
        ...
        {
        %>  <form id="formDuyet" action="<%=Url.Action("DetailSubmit", "ChungTuCap_ChungTuChiTiet_PC", new{ Id_CTCap=Id_CTCap, Id_NguonBTC=Id_NguonBTC })%>" method="post">            
    ...
    <script src="<%= Url.Content("~/Scripts/NguonNS/jsNguon_CTCap_PCCT.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>"
        type="text/javascript"></script>
