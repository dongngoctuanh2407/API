...
<script src="<%= Url.Content("~/Scripts/NguonNS/jsNguon_CTChi_PCCT.js") %>" type="text/javascript"></script>
        ...
        <tr>
            ...
            <td align="left">
                <div style="padding-bottom: 5px; color: #ec3237;">
                    ...
                    |
                    <%=MyHtmlHelper.ActionLink(Url.Action("Index", "ChungTuCap_ChungTu"), "Danh sách chứng từ chi")%>
                </div>
            </td>
            ...
            <div class="box_tong">
                ...
                <div id="nhapform">
                    <div id="form2">
                        ...
                        <%Html.RenderPartial("~/Views/NguonNS/ChungTuCap/ChungTuChiTietPhanCap/ChungTuChiTiet_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet_Index", MaND = User.Identity.Name }); %>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            jsNguon_CTCap_PC_Url_Frame = '<%=Url.Action("ChungTuChiTiet_Frame", "ChungTuCap_ChungTuChiTiet_PC", new { Id_CTCap = Id_CTCap, Id_NguonBTC = Id_NguonBTC})%>';
            $("#tabs").tabs();
        });
    </script>
</asp:Content>
