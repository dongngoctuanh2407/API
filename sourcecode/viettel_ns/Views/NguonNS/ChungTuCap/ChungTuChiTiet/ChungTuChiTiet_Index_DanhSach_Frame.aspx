...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        else
        {
            ...
            Nguon_CTCapChiTiet_BangDuLieu bang = new Nguon_CTCapChiTiet_BangDuLieu(Id_CTCap, arrGiaTriTimKiem, MaND, IPSua);
    ...
    <script src="<%= Url.Content("~/Scripts/NguonNS/jsNguon_CTCap_CT.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>"
        type="text/javascript"></script>
    ...
    <script type="text/javascript">
        function Huy() {
         ...
         $(document).ready(function () {
            ...
            jsNguon_CTCap_PC_Url = '<%=Url.Action("Index", "ChungTuCap_ChungTuChiTiet_PC")%>';
        });
    </script>
