...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        string ParentID = "NguonNS_ChungTuCap";
        ...
        DataTable dtALL = _nguonNSService.GetDSChungTu("Nguon_CTChi", "cap", Nam);     
        ...
        string strThemMoi = Url.Action("Edit", "ChungTuCap_ChungTu");
    %>
    ...
    <div class="box_tong">
        ...
        <div id="Div1">
            <div id="Div2">
                <%
                using (Html.BeginForm("EditSubmit", "ChungTuCap_ChungTu", new { ParentID = ParentID}))
                {
                %>
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "ChungTuCap_ChungTu", new { Id = R["Id"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "", "title=\"Sửa chứng từ\"");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "ChungTuCap_ChungTu", new { Id = R["Id"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "", "title=\"Xóa chứng từ\"");

                    string strTongTien = CommonFunction.DinhDangSo(Convert.ToString(R["TongTien"]));
                    string strURL = MyHtmlHelper.ActionLink(Url.Action("Index", "ChungTuCap_ChungTuChiTiet", new { Id_CTCap = R["Id"] }).ToString(), "<img src='../Content/Themes/images/btnSetting.png' alt='' />", "Detail", null, "title=\"Xem chi tiết chứng từ\"");                   
            ...
            <tr>
                ...
                <td align="center">
                    <b>
                        <%=MyHtmlHelper.ActionLink(Url.Action("Index", "ChungTuCap_ChungTuChiTiet", new { Id_CTCap = R["Id"] }).ToString(),dt.Rows[i]["ChungTu"].ToString(), "Detail", "")%></b>
                </td>
                <td align="center">
