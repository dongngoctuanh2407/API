...
<script src="<%= Url.Content("~/Scripts/NguonNS/jsNguon_CTThu_CT.js") %>" type="text/javascript"></script>
    <%
        ...
        <tr>
            ...
            <td align="left">
                <div style="padding-bottom: 5px; color: #ec3237;">
                    ...
                    |
                    <%=MyHtmlHelper.ActionLink(Url.Action("Index", "ChungTuThu_ChungTu"), "Danh sách chứng từ thu")%>
                </div>
            </td>
            ...
            <div class="box_tong">
                ...
                <div id="nhapform">
                    <div id="form2">
                        ...
                        <%Html.RenderPartial("~/Views/NguonNS/ChungTuThu/ChungTuChiTiet/ChungTuChiTiet_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet_Index", MaND = User.Identity.Name }); %>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            jsNguon_CTThu = "<%=Id_CTThu%>";
            jsNguon_CTThu_Url_Frame = '<%=Url.Action("ChungTuChiTiet_Frame", "ChungTuThu_ChungTuChiTiet", new { Id_CTThu = Id_CTThu})%>';
            $("#tabs").tabs();
        });
    </script>
</asp:Content>
