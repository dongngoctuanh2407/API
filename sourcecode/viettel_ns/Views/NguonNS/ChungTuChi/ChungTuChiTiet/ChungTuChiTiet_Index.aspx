...
<script src="<%= Url.Content("~/Scripts/NguonNS/jsNguon_CTChi_CT.js") %>" type="text/javascript"></script>
            ...
            <div class="box_tong">
                ...
                <div id="nhapform">
                    <div id="form2">
                        ...
                        <%Html.RenderPartial("~/Views/NguonNS/ChungTuChi/ChungTuChiTiet/ChungTuChiTiet_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet_Index", MaND = User.Identity.Name }); %>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            jsNguon_CTChi_Url_Frame = '<%=Url.Action("ChungTuChiTiet_Frame", "ChungTuChi_ChungTuChiTiet", new { Id_CTChi = Id_CTChi})%>';
            $("#tabs").tabs();
        });
    </script>
</asp:Content>
