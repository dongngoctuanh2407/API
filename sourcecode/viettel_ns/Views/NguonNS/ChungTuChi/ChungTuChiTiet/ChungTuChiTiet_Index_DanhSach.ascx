...
<div class="box_tong">
    <div id="nhapform">
        <div id="form2">
            ...
            <tr>
                <%
                    for (int j = 0; j < arrDSTruong.Length; j++)
                    {
                        ...
                        string strAttr = string.Format("class='input1_4' onkeypress='jsCTChi_CT_Search_onkeypress(event)' search-control='1' search-field='{1}' style='width:{0}px;height:22px;'", iColWidth - 2, arrDSTruong[j]);
                        if (CoTabIndex)
                        {
            ...
            <iframe id="ifrChiTietChungTu" width="100%" height="538px" src="<%= Url.Action("ChungTuChiTiet_Frame", "ChungTuChi_ChungTuChiTiet", new {Id_CTChi=Id_CTChi})%>"></iframe>
        </div>
    </div>
</div>