...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        else
        {
            ...
            Nguon_CTChiChiTietPC_BangDuLieu bang = new Nguon_CTChiChiTietPC_BangDuLieu(Id_CTChi, Id_NguonBTC, arrGiaTriTimKiem, MaND, IPSua);
    ...
    %>
        ...
        {
        %>  <form id="formDuyet" action="<%=Url.Action("DetailSubmit", "ChungTuChi_ChungTuChiTiet_PC", new{ Id_CTChi=Id_CTChi, Id_NguonBTC=Id_NguonBTC })%>" method="post">            
    ...
    <script src="<%= Url.Content("~/Scripts/NguonNS/jsNguon_CTChi_PCCT.js") %>?id=<%=DateTime.Now.ToString("YYYYMMddHHmmss") %>"
        type="text/javascript"></script>
