...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        string Id_CTChi = Convert.ToString(ViewData["Id_CTChi"]);
        ...
        DataRow R = _nguonNSService.GetChungTu("Nguon_CTChi", Id_CTChi);
        ...
        var SoChungTu = "CBQP - " + R["SoChungTu"].ToString();
        var LoaiCT = R["LoaiCT"].ToString();
        var SoQD = R["SoQD"].ToString();
        var NgayQD = R["NgayQD"].ToString();
        var NoiDung = R["NoiDung"].ToString();

        using (Html.BeginForm("EditSubmit", "ChungTuChi_ChungTu", new { ParentID = ParentID, Id_CTChi = Id_CTChi}))
        {
    %>    
    <div class="box_tong">
