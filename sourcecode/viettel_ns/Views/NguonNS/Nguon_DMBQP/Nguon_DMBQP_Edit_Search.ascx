        ...
        <div id="form2">            
            ...
            <tr>
                ...
                {                                
                    ...
                    string strAttr = "";                   
                    strAttr = string.Format("class='input1_4' onkeypress='jsDMBQP_Search_onkeypress(event)' search-control='1' search-field='{1}' style='width:{0}px;height:22px;'", iColWidth - 2, arrDSTruong[j]);
            ...
            <iframe id="ifrChiTiet" width="100%" height="538px" src="<%= Url.Action("Nguon_DMBQP_Edit_Frame", "Nguon_DMBQP")%>"></iframe>  
        </div>
