...
<%
    ...
    String strThemMoi = Url.Action("Edit", "CapPhat_ChungTu_DonVi");
    ...
    using (Html.BeginForm("SearchDuyetSubmit", "CapPhat_ChungTu_DonVi", new { ParentID = ParentID }))
    {
%>
<div class="box_tong">
...
<div class="box_tong">
    ...
    <table class="mGrid" id="<%= ParentID %>_thList">
        <tr>
            ...
            <th style="width: 20%;" align="center">Đơn vị</th>
            <th style="width: 24%;" align="center">Nội dung</th>
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "CapPhat_ChungTu_DonVi", new { iID_MaCapPhat = R["iID_MaCapPhat"]}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "CapPhat_ChungTu_DonVi", new { iID_MaCapPhat = R["iID_MaCapPhat"]}).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }
