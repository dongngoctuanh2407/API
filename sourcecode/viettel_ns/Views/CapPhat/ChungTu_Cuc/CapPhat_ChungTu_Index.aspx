...
<%
    ...
    String ParentID = "CapPhat_ChungTu_Cuc";
    ...
    DataTable dt = CapPhat_ChungTu_CucModels.Get_DanhSachChungTu("", MaND, iSoCapPhat, sTuNgay, sDenNgay, iID_MaTrangThaiDuyet, iDM_MaLoaiCapPhat,true, CurrentPage, Globals.PageSize);

    double nums = CapPhat_ChungTu_CucModels.Get_DanhSachChungTu_Count("", MaND, iSoCapPhat, sTuNgay, sDenNgay, iID_MaTrangThaiDuyet, iDM_MaLoaiCapPhat,true);
    ...
    String strThemMoi = Url.Action("Edit", "CapPhat_ChungTu_Cuc", new { sLNS = sLNS, DonVi = DonVi });
    ...
    using (Html.BeginForm("SearchSubmit", "CapPhat_ChungTu_Cuc", new { ParentID = ParentID,DonVi=DonVi }))
    {
%>
<div class="box_tong">
...
<div class="box_tong">
    ...
    <table class="mGrid" id="<%= ParentID %>_thList">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "CapPhat_ChungTu_Cuc", new { iID_MaCapPhat = R["iID_MaCapPhat"]}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "CapPhat_ChungTu_Cuc", new { iID_MaCapPhat = R["iID_MaCapPhat"]}).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }
            ...
            <tr <%=strColor %>>
                ...
                <td align="center">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "CapPhat_ChungTuChiTiet_Cuc", new { iID_MaCapPhat = R["iID_MaCapPhat"] }).ToString(), Convert.ToString(R["sTienToChungTu"]) + Convert.ToString(R["iSoCapPhat"]), "Detail", "")%></b>
                </td>
                <td><%=LoaiCapPhat %></td>
