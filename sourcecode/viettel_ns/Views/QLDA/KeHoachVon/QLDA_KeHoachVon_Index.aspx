        ...
        <table class="mGrid">
            ...
            <%
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    String strEdit = "";
                    String strDelete = "";
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "QLDA_KeHoachVon", new { iID_KeHoachVon_QuyetDinh = R["iID_KeHoachVon_QuyetDinh"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QLDA_KeHoachVon", new { iID_KeHoachVon_QuyetDinh = R["iID_KeHoachVon_QuyetDinh"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
