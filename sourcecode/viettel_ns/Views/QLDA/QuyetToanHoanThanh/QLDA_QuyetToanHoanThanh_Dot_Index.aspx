...
<div class="box_tong">
    ...
    <table class='mGrid'>
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "QLDA_QuyetToanHoanThanh", new { iID_MaQuyetToanHoanThanh_SoPhieu = R["iID_MaQuyetToanHoanThanh_SoPhieu"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
            strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QLDA_QuyetToanHoanThanh", new { iID_MaQuyetToanHoanThanh_SoPhieu = R["iID_MaQuyetToanHoanThanh_SoPhieu"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
