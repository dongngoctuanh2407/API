        ...
        <div id="form2">
            <table class="mGrid">
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    String strEdit = "";
                    String strDelete = "";
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "QLDA_HopDong", new { iID_MaHopDong = R["iID_MaHopDong"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                    ...
                    if(dtCP.Rows.Count<=0)
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QLDA_HopDong", new { iID_MaHopDong = R["iID_MaHopDong"]}).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                    %>
                    <tr <%=sClasstr %>>
