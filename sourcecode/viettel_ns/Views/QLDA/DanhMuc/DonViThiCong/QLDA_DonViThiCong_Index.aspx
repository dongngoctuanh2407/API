...
<div class="box_tong">
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            String strEdit = "";
            String strDelete = "";
            strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "QLDA_DonViThiCong", new { iID_MaDonViThiCong = R["iID_MaDonViThiCong"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
            strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QLDA_DonViThiCong", new { iID_MaDonViThiCong = R["iID_MaDonViThiCong"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            %>
            <tr class='<%=sClasstr %>'>
