...
<%--    <table>
    ...
    <div class="box_tong">
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Detail_Edit", "TraNo", new { iID_VayChiTiet = R["iID_VayChiTiet"], iID_ThuVonChiTiet = R["iID_ThuVonChiTiet"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "EditNoiDung", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Deleted", "TraNo", new { iID_VayChiTiet = R["iID_ThuVonChiTiet"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "DeleteNoiDung", "");
