        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "ChungTuVayNo", new { ParentID = ParentID, iID_MaChungTu = R["iID_Vay"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "ChungTuVayNo", new { ParentID = ParentID, iID_MaChungTu = R["iID_Vay"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                    }
