        ...
        <table class="mGrid">
            ...
            <%
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "VayVon", new { iID_VayChiTiet = R["iID_VayChiTiet"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "EditNoiDung", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("DeleteVayVon", "VayVon", new { iID_VayChiTiet = R["iID_VayChiTiet"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "DeleteNoiDung", "");
            %>
            <tr <%=classtr %>>
                <td align="center">
                    <%=STT%>
