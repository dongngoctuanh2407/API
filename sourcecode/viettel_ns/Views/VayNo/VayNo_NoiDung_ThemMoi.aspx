                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            ...
                            <td class="td_form2_td5">
                                <div>
                                    <%=MyHtmlHelper.TextBox(ParentID, sTenNoiDung, "sTenNoiDung", "", "class=\"form-control\" tab-index='-1'")%>
                        ...
                        <tr>
                            ...
                            <td class="td_form2_td5">
                                ...
                                %>
                                <div>
                                    <%=MyHtmlHelper.TextBox(ParentID, iID_MaNoiDung, "iID_MaNoiDung", "", "class=\"form-control\"")%>
                        ...
                        <tr>
                            ...
                            <td class="td_form2_td5">
                                <div>
                                   <%=MyHtmlHelper.DropDownList(ParentID, optLoaiVayVon, MaLoaiVayVon, "iID_Loai", "", "class=\"form-control\" ")%>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="td_form2_td5">
                                <div>
                                    <%=MyHtmlHelper.TextArea(ParentID, sMoTaChung, "sMoTaChung", "", "class=\"form-control\" style=\"height: 40px;\"")%>
