...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <%
        String iID_MaNoiDung = Request.QueryString["MaNoiDung"];
        string sTenNoiDung = Request.QueryString["TenNoiDung"];
        ...
        double nums = VayNoModels.LaySoBanGhiNoiDung(iID_MaNoiDung, sTenNoiDung);
        ...
        {
            MaNoiDung = iID_MaNoiDung,
            TenNoiDung = sTenNoiDung,
            page = x
        }));
        String strThemMoi = Url.Action("EditNoiDung", "VayNo_NoiDung", new { ID = string.Empty });
        DataTable dt = VayNoModels.LayDanhSachNoiDung(iID_MaNoiDung, sTenNoiDung, CurrentPage, Globals.PageSize);
                            ...
                            <table cellpadding="5" cellspacing="5" width="100%">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, iID_MaNoiDung, "iID_MaNoiDung", "", "class=\"form-control\" tab-index='-1'")%>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td valign="top" align="left" style="width: 45%;">
                            <table cellpadding="5" cellspacing="5" width="100%">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, sTenNoiDung, "sTenNoiDung", "", "class=\"form-control\"")%>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td colspan="2" align="center" style="padding: 0px 0px 10px 0px;">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <button id="TaoMoi" class="btn btn-primary" type="button" onclick="javascript:location.href='<%=strThemMoi %>'"><i class="fa fa-plus"></i>Thêm mới</button>
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    string sHoatDong = Convert.ToString(R["bPublic"]).Equals("True") ? "Có hiệu lực" : "Không có hiệu lực";
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("EditNoiDung", "VayNo_NoiDung", new { ID = R["iID_MaNoiDung"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "EditNoiDung", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("DeleteNoiDung", "VayNo_NoiDung", new { ID = R["iID_MaNoiDung"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "DeleteNoiDung", "");
            %>
            <tr>
