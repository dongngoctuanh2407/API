        ...
        <tr>
	        ...
	        <td  width="30%" align="right">						
                <table cellpadding="0" cellspacing="0" border="0" align="right">
        	        <tr>
            	        <td>
                            <%--<input id="Register" type="button" class="button4" value="<%= NgonNgu.LayXau("Sửa")%>" />--%>
                            <button id="Register" class="btn btn-primary" type="submit"><i class="fa fa-download"></i> Lưu</button>
                        </td>
                        <td width="5px"></td>
                        <td>
