            ...
            <table class="mGrid" id="<%= ParentID %>_thList">
                ...
                <%
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "KeToan_RutDuToan", new { iID_MaDotRutDuToan = R["iID_MaDotRutDuToan"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "KeToan_RutDuToan", new { iID_MaDotRutDuToan = R["iID_MaDotRutDuToan"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
