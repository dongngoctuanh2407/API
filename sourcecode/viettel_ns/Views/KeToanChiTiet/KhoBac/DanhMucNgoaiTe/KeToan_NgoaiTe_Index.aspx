    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "KeToan_NgoaiTe", new { iID_MaNhanVien = R["iID_MaNgoaiTe"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "KeToan_NgoaiTe", new { iID_MaNhanVien = R["iID_MaNgoaiTe"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
        <%} %>
        <tr class="pgr">
