...
<%
    int i;
    String ParentID = "KTCT_KhoBac_ChungTu";
    ...
    DataTable dt = KTCT_KhoBac_ChungTuModels.Get_DanhSachChungTu(MaND, iLoai, iSoChungTu, dTuNgay, dDenNgay, iID_MaTrangThaiDuyet, CurrentPage, Globals.PageSize);

    double nums = KTCT_KhoBac_ChungTuModels.Get_DanhSachChungTu_Count(MaND, iLoai, iSoChungTu, dTuNgay, dDenNgay, iID_MaTrangThaiDuyet);
    ...
    String strThemMoi = Url.Action("Edit", "KTCT_KhoBac_ChungTu", new { iLoai = iLoai});

    using (Html.BeginForm("SearchSubmit", "KTCT_KhoBac_ChungTu", new { ParentID = ParentID, iLoai = iLoai }))
    {
%>
...
<div class="box_tong">
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "KTCT_KhoBac_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"],iLoai = iLoai}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "KTCT_KhoBac_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"], iLoai = iLoai }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }

            String strURL = MyHtmlHelper.ActionLink(Url.Action("Index", "KTCT_KhoBac_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<img src='../Content/Themes/images/btnSetting.png' alt='' />", "Detail", null, "title=\"Xem chi tiết chứng từ\"");
            ...
            <tr <%=strColor %>>
                ...
                <td align="center">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "KTCT_KhoBac_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), Convert.ToString(R["sTienToChungTu"]) + Convert.ToString(R["iSoChungTu"]), "Detail", "")%></b>
                </td>
