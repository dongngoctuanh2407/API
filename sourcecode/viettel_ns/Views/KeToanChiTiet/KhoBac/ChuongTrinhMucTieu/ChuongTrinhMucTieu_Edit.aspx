            ...
            <table cellpadding="0"  cellspacing=""="0" border="0" width="70%">
                <tr>
                    ...
                    <td class="td_form2_td5">
                        <div><%=MyHtmlHelper.TextBox(ParentID, iID_MaChuongTrinhMucTieu, "iiID_MaChuongTrinhMucTieu", "", "style=\"width:20%;\"class=\"form-control\" " + strReadOnlyMa + "")%><%=strIcon %>
                ...
                <tr>
                    ...
                    <td class="td_form2_td5">
                        <div><%=MyHtmlHelper.TextBox(ParentID, sTen, "sTen", "", "style=\"width:80%;\"class=\"form-control\"")%>
                ...
                <tr>
                    ...
                    <td class="td_form2_td5">
                        <div>
                            <%=MyHtmlHelper.TextArea(ParentID, sMoTa, "sMoTa", "", "style=\"width:80%; height: 150px;\"class=\"form-control\"")%>
                        </div>
                    </td>
                </tr>
            </table>
