...
<div id="divNoiDung" style="width: 100%; position:relative;">
        	...
        	<tr>
                ...
                <td align="right" style="padding-right: 10px;">
                    ...
                    <%--<input id="Button2" type="button" class="button_title" value="Sắp xếp" onclick="javascript:location.href='<%=strSapXep %>'" />--%>
                     <button id="Button2" class="btn btn-info" type="button" onclick="javascript:location.href='<%=strSapXep %>'"><i class="fa fa-sort"></i>Sắp xếp</button>
                </td>
            </tr>
        </table>
    </div>
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "KTCT_KhoBac_ChuongTrinhMucTieu", new { iID_MaChuongTrinhMucTieu = R["iID_MaChuongTrinhMucTieu"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "KTCT_KhoBac_ChuongTrinhMucTieu", new { iID_MaChuongTrinhMucTieu = R["iID_MaChuongTrinhMucTieu"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
        <%} %>
        <tr class="pgr">
