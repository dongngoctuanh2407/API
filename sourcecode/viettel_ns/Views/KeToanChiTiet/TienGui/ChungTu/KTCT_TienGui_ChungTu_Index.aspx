...
<%
    int i;
    String ParentID = "KTCT_TienGui_ChungTu";
    ...
    DataTable dt = KTCT_TienGui_ChungTuModels.Get_DanhSachChungTu(MaND, iSoChungTu, dTuNgay, dDenNgay, iID_MaTrangThaiDuyet, CurrentPage, Globals.PageSize);

    double nums = KTCT_TienGui_ChungTuModels.Get_DanhSachChungTu_Count(MaND, iSoChungTu, dTuNgay, dDenNgay, iID_MaTrangThaiDuyet);
    ...
    String strThemMoi = Url.Action("Edit", "KTCT_TienGui_ChungTu");

    using (Html.BeginForm("SearchSubmit", "KTCT_TienGui_ChungTu", new { ParentID = ParentID}))
    {
%>
...
<div class="box_tong">
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "KTCT_TienGui_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "KTCT_TienGui_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }

            String strURL = MyHtmlHelper.ActionLink(Url.Action("Index", "KTCT_TienGui_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<img src='../Content/Themes/images/btnSetting.png' alt='' />", "Detail", null, "title=\"Xem chi tiết chứng từ\"");
            ...
            <tr <%=strColor %>>
                ...
                <td align="center">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "KTCT_TienGui_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), Convert.ToString(R["sTienToChungTu"]) + Convert.ToString(R["iSoChungTu"]), "Detail", "")%></b>
                </td>
