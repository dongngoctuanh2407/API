...
<div class="box_tong">
    ...
    <table class='mGrid'>
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            strDuyet = MyHtmlHelper.ActionLink(Url.Action("Edit", "KTCT_CapThu", new { iID_MaChungTu_Duyet = R["iID_MaChungTu_Duyet"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
            ...
            strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "KTCT_CapThu", new { iID_MaChungTu_Duyet = R["iID_MaChungTu_Duyet"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
            if (strRutDuToan == "" && strUyNhiemChi == "") {
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "KTCT_CapThu", new { iID_MaChungTu_Duyet = R["iID_MaChungTu_Duyet"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }
