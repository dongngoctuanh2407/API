...
<body>
    <%         
        ...
        String UrlReport = "";
        if (PageLoad == "1")
            UrlReport = Url.Action("ViewPDF", "rptThuNopThongTri", new { iID_MaChungTu = iID_MaChungTu, iID_MaDonVi = iID_MaDonVi, iID_MaThongTri = iID_MaThongTri, sSoCT = sSoCT, iLoai = iLoai, noiDung = sGhiChu });
    ...
    <%=MyHtmlHelper.ActionLink(Url.Action("ExportToExcel", "rptThuNopThongTri", new { iID_MaChungTu = iID_MaChungTu, iID_MaDonVi = iID_MaDonVi, iID_MaThongTri = iID_MaThongTri, iLoai = iLoai }), "Xuất ra Excel")%>
