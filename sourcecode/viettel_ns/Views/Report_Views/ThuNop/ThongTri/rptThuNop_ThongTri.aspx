...
<body>
    <%
        ...
        String ParentID = "ThuNopThongTri";
        ...
        String URL = Url.Action("Index", "ThuNop_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu, iLoai = 2 });
        ...
        DataTable dtLoaiTT = SharedModels.getDSLoaiThongTri();
        ...
        using (Html.BeginForm("EditSubmit", "rptThuNopThongTri", new { ParentID = ParentID}))
        {
    %>
                            ...
                            <div style="float: left; width: 98%; margin: 3px; height: 250px; overflow: scroll;">
                                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="mGrid">
                                    ...
                                    <%for (int i = 0; i < dtLoaiThongTri.Rows.Count; i++)
                                      {
                                          String strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "rptThuNopThongTri", new { iID_MaThongTri = iID_MaThongTri, iID_MaChungTu = iID_MaChungTu, iLoai = iLoai }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                                    %>
                                    <tr>
