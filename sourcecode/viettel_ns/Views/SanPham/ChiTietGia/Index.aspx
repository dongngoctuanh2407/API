...
for (i = 0; i < dt.Rows.Count; i++)
{
    ...
    String strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "SP_ChiTietGia", new { iID_MaChiTietGia = R["iID_MaChiTietGia"], iID_MaSanPham = iID_MaSanPham }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
    String strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "SP_ChiTietGia", new { iID_MaChiTietGia = R["iID_MaChiTietGia"], iID_MaSanPham = iID_MaSanPham }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
