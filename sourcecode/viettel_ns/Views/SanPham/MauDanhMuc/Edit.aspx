...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        if (dt.Rows.Count > 0 && iID_MaDanhMuc != null && iID_MaDanhMuc != "")
        {
            ...
            sGhiChu = HamChung.ConvertToString(R["sGhiChu"]);
        }
            ...
            <div id="form2">
                <table cellpadding="5" cellspacing="5" width="50%">
                    ...
                    <tr>
                        <td class="td_form2_td1">
                            <div>
                                <b>Công thức</b>&nbsp;<span  style="color:Red;">*</span></div>
                        </td>
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, sGhiChu, "sGhiChu", "", "class=\"input1_2\"", 2)%><br />
                            </div>
                        </td>
                    </tr>
                </table>
