...
<%
    ...
    DataTable dt = VatTu_TimKiemController.Get_DanhSachVatTu(sMa,sTen, iNam, CurrentPage, Globals.PageSize);

    double nums = VatTu_TimKiemController.Get_DanhSachVatTu_Count(sMa,sTen, iNam);
...
<div class="box_tong">
  ...
  <tr>
    <td align="right" class="style1" width="15%"><b>Mã vật tư: </b></td>
