...
<%
    ...
    DataTable dt = VatTu_SoSanhGiaController.Get_DanhSachVatTu(sMa,sTen, sTenSanPham, iNam, iNamSoSanh,int.Parse(KieuSoSanh), LoaiNganSach, CurrentPage, Globals.PageSize);

    double nums = VatTu_SoSanhGiaController.Get_DanhSachVatTu_Count(sMa,sTen, sTenSanPham, iNam);
