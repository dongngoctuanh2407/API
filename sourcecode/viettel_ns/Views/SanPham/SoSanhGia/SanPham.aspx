...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        DataTable dt = SanPham_SoSanhGiaController.Get_DanhSachSanPham(sMa,sTen, iNam, iNamSoSanh, CurrentPage, Globals.PageSize);

        double nums = SanPham_SoSanhGiaController.Get_DanhSachSanPham_Count(sMa, sTen, iNam);
                        ...
                        <td colspan="2" style="padding-bottom: 5px">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    ...
                                    <td width="35%">
                                        &nbsp;<%=MyHtmlHelper.TextBox(ParentID, sMa, "sMa", "", "class=\"input1_2\" style=\"width: 60%;height:24px;\"", 2)%>
                                    </td>
                                    <td align="right" class="style1" width="15%">
                                        <b>Tên sản phẩm: </b>
                                    </td>
    ...
    STT++;   
            ...
            <tr>
                ...
                <%for (int j = 1; j <= 5; j++)
                  {%>
                <td align="center">
                    <%=CommonFunction.DinhDangSo(Row["Nam" + j.ToString()],2)%>
                </td>
                <%} %>
                <td align="center">
                    <%=CommonFunction.DinhDangSo(Row["Sosanh"],2)%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
