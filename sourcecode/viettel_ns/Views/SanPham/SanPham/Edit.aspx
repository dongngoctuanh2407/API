...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        DataTable dtSanpham = SanPham_VatTuModels.Get_DanhSachSanPham();
        R = dtSanpham.NewRow();
        R["iID_MaSanPham"] = Guid.Empty.ToString();
        R["sTen"] = "--Không chọn--";
        dtSanpham.Rows.InsertAt(R, 0);
        SelectOptionList slCopy = new SelectOptionList(dtSanpham, "iID_MaSanPham", "sTen");
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td valign="top" align="left" style="width: 30%;" class="td_form2_td1">
                            <div>
                                <b>
                                    <%=NgonNgu.LayXau("Mã sản phẩm:")%></b><span style="color: Red">*</span></div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td valign="top" align="left" style="width: 30%;" class="td_form2_td1">
                            <div>
                                <b>
                                    <%=NgonNgu.LayXau("Tên sản phẩm:")%></b><span style="color: Red">*</span></div>
                        </td>
                        <td valign="top" align="left" style="width: 50%;" class="td_form2_td1">
                            <div>
                    ...
                    <tr>
                        ...
                        <td valign="top" align="left" style="width: 30%;" class="td_form2_td1">
                            <div>
                                <b>
                                    <%=NgonNgu.LayXau("Đơn vị tính:")%></b></div>
                        </td>
                        <td valign="top" align="left" style="width: 50%;" class="td_form2_td1">
                            <div>
                    ...
                    <tr>
                        ...
                        <td valign="top" align="left" style="width: 30%;" class="td_form2_td1">
                            <div>
                                <b>
                                    <%=NgonNgu.LayXau("Quy cách phẩm chất:")%></b></div>
                        </td>
                        <td valign="top" align="left" style="width: 50%;" class="td_form2_td1">
                            <div>
                    ...
                    <tr>
                        ...
                        <td valign="top" align="left" style="width: 30%;" class="td_form2_td1">
                            <div>
                                <b>
                                    <%=NgonNgu.LayXau("Copy sản phẩm:")%></b></div>
                        </td>
                        <td valign="top" align="left" style="width: 50%;" class="td_form2_td1">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slCopy, "", "iID_MaSanPham_copy", "", "class=\"input1_2\"")%>
                            </div>
                        </td>
                        <td valign="top" align="left" style="width: 10%;" class="td_form2_td1">
                        </td>
