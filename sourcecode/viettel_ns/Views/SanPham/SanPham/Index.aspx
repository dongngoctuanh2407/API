  ...
  <tr>
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            //{
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "SanPham", new { iID_MaSanPham = R["iID_MaSanPham"]}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "SanPham", new { iID_MaSanPham = R["iID_MaSanPham"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
