...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        DataTable dtTrangThai_All = LuongCongViecModel.Get_dtDSTrangThaiDuyet_All();
        ...
        //longsam: lấy mỗi trang 10 chứng từ (mặc định 20) để nhanh hơn
        var pageSize = 10;
        ...
        DataTable dt = DuToanBSChungTuModels.LayDanhSachChungTuTLTH(iID_MaChungTu_TLTHCuc, MaND, CheckNDtao, sTuNgay, sDenNgay, iID_MaTrangThaiDuyet, CurrentPage, pageSize);
        ...
        //Phân trang
        int TotalPages = (int)Math.Ceiling(nums / pageSize);
        ...
        <div id="Div1">
            <div id="Div2">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table_form2">
                    <tr>
                        <td style="width: 100%">
                            <table cellpadding="0" cellspacing="0" class="table_form2">
                                <tr>
                                    <td class="td_form2_td1" style="width: 10%;">
                                        <div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table_form2" id="tb_DotNganSach">
                                <tr>
                                    <td class="td_form2_td1" style="width: 10%;">
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div style="width: 550px; float: left">
                                            <%= MyHtmlHelper.TextArea(ParentID, "", "sNoiDung", "", "class=\"form-control\" style=\"height: 100px; resize: none;\"") %>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    String strTongTien = "";
                    strTongTien = CommonFunction.DinhDangSo(DuToanBSChungTuModels.ThongKeTongSoTien_ChungTuTLTH(R));
                    ...
                    {
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("SuaChungTuTLTH", "DuToanBSChungTu", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "", "title=\"Sửa chứng từ\"");
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("XoaChungTuTLTH", "DuToanBSChungTu", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"], MaDotNganSach = MaDotNganSach, ChiNganSach = ChiNganSach }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "", "title=\"Xóa chứng từ\"");
                    }

                    maTrangThaiTHCucTuChoi = LuongCongViecModel.Luong_iID_MaTrangThaiDuyet_TuChoi(maTrangThaiTHCucTuChoi);
                    if (check && (Convert.ToInt32(R["iID_MaTrangThaiDuyet"]) == DuToan_ChungTuChiTietModels.iID_MaTrangThaiDuyetKT) ||
                       Convert.ToInt32(R["iID_MaTrangThaiDuyet"]) == maTrangThaiTHCucTuChoi ||
                       Convert.ToInt32(R["iID_MaTrangThaiDuyet"]) == 7) // trợ lý tổng hợp từ chối
                    {
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("SuaChungTuTLTH", "DuToanBSChungTu", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "", "title=\"Sửa chứng từ\"");
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("XoaChungTuTLTH", "DuToanBSChungTu", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"], MaDotNganSach = MaDotNganSach, ChiNganSach = ChiNganSach }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "", "title=\"Xóa chứng từ\"");
                    }
