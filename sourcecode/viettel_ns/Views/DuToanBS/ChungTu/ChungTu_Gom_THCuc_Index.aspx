...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        bool check = (LuongCongViecModel.KiemTra_TroLyTongHopCuc(MaND) || LuongCongViecModel.KiemTra_TroLyPB11_02(MaND));
        ...
        DataTable dtChungTuTLTH = DuToanBSChungTuModels.LayDanhSachChungTuDeGomTLTHCuc(MaND);
        //Lấy danh sách chứng từ theo page
        DataTable dt = DuToanBSChungTuModels.LayDanhSachChungTuTLTHCuc(MaND, sTuNgay, sDenNgay, iID_MaTrangThaiDuyet, CheckNDtao, CurrentPage, Globals.PageSize);

        //Lấy số lượng tất cả chứng từ
        double nums = DuToanBSChungTuModels.LayDanhSachChungTuTLTHCuc(MaND, sTuNgay, sDenNgay, iID_MaTrangThaiDuyet, CheckNDtao).Rows.Count;
    ...
    <div class="custom_css box_tong">
        ...
        <div id="Div1">
            <div id="Div2">
                <%
                    using (Html.BeginForm("ThemSuaChungTuTLTHCuc", "DuToanBSChungTu", new { parentID = ParentID }))
                    {
                %>
    ...
    <div class="custom_css box_tong">
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            <tr>
                ...
                <th style="width: 10%;" align="center">Ngày quyết định
                </th>
                <th style="width: 10%;" align="center">Số quyết định
                </th>
                ...
                <th style="width: 15%;" align="center">Trạng thái
                </th>
            ...
            <%
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (String.IsNullOrEmpty(R["dNgayQuyetDinh"].ToString()) == false)
                        NgayQuyetDinh = CommonFunction.LayXauNgay(Convert.ToDateTime(R["dNgayQuyetDinh"]));
                    String sTrangThai = "";
                    String strColor = "";
                    ...
                    if (check)
                    {
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("SuaChungTuTLTHCuc", "DuToanBSChungTu", new { iID_MaChungTu = R["iID_MaChungTu_TLTHCuc"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "", "title=\"Sửa chứng từ\"");
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("XoaChungTuTLTHCuc", "DuToanBSChungTu", new { iID_MaChungTu = R["iID_MaChungTu_TLTHCuc"], MaDotNganSach = MaDotNganSach, ChiNganSach = ChiNganSach }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "", "title=\"Xóa chứng từ\"");
                    }
                    String strURL = MyHtmlHelper.ActionLink(Url.Action("Index", "DuToanBSChungTu", new { iID_MaChungTu = R["iID_MaChungTu_TLTHCuc"], bTLTH = 1, iloai = 1 }).ToString(), "<img src='../Content/Themes/images/btnSetting.png' alt='' />", "Detail", null, "title=\"Xem chi tiết chứng từ\"");
            %>
            <tr <%=strColor %>>
                <td align="center">
                    <b><%=R["rownum"]%></b>
                ...
                <td align="center">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToanBSChungTu", new { ChiNganSach = ChiNganSach, MaDotNganSach = MaDotNganSach,bTLTHCuc=1,iID_MaChungTu = R["iID_MaChungTu_TLTHCuc"] }).ToString(), NgayQuyetDinh, "Detail", "")%></b>
                </td>
                <td align="center">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToanBSChungTu", new { ChiNganSach = ChiNganSach, MaDotNganSach = MaDotNganSach,bTLTHCuc = 1, iID_MaChungTu = R["iID_MaChungTu_TLTHCuc"] }).ToString(), R["sSoQuyetDinh"], "Detail", "")%></b>
                </td>
                <td align="center">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToanBSChungTu", new { ChiNganSach = ChiNganSach, MaDotNganSach = MaDotNganSach,bTLTHCuc=1,iID_MaChungTu = R["iID_MaChungTu_TLTHCuc"] }).ToString(),  NgayChungTu, "Detail", "")%></b>
                </td>
                <td align="left">
