                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                       <table  class="mGrid" style="width: 100%">
                                            <tr>
                                                <th align="center" style="width: 40px;"> <input type="checkbox"  id="abc" onclick="CheckAll(this.checked)" />
                                                </th>
                                            ...
                                            <%
                                                ...
                                                <tr>
                                                    <td align="center" style="width: 40px;">
                                                        <input type="checkbox" value="<%= MaDonVi %>" <%= strChecked %> 
                                                        check-group="DonVi" id="iID_MaChungTu" name="iID_MaChungTu" />
                                                    </td>
                                                    <td align="left">
                                                        <%= strsTen %>
                                                    </td>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%= MyHtmlHelper.TextArea(ParentID, "", "sNoiDung", "",
                                                                  "class=\"input1_2\" style=\"height: 100px;\"") %>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (check) 
                    {
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit_Gom", "DuToanBS_ChungTu_BaoDam", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"], sLNS = sLNS }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "", "title=\"Sửa chứng từ\"");
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete_Gom", "DuToanBS_ChungTu_BaoDam", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"], sLNS = sLNS, MaDotNganSach = MaDotNganSach, ChiNganSach = ChiNganSach }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "", "title=\"Xóa chứng từ\"");
                    }

                    String strURL = MyHtmlHelper.ActionLink(Url.Action("Index", "DuToanBS_ChungTu_BaoDam", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"], sLNS = sLNS, bTLTH = 1 }).ToString(), "<img src='../Content/Themes/images/btnSetting.png' alt='' />", "Detail", null, "title=\"Xem chi tiết chứng từ\"");
                    ...
                    {
                        strURLTuChoi = Url.Action("TuChoi", "DuToanBS_ChungTuChiTiet", new { ChiNganSach = ChiNganSach, iID_MaChungTu = R["iID_MaChungTu_TLTH"] });
                        strTex = "Từ chối";
                   ...
                   if(DaDuyet==false)
                       strduyet = MyHtmlHelper.ActionLink(Url.Action("TrinhDuyet", "DuToanBS_ChungTuChiTiet_Gom", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"], sLNS = sLNS, iLoai = 1 }).ToString(), "<img src='../Content/Themes/images/arrow_up.png' alt='' />", "", "", "title=\"Duyệt chứng từ\"");
                   strTuChoi = MyHtmlHelper.ActionLink(Url.Action("TuChoi", "DuToanBS_ChungTuChiTiet_Gom", new { iID_MaChungTu = R["iID_MaChungTu_TLTH"], sLNS = sLNS, iLoai = 1 }).ToString(), "<img src='../Content/Themes/images/arrow_down.png' alt='' />", "", "", "title=\"Từ chối chứng từ\""); 
