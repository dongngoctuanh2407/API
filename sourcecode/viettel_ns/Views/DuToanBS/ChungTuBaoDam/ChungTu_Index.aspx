...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        DataTable dtNguon = QuyetToanModels.getDSNguonNganSach();
        SelectOptionList slNguon = new SelectOptionList(dtNguon, "MaLoai", "sTen");
        //dtNguon.Dispose();
        ...
        string strPhanTrang = MyHtmlHelper.PageLinks(String.Format("Trang {0}/{1}:", CurrentPage, TotalPages), CurrentPage, TotalPages, x => Url.Action("Index", new { SoChungTu = iSoChungTu, TuNgay = sTuNgay, DenNgay = sDenNgay, iID_MaTrangThaiDuyet = iID_MaTrangThaiDuyet, page = x, sLNS = sLNS1 }));
                        ...
                        <td style="width: 80%">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="50%" class="table_form2"
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, slLoaiNganSach, "1040100", "sLNS", "", "class=\"input1_2\"")%>
                                        </div>
    ...
    <div class="box_tong">
        <div class="title_tong">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Danh sách đợt dự toán ngân sách bảo đảm
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    String strTongTien = "";
                    strTongTien = CommonFunction.DinhDangSo(DuToanBSChungTuModels.ThongKeTongSoTien_ChungTu(Convert.ToString(R["iID_MaChungTu"])));
                    ...
                    if (iKyThuat == "1")
                    {
                        ...
                        {
                            strEdit = MyHtmlHelper.ActionLink(Url.Action("SuaChungTu", "DuToanBS_ChungTu_BaoDam", new { iID_MaChungTu = R["iID_MaChungTu"], sLNS = sLNS, iKyThuat = iKyThuat }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "", "title=\"Sửa chứng từ\"");
                            strDelete = MyHtmlHelper.ActionLink(Url.Action("XoaChungTu", "DuToanBS_ChungTu_BaoDam", new { iID_MaChungTu = R["iID_MaChungTu"], sLNS = sLNS, MaDotNganSach = MaDotNganSach, ChiNganSach = ChiNganSach, iKyThuat = iKyThuat }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "", "title=\"Xóa chứng từ\"");
                        }
                        else
                        {
            ...
            <tr <%=strColor %>>
                ...
                <td align="center">
                    <b>
                        <%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToanBS_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"], sLNS1="104"}).ToString(), R["iID_MaPhongBanDich"], "Detail", "")%></b>
                </td>
                <td align="center">
                    <b>
                        <%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToanBS_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"], sLNS1 = "104" }).ToString(), R["sDSLNS"], "Detail", "")%></b>
                </td>
                <td align="center">
                    <b>
                        <%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToanBS_ChungTuChiTiet", new { ChiNganSach = ChiNganSach, MaDotNganSach = MaDotNganSach, iID_MaChungTu = R["iID_MaChungTu"], sLNS1 = "104" }).ToString(), "Đợt ngày: " + NgayChungTu, "Detail", "")%></b>
                </td>
                <td align="left">
