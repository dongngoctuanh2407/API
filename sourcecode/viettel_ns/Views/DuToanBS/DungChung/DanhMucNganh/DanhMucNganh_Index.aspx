        ...
        <div>
            <table class="mGrid">
                ...
                <tr <%=classtr %>>
                    ...
                    <td>
                          <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "DanhMucNganh", new { iID = R["iID"], page = CurrentPage }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                    </td>
                     <td>
