    ...
    <div class="box_tong">
        ...
        <table class="mGrid">
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("EditDetail", "PhongBanLNS", new { Code = R["iID_MaPhongBan"], MaID = R["iID_MaPhongBanLoaiNganSach"], LNS = "" }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("DeleteDetail", "PhongBanLNS", new { Code = R["iID_MaPhongBanLoaiNganSach"], MaID = R["iID_MaPhongBan"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
