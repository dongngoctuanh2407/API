    ...
    <table class="mGrid">
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "MucLucNganSach", new { iID_MaMucLucNganSach = R["iID_MaMucLucNganSach"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "MucLucNganSach", new { iID_MaMucLucNganSach = R["iID_MaMucLucNganSach"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
        <%} %>
        <tr class="pgr">
