...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <% 
        ...
        DataTable dt = PhongBan_DonViModels.getDS(sMaPhongBan, CurrentPage, Globals.PageSize);
        double nums = PhongBan_DonViModels.getDS_Count(sMaPhongBan);
        ...
        String strThemMoi = "/PhongBanDonVi/EditNew?Code=" + sMaPhongBan;
    %>
        ...
        <div class="title_tong" >
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                   ...
                   { %>
                   <span><a href="/PhongBanDonVi">Danh sách đơn vị quản lý </a> (Phòng ban:  <%= DanhMucModels.getTenPB( sMaPhongBan)%>)</span>
                    <% } %>
            ...
            <tr <%=classtr %>>
                ...
                <td align="left">
                   <a href=<%=urlDetailPB %>><b>
                         ...
                         <%= HttpUtility.HtmlEncode( dt.Rows[i]["TenPB"])%>
                        </b></a>
                </td>
                <td align="left">
                 <a href=<%=urlDetailDV %>><b>
                         ...
                         <%=HttpUtility.HtmlEncode(dt.Rows[i]["TenDV"])%>
                        </b></a>
                ...
                <td align="left">
                    <%=HttpUtility.HtmlEncode(dt.Rows[i]["sID_MaNguoiDungTao"])%>
                </td>
              <%--  <td align="center">
                    <% if (bPublicNew == "True")
                       { %>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("EditDetail", "PhongBanDonVi", new { Code = R["iID_MaPhongBan"], MaID = R["iID_MaPhongBanDonVi"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("DeleteDetail", "PhongBanDonVi", new { Code = R["iID_MaPhongBanDonVi"], MaID = R["iID_MaPhongBan"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
