...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%
        ...
        //load don vi
        DataTable dtDonvi = DonViModels.Get_DanhSachDonVi(User.Identity.Name);
                            ...
                            <table cellpadding="5" cellspacing="5" width="100%">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                             <%=MyHtmlHelper.DropDownList(ParentID, ddlDonvi,MaDonVi, "search_iID_MaDonVi", "", "class=\"input1_2\"")%>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td valign="top" align="left" style="width: 45%;">
                            <table cellpadding="5" cellspacing="5" width="100%">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, dllPhongban, MaPhongBan, "search_iID_MaPhongBan", "", "class=\"input1_2\"")%>
                                        </div>
                                    </td>
                                </tr>
                            </table>
    ...
    <div class="box_tong">
        ...
        <table class="mGrid">
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "PhongBanDonVi", new { Code = R["iID_MaPhongBan"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
