        ...
        <table class="mGrid">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (String.IsNullOrEmpty(iID_MaDonVi) == false) sTenDonVi = DonViModels.Get_TenDonVi(iID_MaDonVi,MaND);
                    String classtr = "";
                    int STT = i + 1;
                    if (i % 2 == 0)
                    {
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "MucLucDuAn", new { Code = R["iID_MaDanhMucDuAn"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "MucLucDuAn", new { Code = R["iID_MaDanhMucDuAn"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
