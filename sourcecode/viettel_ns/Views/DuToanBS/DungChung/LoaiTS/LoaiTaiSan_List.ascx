    ...
    <table class="mGrid">
        ...
        <%
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                String classtr = "";
                int STT = i + 1;
                String strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "LoaiTaiSan", new { iID_MaLoaiTaiSan = R["iID_MaLoaiTaiSan"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                String strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "LoaiTaiSan", new { iID_MaLoaiTaiSan = R["iID_MaLoaiTaiSan"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
