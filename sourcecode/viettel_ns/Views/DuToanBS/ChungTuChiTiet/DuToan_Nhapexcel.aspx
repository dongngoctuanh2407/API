...
<body>
   <%
    ...
    using (Html.BeginForm("UpLoadExcel", "DuToanBSChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu, iLoai = iLoai, Loai = Loai }, FormMethod.Post, new { enctype = "multipart/form-data" }))
    {
    %>   
    <div class="box_tong">
        <div id="Div1">
