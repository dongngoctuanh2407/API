...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        else
        {
            ...
            DuToanBSPhanCapBangDuLieu bang = new DuToanBSPhanCapBangDuLieu(iID_MaChungTu, dicGiaTriTimKiem, MaND, IPSua, MaLoai);
    ...
    <div style="display: none;">
        ...
        <%  
            ...
            {
        %>
        <form action="<%=Url.Action("CapNhatChungTuChiTiet", "DuToanBSPhanCapChungTuChiTiet", new{iID_MaChungTu=iID_MaChungTu})%>"
        method="post">
        <%
            } %>
