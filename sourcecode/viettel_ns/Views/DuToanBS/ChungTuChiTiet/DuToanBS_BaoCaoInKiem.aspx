...
<body>
    <%
        ...
        DataTable dtDonVi = DuToanBS_ReportModels.dtDonVi_ChungTu(iID_MaChungTu);
  ...
  SelectOptionList slDonViTinh= new SelectOptionList(dtDonViTinh,"iID","sTen");
        ...
        using (Html.BeginForm("EditSubmit", "rptDuToanBS_BieuKiem_1010000", FormMethod.Post, new { target = "_blank" }))
        {
    %>
