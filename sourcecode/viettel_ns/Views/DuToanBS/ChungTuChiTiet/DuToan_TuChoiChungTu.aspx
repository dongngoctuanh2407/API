...
<body>
    <%
        ...
        string iKyThuat = Convert.ToString(Request.QueryString["iKyThuat"]);
        string slyDo = "";
        string idAction = "1";
        using (Html.BeginForm("TuChoiChungTu", "DuToanBSChungTu", new { ParentID = ParentID, maChungTu = iID_MaChungTu, sLNS = sLNS, iLoai = 1, maChungTuTLTH = iID_MaChungTu_TLTH, iKyThuat = iKyThuat }))
        {
    %>
