                ...
                <tr>
                    <td>
                        ...
                        <div style="width: 100%; float: left; margin-top: 2px;">
                            ...
                            <div>
                                <%Html.RenderPartial("~/Views/DuToanBS/ChungTuChiTiet/PhanCap_ChungTuChiTiet_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet_Index_DanhSach", MaND = User.Identity.Name, ChucNangCapNhap = true }); %>
                            </div>
                        </div>
                    </td>
                </tr>
