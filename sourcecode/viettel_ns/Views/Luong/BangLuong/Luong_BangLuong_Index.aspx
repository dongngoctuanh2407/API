        ...
        <%--  <table class="mGrid">
            ...
            <tr <%=strColor %>>
                ...
                <td align="center">
                    <%if (LuongMoi)
                      {%>
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "Luong_BangLuong", new { iID_MaBangLuong = R["iID_MaBangLuong"], iNamBangLuong = R["iNamBangLuong"], iThangBangLuong = R["iThangBangLuong"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                    <%} %>
                </td>
            </tr>
            <%} %>
