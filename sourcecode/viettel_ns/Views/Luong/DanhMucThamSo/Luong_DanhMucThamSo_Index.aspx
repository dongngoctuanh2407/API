        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=classtr %>>
              <td align="center"><%=R["rownum"]%></td>     
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "Luong_DanhMucThamSo", new { iID_MaThamSo = R["iID_MaThamSo"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "Luong_DanhMucThamSo", new { iID_MaThamSo = R["iID_MaThamSo"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
        <%} %>
        <tr class="pgr">
