            ...
            <table cellpadding="5" cellspacing="5" width="50%">
                     <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slThang, sThang, "iThang", "", "class=\"form-control\" style=\"width:98%;\"")%>
                    ...
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slThangCopy,sThangCopy, "iThangCopy", "", "class=\"form-control\" style=\"width:98%;\"")%>
