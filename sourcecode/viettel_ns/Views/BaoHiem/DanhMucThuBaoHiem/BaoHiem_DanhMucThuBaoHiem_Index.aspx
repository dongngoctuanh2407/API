        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
        	<tr>
                ...
                <td align="right">
                   ...
                   <button id="Button1" type="button" class="btn btn-primary" onclick="javascript:location.href='<%=strThemMoi %>'"><i class="fa fa-plus"></i>Thêm mới</button>
                </td>
            </tr>
        </table>
    </div>
    <table class="mGrid">
        ...
        <%
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                String strURL = MyHtmlHelper.ActionLink(Url.Action("Detail", "BaoHiem_DanhMucThuBaoHiem", new { iNamLamViec = iNamLamViec,iThang=iThang }).ToString(), "<i class='fa fa-eye fa-lg' />", "Detail", null, "title=\"Xem chi tiết\"");
                %>
                <tr>
                    <td><%=iThang%></td>
                    <td><%=iNamLamViec%></td>
