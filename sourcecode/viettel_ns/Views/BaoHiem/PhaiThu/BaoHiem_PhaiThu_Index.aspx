...
<div class="box_tong">
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "BaoHiem_PhaiThu", new { iID_MaBaoHiemPhaiThu = R["iID_MaBaoHiemPhaiThu"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "BaoHiem_PhaiThu", new { iID_MaBaoHiemPhaiThu = R["iID_MaBaoHiemPhaiThu"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }
