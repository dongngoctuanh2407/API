                    ...
                    <tr>
                        ...
                        <td style="padding-right: 10px;">
                            <div onclick="OnInit_CT_NEW(700, 'Thông tri');">
                                <%= Html.ActionLink("Thông tri", "Index", new { controller = "rptQuyetToan_ThongTri", iID_MaChungTu = iID_MaChungTu }, new { @class = "button", target = "_blank" })%>
                            </div>
                        </td>
                        <td style="padding-right: 10px;">
                            <div>
                                <%= Html.ActionLink("Nhận dữ liệu", "excel", new { controller = "qt", area="z", id_chungtu = iID_MaChungTu }, new { @class = "button", target = "_blank" })%>
                            </div>
                        </td>
