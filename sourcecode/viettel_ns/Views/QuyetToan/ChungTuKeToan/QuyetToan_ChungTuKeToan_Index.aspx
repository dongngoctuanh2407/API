                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td class="td_form2_td5" style="width: 100%;">
                                <div>
                                    <%=MyHtmlHelper.DropDownList(ParentID, slLNS, "", "sLNS", "", "SIZE=\"30\" onchange=\"ChonLoaiNganSach(this.value)\" class=\"form-control\"")%>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td class="td_form2_td5" style="width: 100%;">
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tr>
                                        <td class="td_form2_td5" style="text-align: left; width: 25%;">
                                            <div><b>Lựa chọn quý:</b></div>
                                        </td>
                                        <td class="td_form2_td5">
                                            <div>
                                                <%=MyHtmlHelper.DropDownList(ParentID, slQuy, "", "iQuy", "", "class=\"form-control\" style=\"width:100%;\"")%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30%" align="right" class="td_form2_td5">
                                                            <%--<input type="submit" class="button" id="Submit1" value="Thực hiện" />--%>
                                                              <button class="btn btn-primary" type="submit" id="Submit1"><i class="fa fa-check"></i>Thực hiện</button>
                                                        </td>          
                                                            <td width="5px">&nbsp;</td>          
                                                        <td class="td_form2_td5">
