...
<%
    ...
    using (Html.BeginForm("SortSubmit", "QuyetToan_QuanSo_MucLucQuanSo", new { iID_MaMucLucQuanSo_Cha = iID_MaMucLucQuanSo_Cha }))
    {   
%>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" align="right">
        	                            <tr>
            	                            <td>
                                                ...
                                                <button type="button" onclick="javascript:return btnLuu_click();" class="btn btn-primary" ><i class="fa fa-download"></i>Lưu</button>
            	                            </td>
                                            <td width="5px"></td>
                                            <td>
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            if (i == 0)
            {
                strSelected = "selected";
                                ...
                                <option value="<%= Row["iID_MaMucLucQuanSo"]%>" "<%= strSelected%>"><%= Row["sKyHieu"]%> - <%= Row["sMoTa"]%></option>
                            <%}
        dt.Dispose();    
                            %>                                 
                    </select>
                ...
                <td>
                    <input type='button' class='btn btn-default textbox' value='↑' onClick='moveOptionUp(SOrder);'><br><br>
                    <input type='button' class='btn btn-default textbox' value='↓' onClick='moveOptionDown(SOrder);'><br><br>
                </td>
            </tr>
        </table>
        </div>
