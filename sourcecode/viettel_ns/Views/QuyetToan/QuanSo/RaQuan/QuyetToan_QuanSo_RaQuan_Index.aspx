    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            String strDelete = "";
                ...
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QuyetToan_QuanSo_RaQuan", new { iThang = R["iThang"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete' title='Xóa'></i>", "Delete", null, "title=\"Xóa\"");
