                    ...
                    <td valign="top" align="left" style="width: 45%;">
                        <table cellpadding="5" cellspacing="5" width="100%">
                            ...
                            <tr>
                                ...
                                <td class="td_form2_td5">
                                    <div>
                                        <%=MyHtmlHelper.DropDownList(ParentID, slThang, iThang_Quy, "iThang_Quy", "", "class=\"form-control\" style=\"width:98%;\"")%><br />
...
<div class="custom_css box_tong">
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "QuyetToan_QuanSo_ChungTu", new {iLoai=iLoai, iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QuyetToan_QuanSo_ChungTu", new { iLoai = iLoai, iID_MaChungTu = R["iID_MaChungTu"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }
