...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        if (string.IsNullOrEmpty(MaDonVi))
            MaDonVi = dtDonVi.AsEnumerable().Select(x => x.Field<string>("iID_MaDonVi")).Join(",");
    ...
    <% 
        ...
        var MaPhongBan = NguoiDung_PhongBanModels.getTenPhongBan_NguoiDung(MaND);
    ...
    <div class="box_tong">
        ...
        <table class="mGrid">
            <tr>
                <th style="width: 3%;" align="center">STT
                </th>
                <th style="width: <%=sWidthDonVi%>;" align="center">Đơn vị
                </th>
                <%if (Loai == "1")
                    { %>
                <th style="width: 5%;" align="center">Loại Ngân sách
                </th>
                <%} %>
                <th style="width: 7%;" align="center">Ngày chứng từ
                </th>
                <th style="width: 10%;" align="center">Thời gian quyết toán
                </th>
                <th style="width: 5%;" align="center">Số chứng từ
                </th>
                <th style="width: 25%;" align="center">Nội dung
                </th>
                ...
                <th style="width: 3%;" align="center">Sửa
                </th>
                <th style="width: 3%;" align="center">Xóa
                </th>
            </tr>
            <%
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "QuyetToan_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"], Loai = Loai }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                        //bool checkXoa = SharedModels.checkXoaQuyetToan(Convert.ToString(R["iID_MaChungTu"]));
                        //if (checkXoa == true)
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "QuyetToan_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"], Loai = Loai }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                    }
