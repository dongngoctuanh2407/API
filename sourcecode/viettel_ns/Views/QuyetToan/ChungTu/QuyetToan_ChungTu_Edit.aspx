...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        DataTable dtLNS = NganSach_HamChungModels.DSLNS_LocCuaPhongBan(UserID, sLNS);
                    ...
                    <div style="width: 60%; float: left;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td class="td_form2_td5">
                                    <div>
                                        <%=MyHtmlHelper.DropDownList(ParentID, slDonVi, iID_MaDonVi, "iID_MaDonVi", "", "onchange=\"ChonDonViNhapLieu(this.value)\" class=\"form-control\"" + ReadOnly)%><br />
                            ...
                            <tr>
                                ...
                                <div>
                                    <%= MyHtmlHelper.DropDownList(ParentID, slLNS, sLNS, "sLNS", "",
                                                                            String.Format(
                                                                                "{0} onchange=\"ChonDonViNhapLieu(this.value)\" class=\"form-control\"",
                                                                                ReadOnly)) %><br />
                                </div>
                            </td>--%>
                            ...
                            <tr>
                                ...
                                <td class="td_form2_td5">
                                    <div>
                                        <%=MyHtmlHelper.DropDownList(ParentID, slThang, sThang, "iThang_Quy", "", "onchange=\"ChonThangNhapLieu(this.value)\" class=\"form-control\" style=\"width:17%;\"")%><br />
                            ...
                            <tr>
                                ...
                                <td class="td_form2_td5">
                                    <div>
                                        <%=MyHtmlHelper.DatePicker(ParentID, dNgayChungTu, "dNgayChungTu", "", "class=\"form-control\" onblur=isDate(this);")%><br />
                            ...
                            <tr>
                                ...
                                <td class="td_form2_td5">
                                    <div><%=MyHtmlHelper.TextArea(ParentID,sNoiDung, "sNoiDung", "", "class=\"form-control\" style=\"height: 80px;\"")%></div>
                                </td>
                            </tr>
                            <tr>
