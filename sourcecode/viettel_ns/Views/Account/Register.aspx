                ...
                <table width="100%" cellpadding="0"  cellspacing=""="0" border="0" class="table_form2">
                    <tr>
                       ...
                       <td class="td_form2_td5"><div>
                            <%= Html.TextBox("Fullname", "", new { style="width:50%", @class="form-control" })%>
                    ...
                    <tr>
                       ...
                       <td class="td_form2_td5"><div>
                            <%= Html.TextBox("Email", "", new { style="width:50%", @class="form-control" })%>
                    ...
                    <tr>
                       ...
                       <td class="td_form2_td5"><div>
                            <%= Html.TextBox("Username", "", new { style = "width:50%", @class="form-control" })%>
                    ...
                    <tr>
                       ...
                       <td class="td_form2_td5"><div>
                            <%= Html.Password("Password", "", new { style = "width:50%", @class="form-control" })%>
                    ...
                    <tr>
                       ...
                       <td class="td_form2_td5"><div>
                            <%= Html.Password("ConfirmPassword", "", new { style = "width:50%", @class="form-control" })%>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" align="right">
        	                    <tr>
            	                    <td>
                                        ...
                                        <button id="Register" class="btn btn-primary" type="button"><i class="fa fa-plus"></i> Đăng ký</button>
            	                    </td>
                                    <td width="5px"></td>
                                    <td>
