...
<div class="box_tong">
    ...
    if (dt != null)
    {
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            strEdit = MyHtmlHelper.ActionLink(Url.Action("EditThuMuc", "TuLieu_ThuMuc", new { ID = R["iID_MaThuMucTaiLieu"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "EditThuMuc", "");
            strDelete = MyHtmlHelper.ActionLink(Url.Action("DeleteThuMuc", "TuLieu_ThuMuc", new { ID = R["iID_MaThuMucTaiLieu"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "DeleteThuMuc", "");
            %>
            <tr >
