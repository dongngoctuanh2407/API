                               ...
                               <%}%>--%>
                                        ...
                                        <%
                                            ...
                                            for (i = 0; i < dt.Rows.Count; i++)
                                            {
                                                ...
                                                //{
                                                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "TuLieu_VanBan", new { MaTaiLieu = dt.Rows[i]["iID_MaTaiLieu"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                                                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "TuLieu_VanBan", new { MaTaiLieu = dt.Rows[i]["iID_MaTaiLieu"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                                                // }
                                        %>
                                        <tr class="<%=strClass %>">
                                            <td align="center">
