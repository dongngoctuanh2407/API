    ...
    <table class="mGrid">
        ...
        <%
            for (i = 0; i < dt.Rows.Count; i++)
            {
                ...
                {
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "CanBo_NguoiPhuThuoc", new { iID_MaNguoiPhuThuoc = R["iID_MaNguoiPhuThuoc"], iID_MaCanBo = R["iID_MaCanBo"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                }
