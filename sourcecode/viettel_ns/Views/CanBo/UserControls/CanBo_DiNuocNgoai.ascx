    ...
    <table class="mGrid">
        ...
        <%
            for (i = 0; i < dt.Rows.Count; i++)
            {
                ...
                {
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "CanBo_DiNuocNgoai", new { iID_MaDiNuocNgoai = R["iID_MaDiNuocNgoai"], iID_MaCanBo = R["iID_MaCanBo"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                }
