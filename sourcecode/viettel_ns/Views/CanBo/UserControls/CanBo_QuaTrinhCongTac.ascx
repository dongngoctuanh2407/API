    ...
    <table class="mGrid">
        ...
        <%
            for (i = 0; i < dt.Rows.Count; i++)
            {
                ...
                {
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "CanBo_QuaTrinhCongTac", new { iID_MaQuaTrinhCongTac = R["iID_MaQuaTrinhCongTac"], iID_MaCanBo = R["iID_MaCanBo"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                }
