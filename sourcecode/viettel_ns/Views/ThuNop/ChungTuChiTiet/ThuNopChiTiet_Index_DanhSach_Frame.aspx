...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        String iID_MaDonVi = data["iID_MaDonVi"];
       
        ThuNop_BangDuLieu bang = new ThuNop_BangDuLieu(iID_MaChungTu, MaND, IPSua, Convert.ToInt32(iLoai));
        ...
        <tr>
            ...
            <td>
             ...
             <td align="left" width="85px">
                            <div style="float: right; margin-left: 10px;" onclick="OnInit_CT_NEW(700, 'Thông tri');">
                             ...
                             <div style="float: right; margin-left: 10px;">                                
                                <%= Html.ActionLink("In kiểm", "Print", new { controller = "rptThuNop_InKiem", ext = "pdf", MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, iID_MaDonVi = iID_MaDonVi }, new { @class = "button", target = "_blank" })%>
                            </div></td>
                            <td>
                &nbsp;
            </td>
    ...
    $(document).ready(function () {
        ...
        BangDuLieu_iID_MaPhongBan = '<%=iID_MaPhongBan%>';
        BangDuLieu_DuocSuaChiTiet = <%=bang.DuocSuaChiTiet?"true":"false"%>;
        <%=bang.DuocSuaChiTiet?"":"Bang_keys.fnSetFocus(null, null);"%>
          BangDuLieu_Url_F12 = '<%=Url.Action("ViewPDF", "rptThuNop_01DTN", new { MaND = MaND, iID_MaPhongBan = iID_MaPhongBan, iLoaiBaoCao = "2", iID_MaDonVi = iID_MaDonVi })%>';
