            ...
            <table cellpadding="0"  cellspacing="0" border="0" width="70%">
                <tr>
                    ...
                    <td class="td_form2_td5">
                        <div>
                            <%=MyHtmlHelper.DropDownList(ParentID, optPhanHe, iID_MaPhanHe, "iID_MaPhanHe", null, "class=\"form-control\"")%></div>
                    </td>
                </tr>
                <tr>
                  <td class="td_form2_td1"><div>Tên báo cáo</div></td>
                    <td class="td_form2_td5">
                        <div><%=MyHtmlHelper.TextBox(ParentID, data, "sTenBaoCao", null, "class=\"form-control\"")%>
                ...
                <tr>
                  <td class="td_form2_td1"><div>Tên controller</div></td>
                    <td class="td_form2_td5">
                        <div><%=MyHtmlHelper.TextBox(ParentID, data, "sController", null, "class=\"form-control\"")%>
