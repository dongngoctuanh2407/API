...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="70%">
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, optPhanHe, MaPhanHe, "iID_MaPhanHe", null, "class='form-control' style=\"width: 100%;\"")%></div>
                        </td>
                        <td>
                            <div style="padding: 3px 10px; float:left;">
                                <button class="btn btn-info" type="submit"><i class="fa fa-search"></i>Lọc</button>
    ...
    <table cellpadding="0" cellspacing="0" border="0" align="left">
        <tr>
            ...
            <td>
                <%=MyHtmlHelper.DropDownList(ParentID, slTK, "", "sID_MaNguoiDungTao", "", "class='form-control' style=\"width:150px;\"")%>
    ...
    <div style="float: left; width: 100%; padding-bottom: 5px;">
        <!-- <input id="Button1" style="float: right;" type="button" class="button_title" value="Thêm mới"
            ...
            <button class="btn btn-primary" style="float: right;" onclick="javascript:location.href='<%=strThemMoi %>'"><i class="fa fa-plus"></i>Thêm mới</button>
    </div>
    <br />
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="right">
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-default" type="button"><i class="fa fa-ban"></i>Hủy</button>
