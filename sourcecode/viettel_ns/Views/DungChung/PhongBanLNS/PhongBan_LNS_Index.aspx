                            ...
                            <table cellpadding="5" cellspacing="5" width="100%">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                        <%=MyHtmlHelper.DropDownList(ParentID, optLNS, MaLNS, "search_sLNS", "", "class=\"form-control\"")%>
        ...
        <table class="mGrid">
            ...
            <tr <%=classtr %>>
               ...
               <%-- <td align="center">
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "PhongBanLNS", new { Code = R["iID_MaPhongBan"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
