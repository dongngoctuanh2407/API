...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        DataTable dtLNS = DanhMucModels.NS_PBLoaiNganSach();
            ...
            <div id="form2">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td>
                            <div id="divDonVi">
                                <%=MyHtmlHelper.DropDownList(ParentID, optPhongBan, MaPhongBan, "iID_MaPhongBan", null, "style=\"width: 50%;\" class=\"form-control\"onchange=\"Chon_LNS(this.value)\"")%>
                                        ...
                                        <div style="margin-top: 5px;">
                                            <table class="mGrid">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <input id="txtLNS" class="form-control" onkeypress='js_Search_PhongBan_LNS_onkeypress(event)' />
