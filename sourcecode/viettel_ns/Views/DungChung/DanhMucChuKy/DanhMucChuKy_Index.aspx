    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "DanhMucChuKy", new { iID_MaChuKy = R["iID_MaChuKy"], page = CurrentPage }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%> &nbsp;
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "DanhMucChuKy", new { iID_MaChuKy = R["iID_MaChuKy"], page=CurrentPage }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
        <%} %>
        <tr class="pgr">
