                            ...
                            <table cellpadding="5" cellspacing="5" width="100%">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, MaNguoiDung, "search_MaNguoiDung", "", "class=\"form-control\"")%>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td valign="top" align="left" style="width: 45%;">
                            <table cellpadding="5" cellspacing="5" width="100%">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, dllPhongban, MaPhongBan, "search_iID_MaPhongBan", "", "class=\"form-control\"")%>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td colspan="2" align="center" style="padding: 0px 0px 10px 0px;">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" onclick="javascript:location.href='<%=strThemMoi %>'" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>Tạo mới</button>
        ...
        <table class="mGrid">
            ...
            <tr <%=classtr %>>
               ...
               <%-- <td align="center">
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "NguoiDungPhongBan", new { sMaNguoiDung = R["sID_MaNguoiDung"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
