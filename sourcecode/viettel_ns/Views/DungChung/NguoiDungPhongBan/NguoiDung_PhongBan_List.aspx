...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <% 
    ...
    MaNguoiDungPhongBan = R["iID_MaNguoiDungPhongBan"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("DeleteDetail", "NguoiDungPhongBan", new { sMaNguoiDung = R["iID_MaNguoiDungPhongBan"], MaNguoiDungPhongBan = R["sMaNguoiDung"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
