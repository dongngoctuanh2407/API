...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <%
         ...
         DataTable dt = MucLucNganSach_NganhModels.Get_dtMucLucNganSach_Nganh_NhaNuoc(iID);
         if (dt.Rows.Count > 0)
         {
         ...
         String BackURL = Url.Action("Index", "DanhMucNganh_NhaNuoc");
         String readOnly="readonly=\"readonly\"";
         if (ViewData["DuLieuMoi"] == "1") readOnly = "";
         using (Html.BeginForm("EditSubmit", "DanhMucNganh_NhaNuoc", new { ParentID = ParentID, iID = iID }))
    {
     %>
     ...
     <div class="custom_css box_tong">
         ...
         <div id="Div2">
            <table cellpadding="0"  cellspacing=""="0" border="0" width="100%"  class="table_form2">
                 ...
                 <td width="30%"><div><%=MyHtmlHelper.TextBox(ParentID, iID_MaNganh, "iID_MaNganh", null, "class=\"form-control\" style=\"width: 50%;\"" + readOnly + "")%>          <br />                  
                 ...
                 <td><div><%=MyHtmlHelper.TextBox(ParentID,sTenNganh, "sTenNganh", null, "class=\"form-control\" style=\"width: 50%;\"")%>   <br />   </div>
                   </td>
                   <td></td>
                 </tr>
                 <tr>
                            ...
                            <tr>
                                    <td style="width: 49%;" align="right">
                                        <%--<input type="submit" class="button" id="Submit1" value="<%=NgonNgu.LayXau("Thực hiện")%>" />--%>                                   
                                           <button type="submit" id="Submit1" class="btn btn-primary pull-right"><i class="fa fa-check"></i>Thực hiện</button>
                                    </td>
                                    <td width="2%">                                    </td>
                                    <td style="width: 49%;" align="left">
                                        <%--<input class="button" type="button" value="<%=NgonNgu.LayXau("Hủy")%>" onclick="Huy()" />--%>        
                                          <button class="btn btn-default" onclick="Huy()"><i class="fa fa-ban"></i>Hủy</button>
                                    </td>
                                </tr>
                           </table></td> 
                             <td></td> 
