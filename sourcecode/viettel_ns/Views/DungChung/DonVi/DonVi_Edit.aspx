                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="70%" class="table_form2">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, optKhoiDonVi, data, "iID_MaKhoiDonVi", null, "class=\"form-control\"")%>
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, optLoaiDonVi, data, "iID_MaLoaiDonVi", null, "class=\"form-control\"")%>
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, optNhomDonVi, data, "iID_MaNhomDonVi", null, "class=\"form-control\"")%>
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, data, "iID_MaDonVi", "", "class=\"form-control\"" + strReadOnlyMa + "", 2)%><%=strIcon %>
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, data, "sTen", "", "class=\"form-control\"")%>
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, data, "sMoTa", "", "class=\"form-control\"")%>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td width="50%">
                            <table cellpadding="0" cellspacing="0" border="0" width="70%" class="table_form2">
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, data, "sMaSo", null, "class=\"form-control\"")%>
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, data, "sSoTaiKhoan", null, "class=\"form-control\"")%>
                                 ...
                                 <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, data, "sDiaChi", null, "class=\"form-control\"")%>
                                   ...
                                   <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.TextBox(ParentID, data, "sKhoBac", null, "class=\"form-control\"")%>
                                  ...
                                  <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.CheckBox(ParentID, data, "iHuongLuong", null, "")%>
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, slCapNS,data, "iCapNS", null, "class=\"form-control\"")%>
