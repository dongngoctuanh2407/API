            ...
            <table cellpadding="5" cellspacing="5" width="50%">
                <tr>
                    ...
                    <td class="td_form2_td5">
                        <div><%=MyHtmlHelper.DropDownList(ParentID, optLoaiDonVi, iID_MaLoaiDonVi, "iID_MaLoaiDonVi", null, "class=\"form-control\"")%>
                ...
                <tr>
                    ...
                    <td class="td_form2_td5">
                        <div><%=MyHtmlHelper.TextBox(ParentID, sKyHieu, "sKyHieu", "", "class=\"form-control\"", 2)%>
                ...
                <tr>
                    ...
                    <td class="td_form2_td5">
                        <div><%=MyHtmlHelper.TextBox(ParentID, sMoTa, "sMoTa", "", "class=\"form-control\"")%>
