...
<%
    ...
    using (Html.BeginForm("SortSubmit", "MucLucDoiTuong", new { iID_MaMucLucDoiTuong_Cha = iID_MaMucLucDoiTuong_Cha }))
    {   
%>
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            if (i == 0)
            {
                strSelected = "selected";
                                ...
                                <option value="<%= Row["iID_MaMucLucDoiTuong"]%>" "<%= strSelected%>"><%= Row["sKyHieu"]%> - <%= Row["sMoTa"]%></option>
                            <%}
        dt.Dispose();    
                            %>                                 
                    </select>
