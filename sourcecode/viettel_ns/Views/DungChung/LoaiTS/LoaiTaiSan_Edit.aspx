                ...
                <table cellpadding="5" cellspacing="5" width="50%">
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, sKyHieu, "MaLoaiTaiSan", "", "class=\"form-control\" tab-index='-1'", 2)%>
                    ...
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.TextArea(ParentID, sMoTa, "sMoTa", "", "class=\"form-control\" style=\"resize:none;\"")%>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div>
                                <%=MyHtmlHelper.TextBox(ParentID, rTyLeKhauHao, "rSoNamKhauHao", "", "class=\"form-control\"", 2)%>
                            </div>
                        </td>
                    </tr>
                    <tr>
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="right">
                    <tr>
                        <td>
                            ...
                            <button type="submit" id="" class="btn btn-primary pull-right"><i class="fa fa-save"></i>Lưu</button>
                        </td>
                        <td width="5px">
                        </td>
                        <td>
