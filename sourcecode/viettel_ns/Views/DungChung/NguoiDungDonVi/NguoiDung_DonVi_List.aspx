    ...
    <div class="box_tong">
        ...
        <table class="mGrid">
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("EditDetail", "NguoiDungDonVi", new { Code = R["sMaNguoiDung"], NguoiDung = R["iID_MaNguoiDungDonVi"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("DeleteDetail", "NguoiDungDonVi", new { Code = R["iID_MaNguoiDungDonVi"],NguoiDung= R["sMaNguoiDung"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
            <tr class="pgr">
