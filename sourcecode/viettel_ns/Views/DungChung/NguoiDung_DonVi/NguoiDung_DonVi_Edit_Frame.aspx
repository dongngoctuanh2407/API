...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        NguoiDung_DonViCT_BangDuLieu bang = new NguoiDung_DonViCT_BangDuLieu(maND,arrGiaTriTimKiem, MaND, IPSua);
        ...
        String DetailSubmit = Url.Action("DetailSubmit", "NguoiDung_DonVi", new { maND = maND });
    %>
