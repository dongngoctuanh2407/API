    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "KeToan_NhanVien", new { iID_MaNhanVien = R["iID_MaNhanVien"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "KeToan_NhanVien", new { iID_MaNhanVien = R["iID_MaNhanVien"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
        <%} %>
        <tr class="pgr">
