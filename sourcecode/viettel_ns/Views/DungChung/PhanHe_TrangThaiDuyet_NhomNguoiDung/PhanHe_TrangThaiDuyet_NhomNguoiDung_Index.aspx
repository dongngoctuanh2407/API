    ...
    <div class="box_tong">
        <table class="mGrid">
            ...
            <tr <%=classtr %>>
                ...
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Edit", "PhanHe_TrangThaiDuyet_NhomNguoiDung", new { MaPhanHe_TrangThaiDuyet_Xem = R["iID_MaPhanHe_TrangThaiDuyet_Xem"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "")%>
                </td>
                <td align="center">
                    <%=MyHtmlHelper.ActionLink(Url.Action("Delete", "PhanHe_TrangThaiDuyet_NhomNguoiDung", new { MaPhanHe_TrangThaiDuyet_Xem = R["iID_MaPhanHe_TrangThaiDuyet_Xem"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "")%>
                </td>
            </tr>
            <%} %>
        </table>
