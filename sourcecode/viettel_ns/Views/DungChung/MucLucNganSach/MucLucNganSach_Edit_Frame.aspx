            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table_form2">
                ...
                <tr>
                    ...
                    <td align="right" style="padding-right:10px;width:6%;">
                       <input type="button" id="btnLuu" class="button btnInputThuchien" onclick="javascript:return Bang_HamTruocKhiKetThuc();"
                  ...
                  <%--  <td style="width:5%">
                    ...
                    <td align="right" style="padding-right:10px;width:6%"> 
                        <input class="button btnInputQuaylai" type="button" value="<%=NgonNgu.LayXau("Quay lại")%>" onclick="Huy()" />
                    </td>
                    <td>
                        &nbsp;
                    </td>
