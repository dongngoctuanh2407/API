                ...
                <tr>
                    <td>
                     ...
                     <td width="30%" align="right" class="td_form2_td5">
                         <button class="btn btn-default pull-right mr-10" onclick="history.go(-1)"><i class="fa fa-ban"></i>Hủy</button>
                         <button type="submit"  id="Submit2" class="btn btn-primary pull-right mr-10"><i class="fa fa-save"></i>Lưu</button>
                     </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    ...
                    <td width="30%" align="right" class="td_form2_td5">
                       <%-- <input type="submit" class="button" id="Submit1" value="Lưu" />--%>
                         <button class="btn btn-default pull-right mt-10" onclick="history.go(-1)"><i class="fa fa-ban"></i>Hủy</button>
                         <button type="submit" id="Submit1" class="btn btn-primary pull-right mr-10 mt-10 mb-10"><i class="fa fa-save"></i>Lưu</button>
                    </td>
                    <td width="5px">
                        &nbsp;
                    </td>
