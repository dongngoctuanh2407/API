...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        PhongBan_DonViCT_BangDuLieu bang = new PhongBan_DonViCT_BangDuLieu(phongban,arrGiaTriTimKiem, MaND, IPSua);
        ...
        String DetailSubmit = Url.Action("DetailSubmit", "PhongBan_DonVi", new { phongban = phongban });
    %>
