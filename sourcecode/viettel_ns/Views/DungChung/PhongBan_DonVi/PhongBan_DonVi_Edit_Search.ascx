...
<%        
    ...
    String phongban = Convert.ToString(props["phongban"].GetValue(Model));
    String ControlID = Convert.ToString(props["ControlID"].GetValue(Model));
    String ParentID = ControlID + "_Search";
    String IPSua = Request.UserHostAddress;
        
    String DSTruong = "iID_MaDonVi";
    String strDSTruongDoRong = "300";
        ...
        <div id="form2">            
            ...
            <tr>
                ...
                {                                
                    ...
                    String strAttr = "";                   
                    strAttr = String.Format("class='input1_4' onkeypress='jsPBDV_Search_onkeypress(event)' search-control='1' search-field='{1}' style='width:{0}px;height:22px;'", iColWidth - 2, arrDSTruong[j]);
            ...
            <iframe id="ifrChiTiet" width="100%" height="538px" src="<%= Url.Action("PhongBan_DonVi_Edit_Frame", "PhongBan_DonVi", new { phongban = phongban})%>"></iframe>  
        </div>
