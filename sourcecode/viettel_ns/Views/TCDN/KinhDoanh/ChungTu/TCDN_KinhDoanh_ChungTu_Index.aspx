...
<%
    int i;
    String ParentID = "TCDN_KinhDoanh_ChungTu";
    ...
    DataTable dt = TCDN_KinhDoanh_ChungTuModels.Get_DanhSachChungTu(MaND, iSoChungTu, iQuy, iID_MaDoanhNghiep, dTuNgay, dDenNgay, iID_MaTrangThaiDuyet, CurrentPage, Globals.PageSize);

    double nums = TCDN_KinhDoanh_ChungTuModels.Get_DanhSachChungTu_Count(MaND, iSoChungTu, iQuy, iID_MaDoanhNghiep, dTuNgay, dDenNgay, iID_MaTrangThaiDuyet);
    ...
    String strThemMoi = Url.Action("Edit", "TCDN_KinhDoanh_ChungTu");
    String strNhapExel = Url.Action("Index", "TCDN_KinhDoanh_ChungTu_ImportExcel");

    using (Html.BeginForm("SearchSubmit", "TCDN_KinhDoanh_ChungTu", new { ParentID = ParentID}))
    {
%>
...
<div class="box_tong">
    ...
    <table class="mGrid">
        ...
        for (i = 0; i < dt.Rows.Count; i++)
        {
            ...
            String classtr = "";
            int STT = i + 1;
            String iNamChungTu = Convert.ToString(R["iNamLamViec"]);
            String sTrangThai = "";
            String strColor = "";
            ...
            {
                strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "TCDN_KinhDoanh_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "TCDN_KinhDoanh_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
            }

            String strURL = MyHtmlHelper.ActionLink(Url.Action("Index", "TCDN_KinhDoanh_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<img src='../Content/Themes/images/btnSetting.png' alt='' />", "Detail", null, "title=\"Xem chi tiết chứng từ\"");
                       
            %>
            <tr <%=strColor %>>
                <td align="center"><%=R["rownum"]%></td>  
                <td align="left"><%=strTenDoanhNghiep%></td>    
                <td align="center"><%=Convert.ToString(R["iQuy"])%></td>
                <td align="center">
                    <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "TCDN_KinhDoanh_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), Convert.ToString(R["sTienToChungTu"]) + Convert.ToString(R["iSoChungTu"]), "Detail", "")%></b>
                </td>
