...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        if (!String.IsNullOrEmpty(iID_MaHinhThucHoatDong)) DK += String.Format(@" AND iID_MaHinhThucHoatDong ='{0}'", iID_MaHinhThucHoatDong);
        String SQL =
                  String.Format(
                      "SELECT * FROM TCDN_CongTyLienDoanhLienKet WHERE iTrangThai=1 AND iID_MaDoanhNghiep=@iID_MaDoanhNghiep {0}",DK);
    ...
    <div class="box_tong">
        ...
        <% using (Html.BeginForm("Search_CongTyLDLK", "TCDN_HoSo_DoanhNghiep", new { ParentID = ParentID, iID_MaDoanhNghiep = iID_MaDoanhNghiep }))
           {%>
        <div id="nhapform">
            <div id="form2">
                <div>
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="float: right" onclick="OnInit_CT(600, 'Công ty liên doanh, liên kết');">
                                    <%= Ajax.ActionLink("Thêm mới", "Index", "NhapNhanh", new { id = "TCDN_CongTyLDLK", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaDoanhNghiep = iID_MaDoanhNghiep }, new AjaxOptions { }, new { @class = "button", id = "TCDN_CongTyLDLK" })%>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            strDelete =
                                MyHtmlHelper.ActionLink(
                                    Url.Action("Delete_CongTyLDLK", "TCDN_HoSo_DoanhNghiep",
                                               new { iID_MaDoanhNghiep = R["iID_MaDoanhNghiep"],iid_ma=R["iiD_Ma"] }).ToString(),
                                    "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                            String sTenLoaiHinh = "";
                            sTenLoaiHinh =
                                Convert.ToString(CommonFunction.LayTruong("DC_DanhMuc", "iID_MaDanhMuc",
                                                                          R["iID_MaHinhThucHoatDong"].ToString(), "sTen"));
                    %>
                    <tr>
                        ...
                        <td align="center">
                              <div  onclick="OnInit_CT(600, 'Công ty liên doanh, liên kết');">
                                    <%= Ajax.ActionLink("Sửa", "Index", "NhapNhanh", new { id = "TCDN_CongTyLDLK", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaDoanhNghiep = iID_MaDoanhNghiep, iID_Ma = R["iID_Ma"] }, new AjaxOptions { }, new { id = "TCDN_CongTyLDLK" })%>
                                </div>
                        </td>
                        <td align="center">
                            <%=strDelete%>
