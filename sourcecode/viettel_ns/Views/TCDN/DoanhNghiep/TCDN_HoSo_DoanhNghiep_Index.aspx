        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    string strEdit = "";
                    string strDelete = "";
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "TCDN_HoSo_DoanhNghiep", new { iID_MaDoanhNghiep = R["iID_MaDoanhNghiep"] }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "TCDN_HoSo_DoanhNghiep", new { iID_MaDoanhNghiep = R["iID_MaDoanhNghiep"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
