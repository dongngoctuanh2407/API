...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        String sTen = Convert.ToString(Request.QueryString["sTen"]);
          String iID_MaHinhThucHoatDong = Convert.ToString(Request.QueryString["iID_MaHinhThucHoatDong"]);
        ...
        String SQL =
                  String.Format(
                      "SELECT * FROM TCDN_DonViThanhVien WHERE iTrangThai=1 AND iLoai= 1 AND iID_MaDoanhNghiep=@iID_MaDoanhNghiep {0}",DK);
        ...
        DataTable dt1 = Connection.GetDataTable(cmd);
         ...
         SQL =
               String.Format(
                   "SELECT * FROM TCDN_DonViThanhVien WHERE iTrangThai=1 AND iLoai= 2 AND iID_MaDoanhNghiep=@iID_MaDoanhNghiep {0}", DK);
         cmd = new SqlCommand();
        cmd.CommandText = SQL;
        cmd.Parameters.AddWithValue("@iID_MaDoanhNghiep", iID_MaDoanhNghiep);
        //hach toan phu thuoc
        DataTable dt2 = Connection.GetDataTable(cmd);
    ...
    <div class="box_tong">
        ...
        <% using (Html.BeginForm("Search_DonViThanhVien", "TCDN_HoSo_DoanhNghiep", new { ParentID = ParentID, iID_MaDoanhNghiep = iID_MaDoanhNghiep }))
           {%>
        <div id="nhapform">
            <div id="form2">
                <div>
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="float: right" onclick="OnInit_CT(600, 'Đơn vị thành viên');">
                                    <%= Ajax.ActionLink("Thêm mới", "Index", "NhapNhanh", new { id = "TCDN_DonViThanhVien", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaDoanhNghiep = iID_MaDoanhNghiep }, new AjaxOptions { }, new { @class = "button", id = "TCDN_DonViThanhVien" })%>
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Danh sách công ty hạch toán độc lập</span>
                    </td>
                </tr>
            </table>
        </div>
                        ...
                        for (int i = 0; i < dt1.Rows.Count; i++)
                        {
                            ...
                            strDelete =
                                MyHtmlHelper.ActionLink(
                                    Url.Action("Delete_DonViThanhVien", "TCDN_HoSo_DoanhNghiep",
                                               new { iID_MaDoanhNghiep = R["iID_MaDoanhNghiep"],iid_ma=R["iiD_Ma"] }).ToString(),
                                    "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "");
                    %>
                    <tr>
                        ...
                        <td align="center">
                              <div  onclick="OnInit_CT(600, 'Đơn vị thành viên');">
                                    <%= Ajax.ActionLink("Sửa", "Index", "NhapNhanh", new { id = "TCDN_DonViThanhVien", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaDoanhNghiep = iID_MaDoanhNghiep, iID_Ma = R["iID_Ma"] }, new AjaxOptions { }, new { id = "TCDN_DonViThanhVien" })%>
                                </div>
                        </td>
                        <td align="center">
                            <%=strDelete%>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <span>Danh sách công ty hạch toán phụ thuộc</span>
                    </td>
                </tr>
            </table>
        </div>
                 <table class="mGrid" id="Table1">
                    <tr>
                        <th style="width: 2%;" align="center">
                            STT
                        </th>
