...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        String DK = "";
        if (!String.IsNullOrEmpty(sTen)) DK += String.Format(@" AND sTenDuAn LIKE '% {0}%'", sTen);
        String iLoai = Convert.ToString(Request.QueryString["iLoai"]);
        if (String.IsNullOrEmpty(iLoai)) iLoai = "1";

        String SQL =
                  String.Format(
                      "SELECT * FROM TCDN_DuAnDauTu WHERE iTrangThai=1 AND iID_MaDoanhNghiep=@iID_MaDoanhNghiep {0}", DK);
    ...
    <div class="box_tong">
        ...
        <% using (Html.BeginForm("Search_DuAnDangDauTu", "TCDN_HoSo_DoanhNghiep",new { ParentID = ParentID, iID_MaDoanhNghiep = iID_MaDoanhNghiep }))
           {%>
        <div id="nhapform">
            <div id="form2">
                <div>
                    <table width="100%">
                        <tr>
                            ...
                            <td class="td_form2_td5" style="width: 25%">
                                <div>
                                    <%= MyHtmlHelper.TextBox(ParentID, sTen, "sTenDoanhNghiep_search", "", "class=\"input1_2\"")%>
                                </div>
                            </td>
                            <td>
                                <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="float: right" onclick="OnInit_CT(600, 'Dự án đang đầu tư');">
                                    <%= Ajax.ActionLink("Thêm mới", "Index", "NhapNhanh", new { id = "TCDN_DuAnDangDauTu", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaDoanhNghiep = iID_MaDoanhNghiep }, new AjaxOptions { }, new { @class = "button", id = "TCDN_DuAnDangDauTu" })%>
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <table class="mGrid" id="<%= ParentID %>_thList">
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            strDelete =
                                MyHtmlHelper.ActionLink(
                                    Url.Action("Delete", "TCDN_HoSo_DoanhNghiep",
                                               new { iID_MaDoanhNghiep = R["iID_MaDoanhNghiep"] }).ToString(),
                    ...
                    <tr>
                        ...
                        <td align="center">
                             <div  onclick="OnInit_CT(600, 'Dự án đang đầu tư');">
                                    <%= Ajax.ActionLink("Sửa", "Index", "NhapNhanh", new {  id = "TCDN_DuAnDangDauTu", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaDoanhNghiep = iID_MaDoanhNghiep,iID_MaDuAn=R["iID_MaDuAn"] }, new AjaxOptions { }, new {  id = "TCDN_DuAnDangDauTu" })%>
                                </div>
                        </td>
                        <td align="center">
                            <%=strDelete%>
