        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    String strEdit = "";
                    String strDelete = "";
                    strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "TCDN_DoanhNghiep", new { iID_MaDoanhNghiep = R["iID_MaDoanhNghiep"]}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "EditNoiDung", "");
                    strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "TCDN_DoanhNghiep", new { iID_MaDoanhNghiep = R["iID_MaDoanhNghiep"] }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "DeleteNoiDung", "");
