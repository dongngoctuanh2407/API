...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width: 100%;">
        <table width="100%" cellspacing="3" cellpadding="3" border="0">
            <tr>
                <td rowspan="3" valign="top" style="width: 9px"></td>
                <td rowspan="3">
                ...
                <td style="width: 122px; text-align: center;" rowspan="3" valign="top">
                    ...
                    <br />
                    <img src="../../Content/Themes/images/Luong_DL_Down.gif" alt="" border="0" style="width: 9px; height: 45px;" />
                    <br />
                    <img src="../../Content/Themes/images/Computer.jpg" alt="" border="0" style="width: 122px;" />
                    <br />
                    <img src="../../Content/Themes/images/Luong_DL_Up.gif" alt="" border="0" style="width: 9px; height: 50px;" />
                    <br />
                ...
                <td rowspan="3" style="width: 50px">
                    ...
                    <img src="../../../Content/Themes/images/KTTH_ROW.gif" alt="" border="0" style="width: 50px; height: 109px; margin-top: 0px;" />


                </td>
                <td style="width: 19px;" rowspan="3" valign="top"></td>
                        ...
                        <div style="margin-left: 3px; height: 350px; float: left;">
                            <table width="100%" border="0" cellpadding="3" cellspacing="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/rptThuNop_01DTN">Báo cáo Thu biểu 01DT/N</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/rptThuNop_T01N">Báo cáo Thu biểu T01/N</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="float: right; width: 38px;">
                                    ...
                                    <td>
                                        <a href="/rptThuNop_T02N">Báo cáo Thu biểu T02/N</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <td style="width: 8px;" rowspan="3" valign="top">&nbsp;</td>
                <td style="width: 270px;" rowspan="3" valign="top">
            ...
            <tr>
                <td valign="middle">
                    <img src="../../Content/Themes/images/Luong_DL.gif" alt="" border="0" style="height: 15px; width: 75px; float: right;" />
                    <br />
                    <br />
    ...
    <script type="text/javascript">
        ...
        var html = '<table width="100%" cellspacing="3" cellpadding="3" border="0">';
        html += '<tr>';
        html += '<td colspan="7" style="font-weight: bold;" valign="top">';
        html += '<div class="box_tong">';
        html += '<div class="title_tong">';
        html += '<table cellpadding="0" cellspacing="0" border="0" width="100%">';
        html += '<tr>';
        html += '<td>';
        html += '<span>Cấu hình hệ thống</span>';
        html += '</td>';
        html += '<td style="width: 59px; text-align: right;"><b>Tháng &nbsp;</b></td>';
        html += '<td valign="top">';
        html += '<%=MyHtmlHelper.DropDownList("CauHinh", slThang, Convert.ToString(iThang), "iThangLamViec", "", "onchange=\"ChonThangNam(this.value, 1)\" class=\"form-control-custom\" style=\"width:70px;\"")%>';
        html += '<b>&nbsp; &nbsp; Năm &nbsp;</b>';
        html += '<%=MyHtmlHelper.DropDownList("CauHinh", slNam, Convert.ToString(iNam), "iNamLamViec", "", "onchange=\"ChonThangNam(this.value, 2)\"  class=\"form-control-custom\" style=\"width:80px;\"")%>';
        html += '</td>';
        html += '<td>Năm ngân sách</td>';
        html += '<td>';
        html += '<%=MyHtmlHelper.DropDownList("CauHinh", slNamNganSach, NamNS, "iID_MaNamNganSach", "", "onchange=\"ChonThangNam(this.value, 3)\" class=\"form-control-custom\" class=\"input1_2\" style=\"width: 200px\"")%>';
        html += '</td>';
        html += '<td>Nguồn ngân sách</td>';
        html += '<td>';
        html += '<%=MyHtmlHelper.DropDownList("CauHinh", slNguonNganSach, NguonNS, "iID_MaNguonNganSach", "", "onchange=\"ChonThangNam(this.value, 4)\" class=\"form-control-custom\" class=\"input1_2\" style=\"width: 300px\"")%>';
        html += '</td>';
        html += '</tr>';
        html += '</table>';
        html += '</div>';
