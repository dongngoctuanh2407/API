...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        dtTrangThai.Dispose();
        //Danh sach đơn vị
        DataTable dtDonVi = DuToan_ChungTuModels.getDanhSachDonViKyThuat(MaND, iID_MaChungTu);
        ...
        DataTable dt = DuToan_ChungTuModels.getDanhSachChungTuKyThuat(MaND, iID_MaChungTu,iID_MaDonVi,sM,sTM,sTTM,sNG);
        String sKyThuat = "";
        if (iKyThuat == "1")
    ...
    <div class="box_tong">
        ...
        <div id="nhapform">
            <div id="form2">
                <%
                    using (Html.BeginForm("SearchSubmit", "DuToan_ChungTu_BaoDam", new { ParentID = ParentID, iID_MaChungTu = iID_MaChungTu,iLoai="4" }))
                    {       
                %>
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "DuToan_ChungTu_BaoDam", new { iID_MaChungTu = R["iID_MaChungTu"], sLNS = "1040100", iKyThuat = iKyThuat }).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "", "title=\"Sửa chứng từ\"");
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "DuToan_ChungTu_BaoDam", new { iID_MaChungTu = R["iID_MaChungTu"], sLNS = "1040100", iKyThuat = iKyThuat }).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "", "title=\"Xóa chứng từ\"");
                    }
                    ...
                    {
                        strURLTuChoi = Url.Action("TuChoi", "DuToan_ChungTuChiTiet", new {  iID_MaChungTu = R["iID_MaChungTu"] });
                        strTex = "Từ chối";
                    ...
                    if (DaDuyet == false)
                        strduyet = MyHtmlHelper.ActionLink(Url.Action("TrinhDuyet", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"], sLNS = "1040100", iLoai = 1 }).ToString(), "<img src='../Content/Themes/images/arrow_up.png' alt='' />", "", "", "title=\"Duyệt chứng từ\"");
                    strTuChoi = MyHtmlHelper.ActionLink(Url.Action("TuChoi", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTu"], sLNS = "1040100", iLoai = 1 }).ToString(), "<img src='../Content/Themes/images/arrow_down.png' alt='' />", "", "", "title=\"Từ chối chứng từ\"");
            ...
            <tr >
                ...
                <td align="center">
                   <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTuChiTiet"], iLoai = 4 }).ToString(), R["iID_MaDonVi"], "Detail", "")%></b>
                </td>
                 <td align="center">
                   <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTuChiTiet"], iLoai = 4 }).ToString(), R["sM"], "Detail", "")%></b>
                </td>
                 <td align="center">
                   <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTuChiTiet"], iLoai = 4 }).ToString(), R["sTM"], "Detail", "")%></b>
                </td>
                 <td align="center">
                   <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTuChiTiet"], iLoai = 4 }).ToString(), R["sTTM"], "Detail", "")%></b>
                </td>
                 <td align="center">
                   <b><%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTuChiTiet"], iLoai = 4 }).ToString(), R["sNG"], "Detail", "")%></b>
                </td>
                 <td align="left">
                  <b> <%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTuChiTiet"], iLoai = 4 }).ToString(), R["sMoTa"], "Detail", "")%></b>
                </td>
                <td align="right">
                  <b> <%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTuChiTiet"], iLoai = 4 }).ToString(), rTuChi, "Detail", "")%></b>
                </td>
                <td align="right">
                 <b>  <%=MyHtmlHelper.ActionLink(Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = R["iID_MaChungTuChiTiet"], iLoai = 4 }).ToString(), rHienVat, "Detail", "")%></b>
                </td>
