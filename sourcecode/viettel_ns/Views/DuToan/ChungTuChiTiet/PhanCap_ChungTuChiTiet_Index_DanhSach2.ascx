...
<%
   ...
   String iID_MaDonVi = Convert.ToString(Request.QueryString["iID_MaDonVi"]);
    ...
    String strDSTruongDoRong = "";
         ...
         strDSTruong =  MucLucNganSachModels.strDSTruong+",iID_MaDonVi,iID_MaPhongBanDich";
         strDSTruongDoRong =   MucLucNganSachModels.strDSTruongDoRong+",200,30";  
    //}
    //else
    //{
...
<div class="box_tong">
    <div id="nhapform">
        <div id="form2">
            ...
            <iframe id="ifrChiTietChungTu" width="100%" height="538px" src="<%= Url.Action("ChungTuChiTiet_Frame", "DuToan_PhanCapChungTuChiTiet2", new {iID_MaChungTu=iID_MaChungTu, iID_MaDonVi=iID_MaDonVi, sLNS=sLNS})%>"></iframe>
        </div>
    </div>
</div>