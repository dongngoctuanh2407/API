...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        else
        {
            ...
            DuToan_PhanCapBangDuLieu2 bang = new DuToan_PhanCapBangDuLieu2(iID_MaChungTu, arrGiaTriTimKiem, MaND, IPSua, sLNS, MaLoai);
...
<input type="hidden" id="idDSDonVi" value="<%=strDSDonVi%>"/>
        <%  
            ...
            {
        %>
        <form action="<%=Url.Action("DetailSubmit", "DuToan_PhanCapChungTuChiTiet2", new{iID_MaChungTu=iID_MaChungTu})%>"
        method="post">
        <%
            } %>
