  ...
  <script src="<%= Url.Content("~/Scripts/jsDuToan_PhanCap.js?id=") %><%=DateTime.Now.ToString("yyMMddHHmmss") %>"
                    ...
                    <td>
                        ...
                        <td>
                          ...
                          <td align="right">
                            ...
                            <div>
                                <%Html.RenderPartial("~/Views/DuToan/ChungTuChiTiet/PhanCap_ChungTuChiTiet_Index_DanhSach2.ascx", new { ControlID = "ChungTuChiTiet_Index_DanhSach", MaND = User.Identity.Name, ChucNangCapNhap = true }); %>
                            </div>
                        </div>
                    </td>
                </tr>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            jsDuToan_Url_Frame = '<%=Url.Action("ChungTuChiTiet_Frame", "DuToan_PhanCapChungTuChiTiet2", new { iID_MaChungTu = iID_MaChungTu })%>';
            jsDuToan_Url = '<%=Url.Action("Index", "DuToan_PhanCapChungTuChiTiet2", new { iID_MaChungTu = iID_MaChungTu , iID_MaDonVi=iID_MaDonVi})%>';
            $("#tabs").tabs();
        });
    </script>
</asp:Content>
