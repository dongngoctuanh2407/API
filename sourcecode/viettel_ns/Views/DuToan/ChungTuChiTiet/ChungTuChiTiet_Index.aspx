...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        if (iLoai == "1")
        {
            data = DuToan_ChungTuModels.LayThongTin_Gom(iID_MaChungTu);
        }
        //ky thuat lan 2
        else if (iLoai == "4")
        {
                ...
                <tr>
                    <td>
                        ...
                        <div style="width: 100%; float: left; margin-top: 2px;">
                                        ...
                                        <tr>
                                            ...
                                            %>
                                                <td align="right" style="width: 200px;">
                                                    <span>F4:Sao chép dữ liệu dự toán năm trước</span>
                                                </td> 
                                            <%  }%>
                            ...
                            <div>
                                <%Html.RenderPartial("~/Views/DuToan/ChungTuChiTiet/ChungTuChiTiet_Index_DanhSach.ascx", new { ControlID = "ChungTuChiTiet_Index_DanhSach", MaND = User.Identity.Name, ChucNangCapNhap = true, sLNS = sLNS, iLoai = iLoai, iChiTapTrung = iChiTapTrung }); %>
                            </div>
                        </div>
                    </td>
                </tr>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            jsDuToan_Url_Frame = '<%=Url.Action("ChungTuChiTiet_Frame", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu,iChiTapTrung=iChiTapTrung })%>';
            jsDuToan_Url_Submit = '<%=Url.Action("DetailSubmit", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu,sLNS=sLNS })%>';
            jsDuToan_Url = '<%=Url.Action("Index", "DuToan_ChungTuChiTiet", new { iID_MaChungTu = iID_MaChungTu , iID_MaDonVi=iID_MaDonVi, sLNS=sLNS})%>';
            $("#tabs").tabs();
            if(<%=iKhoa%>=="1")
