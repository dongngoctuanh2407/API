...
<body>
   <%
    ...
    using (Html.BeginForm("UpLoadExcel", "DuToan_ChungTu_BaoDam", new { iID_MaChungTu = iID_MaChungTu, iLoai = iLoai, Loai = Loai }, FormMethod.Post, new { enctype = "multipart/form-data" }))
    {
    %>   
    <div class="box_tong">
        <div id="Div1">
