                ...
                <table width="100%" cellpadding="0"  cellspacing="0" border="0" class="table_form2">
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div><%=MyHtmlHelper.DropDownList(ParentID, slNam, NamHienTai, "MaNam", "", "class=\"form-control\" style=\"width: 50%\"")%>
                    ...
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div><%=MyHtmlHelper.DropDownList(ParentID, slNamNganSach, NamNS, "iID_MaNamNganSach", "", "class=\"form-control\" style=\"width: 50%\"")%>
                    ...
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <div><%=MyHtmlHelper.DropDownList(ParentID, slNguonNganSach,NguonNS, "iID_MaNguonNganSach", "", "class=\"form-control\" style=\"width: 50%\"")%></div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td_form2_td5">
                            <table cellpadding="0" cellspacing="0" border="0" align="left" style="margin: 10px;">
                                <tr>
                                    <td>
                                        <button type="submit" class="btn btn-primary pull-right" id="Submit1"><i class="fa fa-check-square" aria-hidden="true"></i>Thực hiện</button>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" onclick="history.go(-1)" class="btn btn-default pull-right"><i class="fa fa-ban" aria-hidden="true"></i><%=NgonNgu.LayXau("Hủy")%></button>
                                    </td>
                                </tr>
                            </table>
                        </td>
