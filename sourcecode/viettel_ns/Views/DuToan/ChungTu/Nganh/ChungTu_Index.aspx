...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        dtTrangThaiSoLieu = dtTrangThaiSoLieu.Select("iTrangThai=3").CopyToDataTable();
        ...
        DataTable dtALL = DuToan_ChungTuModels.Get_DanhSachChungTu("", "", iID_MaPhongBan, sLNS, "", MaND, iSoChungTu, sTuNgay, sDenNgay, sLNS_TK, iTrangThai_TK, iID_MaTrangThaiDuyet, CheckNDtao, "0", CurrentPage, Globals.PageSize);
        ...
        String strThemMoi = Url.Action("Edit", "DuToan_Nganh_ChungTu");
    ...
    <div class="box_tong">
        ...
        <div id="nhapform">
            <div id="form2">
                <%
                    using (Html.BeginForm("SearchSubmit", "DuToan_Nganh_ChungTu", new { ParentID = ParentID}))
                    {
                %>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td class="td_form2_td5" style="width: 10%">
                            <div>
                                <%=MyHtmlHelper.DropDownList(ParentID, slTrangThaiSoLieu,iTrangThai_TK,"iTrangThai_TK", "", "class=\"input1_2\"")%>
                            </div>
                        </td>
    ...
    <div class="box_tong">
        ...
        <div id="Div1">
            <div id="Div2">
                <%
                    using (Html.BeginForm("EditSubmit", "DuToan_Nganh_ChungTu", new { ParentID = ParentID}))
                    {
                %>
                        ...
                        <td style="width: 80%">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="50%" class="table_form2"
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, slTrangThaiSoLieu, iTrangThai, "iTrangThai", "", "class=\"input1_2\"")%><br />
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%=MyHtmlHelper.DropDownList(ParentID, slDonVi, iID_MaDonVi, "iID_MaDonVi", "class=\"input1_2\" style=\"height: 100px; width: 30%; \"")%><br />
                                        </div>
                                    </td>
                                </tr>
                                <%} %>
        ...
        <table class="mGrid" id="<%= ParentID %>_thList">
            ...
            <%
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        strEdit = MyHtmlHelper.ActionLink(Url.Action("Edit", "DuToan_Nganh_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<i class='fa fa-pencil-square-o fa-lg color-icon-edit'></i>", "Edit", "", "title=\"Sửa chứng từ\"");
                        strDelete = MyHtmlHelper.ActionLink(Url.Action("Delete", "DuToan_Nganh_ChungTu", new { iID_MaChungTu = R["iID_MaChungTu"]}).ToString(), "<i class='fa fa-trash-o fa-lg color-icon-delete'></i>", "Delete", "", "title=\"Xóa chứng từ\"");
                    }
                    else
                    {
