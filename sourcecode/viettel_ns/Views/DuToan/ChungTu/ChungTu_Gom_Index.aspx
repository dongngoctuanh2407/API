...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        dtTrangThai.Dispose();
        DataTable dtChungTuDuyet = DuToan_ChungTuModels.getDanhSachChungTu_TongHopDuyet(MaND,sLNS);
        ...
        DataTable dt = DuToan_ChungTuModels.Get_DanhSachChungTu_Gom("",iLoai,iID_MaPhongBan, MaND, sTuNgay, sDenNgay,iID_MaTrangThaiDuyet, CheckNDtao, CurrentPage, Globals.PageSize);

        double nums = DuToan_ChungTuModels.Get_DanhSachChungTu_Gom_Count(iID_MaPhongBan, MaND, sTuNgay, sDenNgay, iID_MaTrangThaiDuyet,CheckNDtao, CurrentPage, Globals.PageSize);
    ...
    <div class="box_tong">
        ...
        <div id="Div1">
            <div id="Div2">
                <%
                    using (Html.BeginForm("EditSubmit_Gom", "DuToan_ChungTu", new {ParentID = ParentID, sLNS1 = sLNS}))
                    {
%>
                                    ...
                                    <td class="td_form2_td5">
                                        <div>
                                            <%= MyHtmlHelper.TextArea(ParentID, "", "sNoiDung", "",
                                                                  "class=\"form-control\" style=\"height: 100px;\"") %></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_form2_td1" style="width: 15%;">
                ...
                <td align="center">
                 ...
                 <td align="center">
                    <div onclick="OnInit_CT_NEW(800, 'Báo cáo in kiểm');">
                        <%= Ajax.ActionLink("Báo cáo", "Index", "NhapNhanh", new { id = "DUTOAN_BAOCAOINKIEM_GOM", OnLoad = "OnLoad_CT", OnSuccess = "CallSuccess_CT", iID_MaChungTu = R["iID_MaChungTu_TLTH"], sLNS = sLNS }, new AjaxOptions { }, new { @class = "buttonReport" })%>
                    </div>
                </td>
               <td align="center">
